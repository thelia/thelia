        ...
        <?php } else {
                    ...
                    <?php
                        ...
                        <li class="list-group-item text-danger"><?php
                            echo $trans->trans('update to version %version',
                                ['%version' => $updateError->getVersion()]); ?></li>
                    <?php
                            } ?>
                </ul>
                <?php
                ...
                include 'footer.php';
                    ...
                    try {
                        ...
                        <div class="alert alert-success"><p><?php
                            echo $trans->trans('The update wizard directory will be removed'); ?></p></div><?php
                    } catch (\Symfony\Component\Filesystem\Exception\IOException $ex) {
                        ?>
                        <div class="alert alert-success"><p><?php
                        echo $trans->trans('Don\'t forget to delete the web/install directory.'); ?></p></div><?php
                    }
