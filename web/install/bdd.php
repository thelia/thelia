        ...
        <form action="config.php" method="post">
            <fieldset>
                ...
                <?php foreach ($databases as $database) { ?>
                    <?php if ($database['SCHEMA_NAME'] == 'information_schema') {
        continue;
    } ?>
                    <?php
                ...
                <div class="radio">
                    <label for="database_<?php echo $database['SCHEMA_NAME']; ?>">
                        <input type="radio" name="database" id="database_<?php echo $database['SCHEMA_NAME']; ?>" value="<?php echo $database['SCHEMA_NAME']; ?>" <?php if ($found) {
                        echo 'disabled';
                    } ?>>
