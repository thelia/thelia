...
<script>
    ...
    tinymce.init({
        ...
        toolbar1: "undo redo | bold italic underline | alignleft aligncenter alignright alignjustify | bullist numlist outdent indent | hr | styleselect | code | fullscreen",
        toolbar2: "link unlink anchor | image media youtube | forecolor backcolor | charmap | print preview ",
