...
{foreach $locales as $locale}
    ...
    (73, '{$locale}', {intl l='The URL of the images and documents CDN (leave empty is you\'re not using a CDN for assets).' locale=$locale}, NULL, NULL, NULL),
    (72, '{$locale}', {intl l='Apply customer discount percentage to sales and products in promotion' locale=$locale}, NULL, NULL, NULL){if ! $locale@last},{/if}
{/foreach}
;
