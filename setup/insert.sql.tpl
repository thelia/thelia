...
{foreach $locales as $locale}
    ...
    (36, '{$locale}', {intl l='Allow customers to change their email. 1 for yes, 0 for no' locale=$locale}, NULL, NULL, NULL),
    (37, '{$locale}', {intl l='Ask the customers to confirm their email, 1 for yes, 0 for no' locale=$locale}, NULL, NULL, NULL),
    (54, '{$locale}', {intl l='[Firewall/Bruteforce] Time to wait between X attempts' locale=$locale}, NULL, NULL, NULL),
    (55, '{$locale}', {intl l='[Firewall] Time to wait between X attempts' locale=$locale}, NULL, NULL, NULL),
    (56, '{$locale}', {intl l='[Firewall/Bruteforce] Number of allowed attemps' locale=$locale}, NULL, NULL, NULL),
    (57, '{$locale}', {intl l='[Firewall] Number of allowed attemps' locale=$locale}, NULL, NULL, NULL),
