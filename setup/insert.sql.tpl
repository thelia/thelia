...
(8, 'Nederlands', 'nl', 'nl_NL', '', 'd/m/Y', 'H:i:s', 'd/m/Y H:i:s', ',', '.', '2', '1', '0', '0', NOW(), NOW());
...
{foreach $locales as $locale}
    ...
    (19, '{$locale}', {intl l='Palau' locale=$locale}, NULL, NULL, NULL),
    ...
    (24, '{$locale}', {intl l='Belarus' locale=$locale}, NULL, NULL, NULL),
    ...
    (273, '{$locale}', {intl l='Taïwan' locale=$locale}, NULL, NULL, NULL),
    (274, '{$locale}', {intl l='Anguilla' locale=$locale}, NULL, NULL, NULL),
    (275, '{$locale}', {intl l='Antarctica' locale=$locale}, NULL, NULL, NULL),
    (276, '{$locale}', {intl l='American Samoa' locale=$locale}, NULL, NULL, NULL),
    (277, '{$locale}', {intl l='Aruba' locale=$locale}, NULL, NULL, NULL),
    (278, '{$locale}', {intl l='Åland Islands' locale=$locale}, NULL, NULL, NULL),
    (279, '{$locale}', {intl l='Bermuda' locale=$locale}, NULL, NULL, NULL),
    (280, '{$locale}', {intl l='Bonaire, Sint Eustatius and Saba' locale=$locale}, NULL, NULL, NULL),
    (281, '{$locale}', {intl l='Bouvet Island' locale=$locale}, NULL, NULL, NULL),
    (282, '{$locale}', {intl l='Cocos (Keeling) Islands' locale=$locale}, NULL, NULL, NULL),
    (283, '{$locale}', {intl l='Curaçao' locale=$locale}, NULL, NULL, NULL),
    (284, '{$locale}', {intl l='Christmas Island' locale=$locale}, NULL, NULL, NULL),
    (285, '{$locale}', {intl l='Western Sahara' locale=$locale}, NULL, NULL, NULL),
    (286, '{$locale}', {intl l='Falkland Islands (Malvinas)' locale=$locale}, NULL, NULL, NULL),
    (287, '{$locale}', {intl l='Faroe Islands' locale=$locale}, NULL, NULL, NULL),
    (288, '{$locale}', {intl l='Guernsey' locale=$locale}, NULL, NULL, NULL),
    (289, '{$locale}', {intl l='Gibraltar' locale=$locale}, NULL, NULL, NULL),
    (290, '{$locale}', {intl l='Greenland' locale=$locale}, NULL, NULL, NULL),
    (291, '{$locale}', {intl l='South Georgia and the South Sandwich Islands' locale=$locale}, NULL, NULL, NULL),
    (292, '{$locale}', {intl l='Guam' locale=$locale}, NULL, NULL, NULL),
    (293, '{$locale}', {intl l='Heard Island and McDonald Islands' locale=$locale}, NULL, NULL, NULL),
    (294, '{$locale}', {intl l='Isle of Man' locale=$locale}, NULL, NULL, NULL),
    (295, '{$locale}', {intl l='British Indian Ocean Territory' locale=$locale}, NULL, NULL, NULL),
    (296, '{$locale}', {intl l='Jersey' locale=$locale}, NULL, NULL, NULL),
    (297, '{$locale}', {intl l='Cayman Islands' locale=$locale}, NULL, NULL, NULL),
    (298, '{$locale}', {intl l='Montenegro' locale=$locale}, NULL, NULL, NULL),
    (299, '{$locale}', {intl l='Macao' locale=$locale}, NULL, NULL, NULL),
    (300, '{$locale}', {intl l='Northern Mariana Islands' locale=$locale}, NULL, NULL, NULL),
    (301, '{$locale}', {intl l='Montserrat' locale=$locale}, NULL, NULL, NULL),
    (302, '{$locale}', {intl l='Norfolk Island' locale=$locale}, NULL, NULL, NULL),
    (303, '{$locale}', {intl l='Pitcairn' locale=$locale}, NULL, NULL, NULL),
    (304, '{$locale}', {intl l='Puerto Rico' locale=$locale}, NULL, NULL, NULL),
    (305, '{$locale}', {intl l='State of Palestine' locale=$locale}, NULL, NULL, NULL),
    (306, '{$locale}', {intl l='Serbia' locale=$locale}, NULL, NULL, NULL),
    (307, '{$locale}', {intl l='Saint Helena, Ascension and Tristan da Cunha' locale=$locale}, NULL, NULL, NULL),
    (308, '{$locale}', {intl l='Svalbard and Jan Mayen' locale=$locale}, NULL, NULL, NULL),
    (309, '{$locale}', {intl l='South Sudan' locale=$locale}, NULL, NULL, NULL),
    (310, '{$locale}', {intl l='Sint Maarten (Dutch part)' locale=$locale}, NULL, NULL, NULL),
    (311, '{$locale}', {intl l='Turks and Caicos Islands' locale=$locale}, NULL, NULL, NULL),
    (312, '{$locale}', {intl l='Tokelau' locale=$locale}, NULL, NULL, NULL),
    (313, '{$locale}', {intl l='Timor-Leste' locale=$locale}, NULL, NULL, NULL),
    (314, '{$locale}', {intl l='United States Minor Outlying Islands' locale=$locale}, NULL, NULL, NULL),
    (315, '{$locale}', {intl l='Virgin Islands (British)' locale=$locale}, NULL, NULL, NULL),
    (316, '{$locale}', {intl l='Virgin Islands (U.S.)' locale=$locale}, NULL, NULL, NULL){if ! $locale@last},{/if}
...
{foreach $locales as $locale}
    ...
    (313, '{$locale}', {intl l='Ain' locale=$locale use_default=1}),
    (314, '{$locale}', {intl l='Aisne' locale=$locale use_default=1}),
    (315, '{$locale}', {intl l='Allier' locale=$locale use_default=1}),
    (316, '{$locale}', {intl l='Alpes-de-Haute-Provence' locale=$locale use_default=1}),
    (317, '{$locale}', {intl l='Hautes-Alpes' locale=$locale use_default=1}),
    (318, '{$locale}', {intl l='Alpes-Maritimes' locale=$locale use_default=1}),
    (319, '{$locale}', {intl l='Ardèche' locale=$locale use_default=1}),
    (320, '{$locale}', {intl l='Ardennes' locale=$locale use_default=1}),
    (321, '{$locale}', {intl l='Ariège' locale=$locale use_default=1}),
    (322, '{$locale}', {intl l='Aube' locale=$locale use_default=1}),
    (323, '{$locale}', {intl l='Aude' locale=$locale use_default=1}),
    (324, '{$locale}', {intl l='Aveyron' locale=$locale use_default=1}),
    (325, '{$locale}', {intl l='Bouches-du-Rhône' locale=$locale use_default=1}),
    (326, '{$locale}', {intl l='Calvados' locale=$locale use_default=1}),
    (327, '{$locale}', {intl l='Cantal' locale=$locale use_default=1}),
    (328, '{$locale}', {intl l='Charente' locale=$locale use_default=1}),
    (329, '{$locale}', {intl l='Charente-Maritime' locale=$locale use_default=1}),
    (330, '{$locale}', {intl l='Cher' locale=$locale use_default=1}),
    (331, '{$locale}', {intl l='Corrèze' locale=$locale use_default=1}),
    (332, '{$locale}', {intl l='Corse-du-Sud' locale=$locale use_default=1}),
    (333, '{$locale}', {intl l='Haute-Corse' locale=$locale use_default=1}),
    (334, '{$locale}', {intl l="Côte-d'Or" locale=$locale use_default=1}),
    (335, '{$locale}', {intl l="Côtes-d'Armor" locale=$locale use_default=1}),
    (336, '{$locale}', {intl l='Creuse' locale=$locale use_default=1}),
    (337, '{$locale}', {intl l='Dordogne' locale=$locale use_default=1}),
    (338, '{$locale}', {intl l='Doubs' locale=$locale use_default=1}),
    (339, '{$locale}', {intl l='Drôme' locale=$locale use_default=1}),
    (340, '{$locale}', {intl l='Eure' locale=$locale use_default=1}),
    (341, '{$locale}', {intl l='Eure-et-Loir' locale=$locale use_default=1}),
    (342, '{$locale}', {intl l='Finistère' locale=$locale use_default=1}),
    (343, '{$locale}', {intl l='Gard' locale=$locale use_default=1}),
    (344, '{$locale}', {intl l='Haute-Garonne' locale=$locale use_default=1}),
    (345, '{$locale}', {intl l='Gers' locale=$locale use_default=1}),
    (346, '{$locale}', {intl l='Gironde' locale=$locale use_default=1}),
    (347, '{$locale}', {intl l='Hérault' locale=$locale use_default=1}),
    (348, '{$locale}', {intl l='Ille-et-Vilaine' locale=$locale use_default=1}),
    (349, '{$locale}', {intl l='Indre' locale=$locale use_default=1}),
    (350, '{$locale}', {intl l='Indre-et-Loire' locale=$locale use_default=1}),
    (351, '{$locale}', {intl l='Isère' locale=$locale use_default=1}),
    (352, '{$locale}', {intl l='Jura' locale=$locale use_default=1}),
    (353, '{$locale}', {intl l='Landes' locale=$locale use_default=1}),
    (354, '{$locale}', {intl l='Loir-et-Cher' locale=$locale use_default=1}),
    (355, '{$locale}', {intl l='Loire' locale=$locale use_default=1}),
    (356, '{$locale}', {intl l='Haute-Loire' locale=$locale use_default=1}),
    (357, '{$locale}', {intl l='Loire-Atlantique' locale=$locale use_default=1}),
    (358, '{$locale}', {intl l='Loiret' locale=$locale use_default=1}),
    (359, '{$locale}', {intl l='Lot' locale=$locale use_default=1}),
    (360, '{$locale}', {intl l='Lot-et-Garonne' locale=$locale use_default=1}),
    (361, '{$locale}', {intl l='Lozère' locale=$locale use_default=1}),
    (362, '{$locale}', {intl l='Maine-et-Loire' locale=$locale use_default=1}),
    (363, '{$locale}', {intl l='Manche' locale=$locale use_default=1}),
    (364, '{$locale}', {intl l='Marne' locale=$locale use_default=1}),
    (365, '{$locale}', {intl l='Haute-Marne' locale=$locale use_default=1}),
    (366, '{$locale}', {intl l='Mayenne' locale=$locale use_default=1}),
    (367, '{$locale}', {intl l='Meurthe-et-Moselle' locale=$locale use_default=1}),
    (368, '{$locale}', {intl l='Meuse' locale=$locale use_default=1}),
    (369, '{$locale}', {intl l='Morbihan' locale=$locale use_default=1}),
    (370, '{$locale}', {intl l='Moselle' locale=$locale use_default=1}),
    (371, '{$locale}', {intl l='Nièvre' locale=$locale use_default=1}),
    (372, '{$locale}', {intl l='Nord' locale=$locale use_default=1}),
    (373, '{$locale}', {intl l='Oise' locale=$locale use_default=1}),
    (374, '{$locale}', {intl l='Orne' locale=$locale use_default=1}),
    (375, '{$locale}', {intl l='Pas-de-Calais' locale=$locale use_default=1}),
    (376, '{$locale}', {intl l='Puy-de-Dôme' locale=$locale use_default=1}),
    (377, '{$locale}', {intl l='Pyrénées-Atlantiques' locale=$locale use_default=1}),
    (378, '{$locale}', {intl l='Hautes-Pyrénées' locale=$locale use_default=1}),
    (379, '{$locale}', {intl l='Pyrénées-Orientales' locale=$locale use_default=1}),
    (380, '{$locale}', {intl l='Bas-Rhin' locale=$locale use_default=1}),
    (381, '{$locale}', {intl l='Haut-Rhin' locale=$locale use_default=1}),
    (382, '{$locale}', {intl l='Rhône' locale=$locale use_default=1}),
    (383, '{$locale}', {intl l='Haute-Saône' locale=$locale use_default=1}),
    (384, '{$locale}', {intl l='Saône-et-Loire' locale=$locale use_default=1}),
    (385, '{$locale}', {intl l='Sarthe' locale=$locale use_default=1}),
    (386, '{$locale}', {intl l='Savoie' locale=$locale use_default=1}),
    (387, '{$locale}', {intl l='Haute-Savoie' locale=$locale use_default=1}),
    (388, '{$locale}', {intl l='Paris' locale=$locale use_default=1}),
    (389, '{$locale}', {intl l='Seine-Maritime' locale=$locale use_default=1}),
    (390, '{$locale}', {intl l='Seine-et-Marne' locale=$locale use_default=1}),
    (391, '{$locale}', {intl l='Yvelines' locale=$locale use_default=1}),
    (392, '{$locale}', {intl l='Deux-Sèvres' locale=$locale use_default=1}),
    (393, '{$locale}', {intl l='Somme' locale=$locale use_default=1}),
    (394, '{$locale}', {intl l='Tarn' locale=$locale use_default=1}),
    (395, '{$locale}', {intl l='Tarn-et-Garonne' locale=$locale use_default=1}),
    (396, '{$locale}', {intl l='Var' locale=$locale use_default=1}),
    (397, '{$locale}', {intl l='Vaucluse' locale=$locale use_default=1}),
    (398, '{$locale}', {intl l='Vendée' locale=$locale use_default=1}),
    (399, '{$locale}', {intl l='Vienne' locale=$locale use_default=1}),
    (400, '{$locale}', {intl l='Haute-Vienne' locale=$locale use_default=1}),
    (401, '{$locale}', {intl l='Vosges' locale=$locale use_default=1}),
    (402, '{$locale}', {intl l='Yonne' locale=$locale use_default=1}),
    (403, '{$locale}', {intl l='Territoire de Belfort' locale=$locale use_default=1}),
    (404, '{$locale}', {intl l='Essonne' locale=$locale use_default=1}),
    (405, '{$locale}', {intl l='Hauts-de-Seine' locale=$locale use_default=1}),
    (406, '{$locale}', {intl l='Seine-Saint-Denis' locale=$locale use_default=1}),
    (407, '{$locale}', {intl l='Val-de-Marne' locale=$locale use_default=1}),
    (408, '{$locale}', {intl l="Val-d'Oise" locale=$locale use_default=1}),
    (409, '{$locale}', {intl l='Guadeloupe' locale=$locale use_default=1}),
    (410, '{$locale}', {intl l='Martinique' locale=$locale use_default=1}),
    (411, '{$locale}', {intl l='Guyane' locale=$locale use_default=1}),
    (412, '{$locale}', {intl l='La Réunion' locale=$locale use_default=1}),
    (413, '{$locale}', {intl l='Mayotte' locale=$locale use_default=1}),
    (414, '{$locale}', {intl l='Sud Sardegna' locale=$locale}){if ! $locale@last},{/if}
