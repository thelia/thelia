...
return [
    ...
    'A {{ config("store_name") }} account has been created for you' => '{{ config("store_name") }} účet bol vytvorený pre vás',
    ...
    'Your subscription to %store newsletter' => 'Odoberanie noviniek {{ config("store_name") }}',
    'Yuan' => 'Yuan',
    'Yucatán' => 'Yucatán',
    'Yukon' => 'Yukon',
    'Zacatecas' => 'Zacatecas',
