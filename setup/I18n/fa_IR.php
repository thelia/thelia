...
return [
    ...
    'Your account information on {{ config("store_name") }} has been changed.' => 'اطلاعات حساب شما در {{ config("store_name") }} تغییر کرد.',
    'Your new passord is : {{ password }}' => 'رمزعبور جدید شما: {{ password }}',
    'Your new password' => 'رمز عبور جدید شما',
    'Your new password for {{ config("store_name") }}' => 'رمزعبور جدید شما برای {{ config("store_name") }}',
    'Your order {{ order_ref }} at {{ config("store_name") }}' => 'سفارش شما {{ order_ref }} در {{ config("store_name") }}',
    'Zaire' => 'زئیر',
    'Zambia' => 'زامبیا',
    'Zimbabwe' => 'زیمباوه',
];
