...
return [
    ...
    'A {{ config("store_name") }} account has been created for you' => '{{ config("store_name") }} konto zostało utworzone dla Ciebie',
    ...
    'New order {{ order_ref }} placed on {{ config("store_name") }}' => 'Nowe zamówienie {{ order_ref }} złożone w {{ config("store_name") }}',
    'Nicaragua' => 'Nikaragua',
    'Niger' => 'Niger',
    'Nigeria' => 'Nigeria',
    'Niue' => 'Niue',
    ...
    'Your account information on {{ config("store_name") }} has been changed.' => 'Informacje o twoim koncie na {{ config("store_name") }} zostały zmienione.',
    'Your new passord is : {{ password }}' => 'Twoje nowe hasło: {{ password }}',
    'Your new password' => 'Twoje nowe hasło',
    'Your new password for {{ config("store_name") }}' => 'Twoje nowe hasło dla {{ config("store_name") }}',
    'Your order {{ order_ref }} at {{ config("store_name") }}' => 'Twoje zamówienie {{ order_ref }} w {{ config("store_name") }}',
    'Zaire' => 'Zair',
    'Zambia' => 'Zambia',
    'Zimbabwe' => 'Zimbabwe',
];
