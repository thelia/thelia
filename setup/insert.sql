...
(7, 'en_US', 'Name of the active mailing template', NULL, NULL, NULL),
(8, 'en_US', 'Enable (1) or disable (0) URL rewriting', NULL, NULL, NULL),
(9, 'en_US', 'Name of the graphic driver used by the Imagine library (see https://imagine.readthedocs.org)', NULL, NULL, NULL),
(10, 'en_US', 'The default quality (in %) of the generated images', NULL, NULL, NULL),
(11, 'en_US', 'How original (full resolution) images are delivered in the web space (symlink or copy)', NULL, NULL, NULL),
(12, 'en_US', 'How document files are delivered in the web space (symlink or copy)', NULL, NULL, NULL),
(13, 'en_US', 'Path to the directory where images are stored', NULL, NULL, NULL),
(14, 'en_US', 'Path to the directory where documents are stored', NULL, NULL, NULL),
(15, 'en_US', 'The path to the image cache directory in the web space', NULL, NULL, NULL),
(16, 'en_US', 'The path to the document cache directory in the web space', NULL, NULL, NULL),
(17, 'en_US', 'The URL to update exchange rates', NULL, NULL, NULL),
(18, 'en_US', 'File name of the 404 (not found) view in the current template (with extension, e.g. 404.html)', NULL, NULL, NULL),
(19, 'en_US', 'Name of the template view returned when an obsolete (or inactive) product URL is invoked', NULL, NULL, NULL),
(20, 'en_US', 'Display and process prices with (0) or without (1) taxes.', NULL, NULL, NULL),
(21, 'en_US', 'Compile templates assets automatically upon asset source change (1 = yes, 0 = no)', NULL, NULL, NULL),
(22, 'en_US', '"Remember me" cookie name for administration users', NULL, NULL, NULL),
(23, 'en_US', '"Remember me" cookie expiration time, in seconds, for administration users', NULL, NULL, NULL),
(24, 'en_US', '"Remember me" cookie name for customer users', NULL, NULL, NULL),
(25, 'en_US', '"Remember me" cookie expiration time, in seconds, for customer users', NULL, NULL, NULL),
...
(3, 'fr_FR', 'Si la présence de produits en stock est ignorée, entrer la quantité maximun possible à commander', NULL, NULL, NULL),
(4, 'fr_FR', 'Nom du modèle de front-office actif', NULL, NULL, NULL),
(5, 'fr_FR', 'Nom du modèle de back-office actif', NULL, NULL, NULL),
(6, 'fr_FR', 'Nom du modèle PDF actif', NULL, NULL, NULL),
(7, 'fr_FR', 'Nom du modèle d''e-mail actif', NULL, NULL, NULL),
(8, 'fr_FR', 'Activer (1) ou désactiver (0) la réécriture d''URL', NULL, NULL, NULL),
(9, 'fr_FR', 'Nom du pilote graphique utilisé par la bibliothèque Imagine (voir https://imagine.readthedocs.org)', NULL, NULL, NULL),
(10, 'fr_FR', 'La qualité par défaut (en %) dans les images générées', NULL, NULL, NULL),
(11, 'fr_FR', 'Comment les images originales (pleine résolution) sont-elles fournises dans l''espace web (lien symbolique ou copie)', NULL, NULL, NULL),
(12, 'fr_FR', 'Comment les documents sont-ils fournis dans l''espace web (lien symbolique ou copie)', NULL, NULL, NULL),
(13, 'fr_FR', 'Chemin vers le répertoire où les images sont stockées', NULL, NULL, NULL),
(14, 'fr_FR', 'Chemin vers le répertoire où sont stockés les documents', NULL, NULL, NULL),
(15, 'fr_FR', 'Chemin vers le répertoire de cache d''image dans l''espace web', NULL, NULL, NULL),
(16, 'fr_FR', 'Chemin d''accès au répertoire de cache de document dans l''espace web', NULL, NULL, NULL),
(17, 'fr_FR', 'L''URL pour mettre à jour les taux de change', NULL, NULL, NULL),
(18, 'fr_FR', 'Nom de la page 404 (introuvable) dans le modèle actuel (avec l''extension, par exemple, 404.html)', NULL, NULL, NULL),
(19, 'fr_FR', 'Nom de la page du modèle retournée lorsqu''une URL obsolète (ou inactive) est invoquée', NULL, NULL, NULL),
(20, 'fr_FR', 'Affiche et traite les prix avec(0) ou sans (1) les taxes', NULL, NULL, NULL),
(21, 'fr_FR', 'Compiler les resources du modèle actif à chaque changement (1 = oui, 2 = non)', NULL, NULL, NULL),
(22, 'fr_FR', 'Nom du cookie "Remember me" pour les utilisateurs d''administration', NULL, NULL, NULL),
(23, 'fr_FR', 'Délai d''expiration du cookie "Remember me", en secondes, pour les utilisateurs d''administration', NULL, NULL, NULL),
(24, 'fr_FR', 'Nom du cookie "Remember me" pour les clients', NULL, NULL, NULL),
(25, 'fr_FR', 'Délai d''expiration du cookie "Remember me", en secondes, pour les clients', NULL, NULL, NULL),
(26, 'fr_FR', 'URL de base pour la boutique (par exemple http://www.yourshopdomain.com)', NULL, NULL, NULL),
(27, 'fr_FR', 'Nom de la vue de la facture dans le modèle PDF en cours (sans extension)', NULL, NULL, NULL),
(28, 'fr_FR', 'Nom de la vue de la livraison dans le modèle PDF en cours (sans extension)', NULL, NULL, NULL),
(29, 'fr_FR', 'Le chemin (par rapport au modèle de back-office par défaut) vers l''image utilisée lorsque aucune image de drapeau ne peut être trouvée pour un pays', NULL, NULL, NULL),
(30, 'fr_FR', 'Niveau de découpe des espaces dans le code HTML généré (0 = aucun, 1 = moyen, 2 = maximum)', NULL, NULL, NULL);
