...
INSERT INTO `config_i18n` (`id`, `locale`, `title`, `chapo`, `description`, `postscriptum`) VALUES
    ...
    (7, 'de_DE', 'Name of the graphic driver used by the Imagine library (see https://imagine.readthedocs.org)', NULL, NULL, NULL),
    (8, 'de_DE', 'Die Standardqualität (in%) der erzeugten Bilder', NULL, NULL, NULL),
    (9, 'de_DE', 'How original (full resolution) images are delivered in the web space (symlink or copy)', NULL, NULL, NULL),
    (10, 'de_DE', 'How document files are delivered in the web space (symlink or copy)', NULL, NULL, NULL),
    ...
    (16, 'de_DE', 'Name of the template view returned when an obsolete (or inactive) product URL is invoked', NULL, NULL, NULL),
    (17, 'de_DE', 'Anzeigt und verwendet Preise mit (0) oder ohne (1) Taxen', NULL, NULL, NULL),
    (18, 'de_DE', 'Compile templates assets automatically upon asset source change (1 = yes, 0 = no)', NULL, NULL, NULL),
    ...
    (24, 'de_DE', 'Name of the invoice view in the current PDF template (without extension)', NULL, NULL, NULL),
    (25, 'de_DE', 'Name of the delivery view in the current PDF template (without extension)', NULL, NULL, NULL),
    ...
    (27, 'de_DE', 'Whitespace trim level of the generated HTML code (0 = none, 1 = medium, 2 = maximum)', NULL, NULL, NULL),
...
INSERT INTO `module_i18n` (`id`, `locale`, `title`, `chapo`, `description`, `postscriptum`) VALUES
    ...
    (20, 'de_DE', 'Virtual Product Controller', NULL, NULL, NULL),
...
INSERT INTO `hook_i18n` (`id`, `locale`, `title`, `chapo`, `description`) VALUES
    ...
    (1250, 'de_DE', 'Logs - JavaScript', NULL, NULL),
    ...
    (1264, 'de_DE', 'Layout - in top menu items', NULL, NULL),
...
INSERT INTO `country_i18n` (`id`, `locale`, `title`, `chapo`, `description`, `postscriptum`) VALUES
    ...
    (32, 'de_DE', 'Burkina', NULL, NULL, NULL),
    ...
    (52, 'de_DE', 'Djibouti', NULL, NULL, NULL),
    (53, 'de_DE', 'Dominica', NULL, NULL, NULL),
    ...
    (106, 'de_DE', 'Malaysia', NULL, NULL, NULL),
    ...
    (178, 'de_DE', 'Trinidad and Tobago', NULL, NULL, NULL),
    ...
    (196, 'de_DE', 'USA - Alaska', NULL, NULL, NULL),
    (197, 'de_DE', 'USA - Arizona', NULL, NULL, NULL),
    (198, 'de_DE', 'USA - Arkansas', NULL, NULL, NULL),
    (199, 'de_DE', 'USA - California', NULL, NULL, NULL),
    (200, 'de_DE', 'USA - Colorado', NULL, NULL, NULL),
    (201, 'de_DE', 'USA - Connecticut', NULL, NULL, NULL),
    (202, 'de_DE', 'USA - Delaware', NULL, NULL, NULL),
    (203, 'de_DE', 'USA - District Of Columbia', NULL, NULL, NULL),
    (204, 'de_DE', 'USA - Florida', NULL, NULL, NULL),
    (205, 'de_DE', 'USA - Georgia', NULL, NULL, NULL),
    (206, 'de_DE', 'USA - Hawaii', NULL, NULL, NULL),
    (207, 'de_DE', 'USA - Idaho', NULL, NULL, NULL),
    (208, 'de_DE', 'USA - Illinois', NULL, NULL, NULL),
    (209, 'de_DE', 'USA - Indiana', NULL, NULL, NULL),
    (210, 'de_DE', 'USA - Iowa', NULL, NULL, NULL),
    (211, 'de_DE', 'USA - Kansas', NULL, NULL, NULL),
    (212, 'de_DE', 'USA - Kentucky', NULL, NULL, NULL),
    (213, 'de_DE', 'USA - Louisiana', NULL, NULL, NULL),
    (214, 'de_DE', 'USA - Maine', NULL, NULL, NULL),
    (215, 'de_DE', 'USA - Maryland', NULL, NULL, NULL),
    (216, 'de_DE', 'USA - Massachusetts', NULL, NULL, NULL),
    (217, 'de_DE', 'USA - Michigan', NULL, NULL, NULL),
    (218, 'de_DE', 'USA - Minnesota', NULL, NULL, NULL),
    (219, 'de_DE', 'USA - Mississippi', NULL, NULL, NULL),
    (220, 'de_DE', 'USA - Missouri', NULL, NULL, NULL),
    (221, 'de_DE', 'USA - Montana', NULL, NULL, NULL),
    (222, 'de_DE', 'USA - Nebraska', NULL, NULL, NULL),
    (223, 'de_DE', 'USA - Nevada', NULL, NULL, NULL),
    (224, 'de_DE', 'USA - New Hampshire', NULL, NULL, NULL),
    (225, 'de_DE', 'USA - New Jersey', NULL, NULL, NULL),
    (226, 'de_DE', 'USA - New Mexico', NULL, NULL, NULL),
    (227, 'de_DE', 'USA - New York', NULL, NULL, NULL),
    (228, 'de_DE', 'USA - North Carolina', NULL, NULL, NULL),
    (229, 'de_DE', 'USA - North Dakota', NULL, NULL, NULL),
    (230, 'de_DE', 'USA - Ohio', NULL, NULL, NULL),
    (231, 'de_DE', 'USA - Oklahoma', NULL, NULL, NULL),
    (232, 'de_DE', 'USA - Oregon', NULL, NULL, NULL),
    (233, 'de_DE', 'USA - Pennsylvania', NULL, NULL, NULL),
    (234, 'de_DE', 'USA - Rhode Island', NULL, NULL, NULL),
    (235, 'de_DE', 'USA - South Carolina', NULL, NULL, NULL),
    (236, 'de_DE', 'USA - South Dakota', NULL, NULL, NULL),
    (237, 'de_DE', 'USA - Tennessee', NULL, NULL, NULL),
    (238, 'de_DE', 'USA - Texas', NULL, NULL, NULL),
    (239, 'de_DE', 'USA - Utah', NULL, NULL, NULL),
    (240, 'de_DE', 'USA - Vermont', NULL, NULL, NULL),
    (241, 'de_DE', 'USA - Virginia', NULL, NULL, NULL),
    (242, 'de_DE', 'USA - Washington', NULL, NULL, NULL),
    (243, 'de_DE', 'USA - West Virginia', NULL, NULL, NULL),
    (244, 'de_DE', 'USA - Wisconsin', NULL, NULL, NULL),
    (245, 'de_DE', 'USA - Wyoming', NULL, NULL, NULL),
    (246, 'de_DE', 'Kanada - British Columbia', NULL, NULL, NULL),
    ...
    (251, 'de_DE', 'Kanada - Quebec', NULL, NULL, NULL),
    (252, 'de_DE', 'Kanada - New Brunswick', NULL, NULL, NULL),
    (253, 'de_DE', 'Kanada - Nova Scotia', NULL, NULL, NULL),
    (254, 'de_DE', 'Kanada - Prince Edward Island', NULL, NULL, NULL),
    (255, 'de_DE', 'Kanada - Neufundland und Labrador', NULL, NULL, NULL),
    (256, 'de_DE', 'Kanada - Yukon', NULL, NULL, NULL),
    (257, 'de_DE', 'Kanada - Nordwest-Territorien', NULL, NULL, NULL),
    ...
    (268, 'de_DE', 'USA - Alabama', NULL, NULL, NULL),
