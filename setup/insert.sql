...
INSERT INTO `state_i18n` (`id`, `locale`, `title`) VALUES
    ...
    (409, 'es_ES', 'Guadeloupe'),
    (410, 'es_ES', 'Martinique'),
    (411, 'es_ES', 'Guyane'),
    ...
    (409, 'it_IT', 'Guadeloupe'),
    (410, 'it_IT', 'Martinique'),
    (411, 'it_IT', 'Guyane'),
...
INSERT INTO `message_i18n` (`id`, `locale`, `title`, `subject`, `text_message`, `html_message`) VALUES
    ...
    (2, 'de_DE', 'Ihr neues Passwort', 'Ihr neues Passwort für {{ config(\"store_name\") }}', NULL, NULL),
    ...
    (2, 'en_US', 'Your new password', 'Your new password for {{ config(\"store_name\") }}', NULL, NULL),
    ...
    (2, 'es_ES', 'Su nueva contraseña', 'Su nueva contraseña para {{ config(\"store_name\") }}', NULL, NULL),
    ...
    (2, 'fr_FR', 'Votre nouveau mot de passe', 'Votre nouveau mot de passe {{ config(\"store_name\") }}', NULL, NULL),
    ...
    (2, 'ru_RU', 'Ваш новый пароль', 'Ваш новый пароль для {{ config(\"store_name\") }}', NULL, NULL),
