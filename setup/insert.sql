...
(5, 'order.invoice.after.javascript.initialization', 1, 0, 0, 1, 1, 1, NOW(), NOW()),
...
(10, 'order.payment.gateway.after.javascript.initialization', 1, 0, 0, 1, 1, 1, NOW(), NOW()),
...
(18, 'currency.after.javascript.initialization', 1, 0, 0, 1, 1, 1, NOW(), NOW()),
...
(27, 'login.after.javascript.initialization', 1, 0, 0, 1, 1, 1, NOW(), NOW()),
...
(34, 'account.update.after.javascript.initialization', 1, 0, 0, 1, 1, 1, NOW(), NOW()),
...
(46, 'contact.after.javascript.initialization', 1, 0, 0, 1, 1, 1, NOW(), NOW()),
...
(50, 'order.placed.after.javascript.initialization', 1, 0, 0, 1, 1, 1, NOW(), NOW()),
(51, 'search.stylesheet', 1, 0, 0, 1, 1, 1, NOW(), NOW()),
(52, 'search.after.javascript.include', 1, 0, 0, 1, 1, 1, NOW(), NOW()),
(53, 'search.after.javascript.initialization', 1, 0, 0, 1, 1, 1, NOW(), NOW()),
...
(60, 'register.after.javascript.initialization', 1, 0, 0, 1, 1, 1, NOW(), NOW()),
...
(67, 'password.after.javascript.initialization', 1, 0, 0, 1, 1, 1, NOW(), NOW()),
...
(72, 'language.after.javascript.initialization', 1, 0, 0, 1, 1, 1, NOW(), NOW()),
...
(78, 'newsletter.after.javascript.initialization', 1, 0, 0, 1, 1, 1, NOW(), NOW()),
...
(88, 'content.after.javascript.initialization', 1, 0, 0, 1, 1, 1, NOW(), NOW()),
(89, 'main.head.top', 1, 0, 0, 1, 1, 1, NOW(), NOW()),
(90, 'main.head.bottom', 1, 0, 0, 1, 1, 1, NOW(), NOW()),
(91, 'main.body.top', 1, 0, 0, 1, 1, 1, NOW(), NOW()),
(92, 'main.header.top', 1, 0, 0, 1, 1, 1, NOW(), NOW()),
(93, 'main.navbar.secondary', 1, 0, 0, 1, 1, 1, NOW(), NOW()),
(94, 'main.navbar.primary', 1, 0, 0, 1, 1, 1, NOW(), NOW()),
(95, 'main.header.bottom', 1, 0, 0, 1, 1, 1, NOW(), NOW()),
(96, 'main.content.top', 1, 0, 0, 1, 1, 1, NOW(), NOW()),
(97, 'main.content.bottom', 1, 0, 0, 1, 1, 1, NOW(), NOW()),
(98, 'main.footer.top', 1, 0, 0, 1, 1, 1, NOW(), NOW()),
(99, 'main.footer.body', 1, 0, 0, 1, 1, 1, NOW(), NOW()),
(100, 'main.footer.bottom', 1, 0, 0, 1, 1, 1, NOW(), NOW()),
(101, 'main.body.bottom', 1, 0, 0, 1, 1, 1, NOW(), NOW()),
(102, '404.content', 1, 0, 0, 1, 1, 1, NOW(), NOW()),
(103, '404.stylesheet', 1, 0, 0, 1, 1, 1, NOW(), NOW()),
(104, '404.after.javascript.include', 1, 0, 0, 1, 1, 1, NOW(), NOW()),
(105, '404.after.javascript.initialization', 1, 0, 0, 1, 1, 1, NOW(), NOW()),
(106, 'order.delivery.top', 1, 0, 0, 1, 1, 1, NOW(), NOW()),
(107, 'order.delivery.form.top', 1, 0, 0, 1, 1, 1, NOW(), NOW()),
(108, 'order.delivery.form.bottom', 1, 0, 0, 1, 1, 1, NOW(), NOW()),
(109, 'order.delivery.bottom', 1, 0, 0, 1, 1, 1, NOW(), NOW()),
(110, 'order.delivery.after.javascript.initialization', 1, 0, 0, 1, 1, 1, NOW(), NOW()),
(111, 'order.delivery.stylesheet', 1, 0, 0, 1, 1, 1, NOW(), NOW()),
(112, 'order.delivery.after.javascript.include', 1, 0, 0, 1, 1, 1, NOW(), NOW()),
(113, 'address.create.top', 1, 0, 0, 1, 1, 1, NOW(), NOW()),
(114, 'address.create.form.top', 1, 0, 0, 1, 1, 1, NOW(), NOW()),
(115, 'address.create.form.bottom', 1, 0, 0, 1, 1, 1, NOW(), NOW()),
(116, 'address.create.bottom', 1, 0, 0, 1, 1, 1, NOW(), NOW()),
(117, 'address.create.stylesheet', 1, 0, 0, 1, 1, 1, NOW(), NOW()),
(118, 'address.create.after.javascript.include', 1, 0, 0, 1, 1, 1, NOW(), NOW()),
(119, 'address.create.after.javascript.initialization', 1, 0, 0, 1, 1, 1, NOW(), NOW()),
(120, 'folder.top', 1, 0, 0, 1, 1, 1, NOW(), NOW()),
(121, 'folder.main.top', 1, 0, 0, 1, 1, 1, NOW(), NOW()),
(122, 'folder.main.bottom', 1, 0, 0, 1, 1, 1, NOW(), NOW()),
(123, 'folder.bottom', 1, 0, 0, 1, 1, 1, NOW(), NOW()),
(124, 'folder.stylesheet', 1, 0, 0, 1, 1, 1, NOW(), NOW()),
(125, 'folder.after.javascript.include', 1, 0, 0, 1, 1, 1, NOW(), NOW()),
(126, 'folder.after.javascript.initialization', 1, 0, 0, 1, 1, 1, NOW(), NOW()),
(127, 'order.failed.top', 1, 0, 0, 1, 1, 1, NOW(), NOW()),
(128, 'order.failed.bottom', 1, 0, 0, 1, 1, 1, NOW(), NOW()),
(129, 'order.failed.stylesheet', 1, 0, 0, 1, 1, 1, NOW(), NOW()),
(130, 'order.failed.after.javascript.include', 1, 0, 0, 1, 1, 1, NOW(), NOW()),
(131, 'order.failed.after.javascript.initialization', 1, 0, 0, 1, 1, 1, NOW(), NOW()),
(132, 'category.top', 1, 0, 0, 1, 1, 1, NOW(), NOW()),
(133, 'category.main.top', 1, 0, 0, 1, 1, 1, NOW(), NOW()),
(134, 'category.main.bottom', 1, 0, 0, 1, 1, 1, NOW(), NOW()),
(135, 'category.bottom', 1, 0, 0, 1, 1, 1, NOW(), NOW()),
(136, 'category.stylesheet', 1, 0, 0, 1, 1, 1, NOW(), NOW()),
(137, 'category.after.javascript.include', 1, 0, 0, 1, 1, 1, NOW(), NOW()),
(138, 'category.after.javascript.initialization', 1, 0, 0, 1, 1, 1, NOW(), NOW()),
(139, 'address.update.top', 1, 0, 0, 1, 1, 1, NOW(), NOW()),
(140, 'address.update.form.top', 1, 0, 0, 1, 1, 1, NOW(), NOW()),
(141, 'address.update.form.bottom', 1, 0, 0, 1, 1, 1, NOW(), NOW()),
(142, 'address.update.bottom', 1, 0, 0, 1, 1, 1, NOW(), NOW()),
(143, 'address.update.stylesheet', 1, 0, 0, 1, 1, 1, NOW(), NOW()),
(144, 'address.update.after.javascript.include', 1, 0, 0, 1, 1, 1, NOW(), NOW()),
(145, 'address.update.after.javascript.initialization', 1, 0, 0, 1, 1, 1, NOW(), NOW()),
(146, 'home.body', 1, 0, 0, 1, 1, 1, NOW(), NOW()),
(147, 'home.stylesheet', 1, 0, 0, 1, 1, 1, NOW(), NOW()),
(148, 'home.after.javascript.include', 1, 0, 0, 1, 1, 1, NOW(), NOW()),
(149, 'home.after.javascript.initialization', 1, 0, 0, 1, 1, 1, NOW(), NOW()),
(150, 'account.password.top', 1, 0, 0, 1, 1, 1, NOW(), NOW()),
(151, 'account.password.bottom', 1, 0, 0, 1, 1, 1, NOW(), NOW()),
(152, 'account.password.stylesheet', 1, 0, 0, 1, 1, 1, NOW(), NOW()),
(153, 'account.password.after.javascript.include', 1, 0, 0, 1, 1, 1, NOW(), NOW()),
(154, 'account.password.after.javascript.initialization', 1, 0, 0, 1, 1, 1, NOW(), NOW()),
(155, 'product.top', 1, 0, 0, 1, 1, 1, NOW(), NOW()),
(156, 'product.gallery', 1, 0, 0, 1, 1, 1, NOW(), NOW()),
(157, 'product.details.top', 1, 0, 0, 1, 1, 1, NOW(), NOW()),
(158, 'product.details.bottom', 1, 0, 0, 1, 1, 1, NOW(), NOW()),
(159, 'product.additional', 1, 0, 1, 1, 1, 1, NOW(), NOW()),
(160, 'product.bottom', 1, 0, 0, 1, 1, 1, NOW(), NOW()),
(161, 'product.stylesheet', 1, 0, 0, 1, 1, 1, NOW(), NOW()),
(162, 'product.after.javascript.include', 1, 0, 0, 1, 1, 1, NOW(), NOW()),
(163, 'product.after.javascript.initialization', 1, 0, 0, 1, 1, 1, NOW(), NOW()),
(164, 'account.top', 1, 0, 0, 1, 1, 1, NOW(), NOW()),
(165, 'account.bottom', 1, 0, 0, 1, 1, 1, NOW(), NOW()),
(166, 'account.stylesheet', 1, 0, 0, 1, 1, 1, NOW(), NOW()),
(167, 'account.after.javascript.include', 1, 0, 0, 1, 1, 1, NOW(), NOW()),
(168, 'account.after.javascript.initialization', 1, 0, 0, 1, 1, 1, NOW(), NOW()),
(169, 'view-all.top', 1, 0, 0, 1, 1, 1, NOW(), NOW()),
(170, 'view-all.bottom', 1, 0, 0, 1, 1, 1, NOW(), NOW()),
(171, 'view-all.stylesheet', 1, 0, 0, 1, 1, 1, NOW(), NOW()),
(172, 'view-all.after.javascript.include', 1, 0, 0, 1, 1, 1, NOW(), NOW()),
(173, 'view-all.after.javascript.initialization', 1, 0, 0, 1, 1, 1, NOW(), NOW()),
(174, 'single-product.top', 1, 0, 0, 1, 1, 1, NOW(), NOW()),
(175, 'single-product.bottom', 1, 0, 0, 1, 1, 1, NOW(), NOW()),
(176, 'category.sidebar.top', 1, 0, 0, 1, 1, 1, NOW(), NOW()),
(177, 'category.sidebar.body', 1, 0, 0, 1, 1, 1, NOW(), NOW()),
(178, 'category.sidebar.bottom', 1, 0, 0, 1, 1, 1, NOW(), NOW()),
(179, 'content.sidebar.top', 1, 0, 0, 1, 1, 1, NOW(), NOW()),
(180, 'content.sidebar.body', 1, 0, 0, 1, 1, 1, NOW(), NOW()),
(181, 'content.sidebar.bottom', 1, 0, 0, 1, 1, 1, NOW(), NOW()),
(182, 'order.delivery.extra', 1, 1, 0, 1, 1, 1, NOW(), NOW()),
(183, 'order.delivery.javascript', 1, 1, 0, 1, 1, 1, NOW(), NOW())
;
