...
INSERT INTO `hook` (`id`, `code`, `type`, `by_module`, `native`, `activate`, `position`, `created_at`, `updated_at`) VALUES
(1, '404.content', 1, 0, 1, 1, 1, NOW(), NOW())
,(2, 'account.bottom', 1, 0, 1, 1, 1, NOW(), NOW())
,(3, 'account.password.bottom', 1, 0, 1, 1, 1, NOW(), NOW())
,(4, 'account.password.top', 1, 0, 1, 1, 1, NOW(), NOW())
,(5, 'account.top', 1, 0, 1, 1, 1, NOW(), NOW())
,(6, 'account.update.bottom', 1, 0, 1, 1, 1, NOW(), NOW())
,(7, 'account.update.form.bottom', 1, 0, 1, 1, 1, NOW(), NOW())
,(8, 'account.update.form.top', 1, 0, 1, 1, 1, NOW(), NOW())
,(9, 'account.update.top', 1, 0, 1, 1, 1, NOW(), NOW())
,(10, 'address.create.bottom', 1, 0, 1, 1, 1, NOW(), NOW())
,(11, 'address.create.form.bottom', 1, 0, 1, 1, 1, NOW(), NOW())
,(12, 'address.create.form.top', 1, 0, 1, 1, 1, NOW(), NOW())
,(13, 'address.create.top', 1, 0, 1, 1, 1, NOW(), NOW())
,(14, 'address.update.bottom', 1, 0, 1, 1, 1, NOW(), NOW())
,(15, 'address.update.form.bottom', 1, 0, 1, 1, 1, NOW(), NOW())
,(16, 'address.update.form.top', 1, 0, 1, 1, 1, NOW(), NOW())
,(17, 'address.update.top', 1, 0, 1, 1, 1, NOW(), NOW())
,(18, 'cart.bottom', 1, 0, 1, 1, 1, NOW(), NOW())
,(19, 'cart.top', 1, 0, 1, 1, 1, NOW(), NOW())
,(20, 'category.bottom', 1, 0, 1, 1, 1, NOW(), NOW())
,(21, 'category.main.bottom', 1, 0, 1, 1, 1, NOW(), NOW())
,(22, 'category.main.top', 1, 0, 1, 1, 1, NOW(), NOW())
,(23, 'category.top', 1, 0, 1, 1, 1, NOW(), NOW())
,(24, 'category.view.sidebar.body', 1, 0, 1, 1, 1, NOW(), NOW())
,(25, 'category.view.sidebar.bottom', 1, 0, 1, 1, 1, NOW(), NOW())
,(26, 'category.view.sidebar.top', 1, 0, 1, 1, 1, NOW(), NOW())
,(27, 'contact.bottom', 1, 0, 1, 1, 1, NOW(), NOW())
,(28, 'contact.form.bottom', 1, 0, 1, 1, 1, NOW(), NOW())
,(29, 'contact.form.top', 1, 0, 1, 1, 1, NOW(), NOW())
,(30, 'contact.success', 1, 0, 1, 1, 1, NOW(), NOW())
,(31, 'contact.top', 1, 0, 1, 1, 1, NOW(), NOW())
,(32, 'content.bottom', 1, 0, 1, 1, 1, NOW(), NOW())
,(33, 'content.main.bottom', 1, 0, 1, 1, 1, NOW(), NOW())
,(34, 'content.main.top', 1, 0, 1, 1, 1, NOW(), NOW())
,(35, 'content.top', 1, 0, 1, 1, 1, NOW(), NOW())
,(36, 'content.view.sidebar.body', 1, 0, 1, 1, 1, NOW(), NOW())
,(37, 'content.view.sidebar.bottom', 1, 0, 1, 1, 1, NOW(), NOW())
,(38, 'content.view.sidebar.top', 1, 0, 1, 1, 1, NOW(), NOW())
,(39, 'currency.bottom', 1, 0, 1, 1, 1, NOW(), NOW())
,(40, 'currency.top', 1, 0, 1, 1, 1, NOW(), NOW())
,(41, 'folder.main.bottom', 1, 0, 1, 1, 1, NOW(), NOW())
,(42, 'folder.main.top', 1, 0, 1, 1, 1, NOW(), NOW())
,(43, 'folder.bottom', 1, 0, 1, 1, 1, NOW(), NOW())
,(44, 'folder.top', 1, 0, 1, 1, 1, NOW(), NOW())
,(45, 'home.body', 1, 0, 1, 1, 1, NOW(), NOW())
,(46, 'login.bottom', 1, 0, 1, 1, 1, NOW(), NOW())
,(47, 'login.form.bottom', 1, 0, 1, 1, 1, NOW(), NOW())
,(48, 'login.form.top', 1, 0, 1, 1, 1, NOW(), NOW())
,(49, 'login.main.bottom', 1, 0, 1, 1, 1, NOW(), NOW())
,(50, 'login.main.top', 1, 0, 1, 1, 1, NOW(), NOW())
,(51, 'login.top', 1, 0, 1, 1, 1, NOW(), NOW())
,(52, 'main-body-bottom', 1, 0, 1, 1, 1, NOW(), NOW())
,(53, 'main.body.top', 1, 0, 1, 1, 1, NOW(), NOW())
,(54, 'main.content.bottom', 1, 0, 1, 1, 1, NOW(), NOW())
,(55, 'main.content.top', 1, 0, 1, 1, 1, NOW(), NOW())
,(56, 'main.footer.body', 1, 0, 1, 1, 1, NOW(), NOW())
,(57, 'main.footer.bottom', 1, 0, 1, 1, 1, NOW(), NOW())
,(58, 'main.footer.top', 1, 0, 1, 1, 1, NOW(), NOW())
,(59, 'main.head.bottom', 1, 0, 1, 1, 1, NOW(), NOW())
,(60, 'main.head.top', 1, 0, 1, 1, 1, NOW(), NOW())
,(61, 'main.header.bottom', 1, 0, 1, 1, 1, NOW(), NOW())
,(62, 'main.header.top', 1, 0, 1, 1, 1, NOW(), NOW())
,(63, 'main.navebar.primary', 1, 0, 1, 1, 1, NOW(), NOW())
,(64, 'main.navebar.secondary', 1, 0, 1, 1, 1, NOW(), NOW())
,(65, 'newsletter.bottom', 1, 0, 1, 1, 1, NOW(), NOW())
,(66, 'newsletter.top', 1, 0, 1, 1, 1, NOW(), NOW())
,(67, 'order.failed.bottom', 1, 0, 1, 1, 1, NOW(), NOW())
,(68, 'order.failed.top', 1, 0, 1, 1, 1, NOW(), NOW())
,(69, 'password.bottom', 1, 0, 1, 1, 1, NOW(), NOW())
,(70, 'password.form.bottom', 1, 0, 1, 1, 1, NOW(), NOW())
,(71, 'password.form.top', 1, 0, 1, 1, 1, NOW(), NOW())
,(72, 'password.top', 1, 0, 1, 1, 1, NOW(), NOW())
,(73, 'product.bottom', 1, 0, 1, 1, 1, NOW(), NOW())
,(74, 'product.details.bottom', 1, 0, 1, 1, 1, NOW(), NOW())
,(75, 'product.details.top', 1, 0, 1, 1, 1, NOW(), NOW())
,(76, 'product.gallery', 1, 0, 1, 1, 1, NOW(), NOW())
,(77, 'product.top', 1, 0, 1, 1, 1, NOW(), NOW())
,(78, 'register.bottom', 1, 0, 1, 1, 1, NOW(), NOW())
,(79, 'register.form.bottom', 1, 0, 1, 1, 1, NOW(), NOW())
,(81, 'register.form.top', 1, 0, 1, 1, 1, NOW(), NOW())
,(82, 'register.top', 1, 0, 1, 1, 1, NOW(), NOW())
,(83, 'single-product.bottom', 1, 0, 1, 1, 1, NOW(), NOW())
,(84, 'single-product.top', 1, 0, 1, 1, 1, NOW(), NOW())
,(85, 'sitemap.bottom', 1, 0, 1, 1, 1, NOW(), NOW())
,(86, 'view-all.bottom', 1, 0, 1, 1, 1, NOW(), NOW())
,(87, 'view-all.top', 1, 0, 1, 1, 1, NOW(), NOW())
,(88, 'order.delivery.extra', 1, 1, 1, 1, 1, NOW(), NOW())
,(89, 'order.delivery.js', 1, 1, 1, 1, 1, NOW(), NOW())
;
...
,(88, 'en_US', 'order.delivery.extra', '',  NULL)
,(89, 'en_US', 'order.delivery.js', '',  NULL)
...
,(88, 'fr_FR', 'order.delivery.extra', '',  NULL)
,(89, 'fr_FR', 'order.delivery.js', '',  NULL)
;
