...
INSERT INTO `config_i18n` (`id`, `locale`, `title`, `chapo`, `description`, `postscriptum`) VALUES
    ...
    (62, 'en_US', 'Stay on the default language at use arrows \"Next\" and \"Previous\" on the product, category, content, folder and brand page', NULL, NULL, NULL),    (1, 'es_ES', NULL, NULL, NULL, NULL),
    ...
    (62, 'es_ES', NULL, NULL, NULL, NULL),    (1, 'fr_FR', 'Vérifier la présence de produits en stock (1) ou l\'ignorer (0) lors de l\'affichage et la modification des quantités commandées', NULL, NULL, NULL),
    ...
    (62, 'fr_FR', 'Rester sur la langue par défaut pour l\'utilisation des flèches \"Suivant\" et \"Précédent\" sur les pages produit, catégorie, contenu, dossier et marque', NULL, NULL, NULL);
