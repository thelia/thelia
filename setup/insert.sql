...
INSERT INTO `module` (`id`, `code`, `version`,  `type`, `activate`, `position`, `full_namespace`, `hidden`, `mandatory`, `created_at`, `updated_at`) VALUES
    (1, 'TwigEngine', '2.5.5', 1, 1, 1, 'TwigEngine\\TwigEngine', 0, 0, NOW(), NOW()),
    (2, 'TheliaSmarty', '2.5.5', 1, 1, 1, 'TheliaSmarty\\TheliaSmarty', 0, 0, NOW(), NOW()),
    (3, 'TheliaBlocks', '2.1.17', 1, 1, 1, 'TheliaBlocks\\TheliaBlocks', 0, 0, NOW(), NOW())
;
-- Insert front hooks
