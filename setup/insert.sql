...
(43, 'thelia_version','2.3.2', 1, 1, NOW(), NOW()),
...
INSERT INTO `message_i18n` (`id`, `locale`, `title`, `subject`, `text_message`, `html_message`) VALUES
    ...
    (7, 'en_US', 'Newsletter subscription confirmation mail', NULL, NULL, NULL),
    (8, 'en_US', 'Mail sent to the customer to confirm its account', NULL, NULL, NULL),
    ...
    (7, 'es_ES', 'Confirmación de suscripción por correo al boletín', 'Tu subscripción al boletín de {config key=\"store_name\"}', NULL, NULL),
