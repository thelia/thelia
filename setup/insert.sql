...
(43, 'thelia_version','2.5.0', 1, 1, NOW(), NOW()),
...
INSERT INTO `config_i18n` (`id`, `locale`, `title`, `chapo`, `description`, `postscriptum`) VALUES
    ...
    (73, 'cs_CZ', NULL, NULL, NULL, NULL),    (74, 'cs_CZ', NULL, NULL, NULL, NULL),    (1, 'de_DE', 'Verfügbaren Lagerbestand prüfen (1) oder ignorieren (0) beim Anzeigen und Änderung der bestellte Menge', NULL, NULL, NULL),
    ...
    (73, 'de_DE', 'Modulinstallation aus ZIP-Dateien zulassen.', NULL, NULL, NULL),    (74, 'de_DE', NULL, NULL, NULL, NULL),    (1, 'en_US', 'Check available product stock (1) or ignore it (0) when displaying and changing ordered quantity', NULL, NULL, NULL),
    ...
    (73, 'en_US', 'Allow module installation from ZIP files.', NULL, NULL, NULL),    (74, 'en_US', NULL, NULL, NULL, NULL),    (1, 'es_ES', 'Comprobar disponibilidad de stock de producto (1) o ignorar (0) cuando se muestra o cambia cantidad en pedido', NULL, NULL, NULL),
    ...
    (73, 'es_ES', 'Permitir la instalación del módulo desde archivos ZIP.', NULL, NULL, NULL),    (74, 'es_ES', NULL, NULL, NULL, NULL),    (1, 'fr_FR', 'Vérifier la présence de produits en stock (1) ou l\'ignorer (0) lors de l\'affichage et la modification des quantités commandées', NULL, NULL, NULL),
    ...
    (73, 'fr_FR', 'Autoriser l\'installation des modules par fichier ZIP.', NULL, NULL, NULL),    (74, 'fr_FR', NULL, NULL, NULL, NULL),    (1, 'it_IT', NULL, NULL, NULL, NULL),
    ...
    (73, 'it_IT', NULL, NULL, NULL, NULL),    (74, 'it_IT', NULL, NULL, NULL, NULL),    (1, 'ru_RU', 'Проверять доступный запас товара (1) или игнорировать его (0) при отображении и изменении количества в заказе', NULL, NULL, NULL),
    ...
    (73, 'ru_RU', NULL, NULL, NULL, NULL)    (74, 'ru_RU', NULL, NULL, NULL, NULL);
