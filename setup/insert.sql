...
(108, '404.after-javascript-initialization', 1, 0, 0, 1, 1, 1, NOW(), NOW()),
...
(113, 'order-delivery.after-javascript-initialization', 1, 0, 0, 1, 1, 1, NOW(), NOW()),
...
(122, 'address-create.after-javascript-initialization', 1, 0, 0, 1, 1, 1, NOW(), NOW()),
...
(129, 'folder.after-javascript-initialization', 1, 0, 0, 1, 1, 1, NOW(), NOW()),
...
(134, 'order-failed.after-javascript-initialization', 1, 0, 0, 1, 1, 1, NOW(), NOW()),
...
(141, 'category.after-javascript-initialization', 1, 0, 0, 1, 1, 1, NOW(), NOW()),
...
(148, 'address-update.after-javascript-initialization', 1, 0, 0, 1, 1, 1, NOW(), NOW()),
...
(152, 'home.after-javascript-initialization', 1, 0, 0, 1, 1, 1, NOW(), NOW()),
...
(157, 'account-password.after-javascript-initialization', 1, 0, 0, 1, 1, 1, NOW(), NOW()),
...
(166, 'product.after-javascript-initialization', 1, 0, 0, 1, 1, 1, NOW(), NOW()),
...
(171, 'account.after-javascript-initialization', 1, 0, 0, 1, 1, 1, NOW(), NOW()),
...
(176, 'viewall.after-javascript-initialization', 1, 0, 0, 1, 1, 1, NOW(), NOW()),
...
(1032, 'export.top', 2, 0, 0, 1, 1, 1, NOW(), NOW()),
(1033, 'export.col1-top', 2, 0, 0, 1, 1, 1, NOW(), NOW()),
(1034, 'export.col1-bottom', 2, 0, 0, 1, 1, 1, NOW(), NOW()),
(1035, 'export.bottom', 2, 0, 0, 1, 1, 1, NOW(), NOW()),
...
(1163, 'main.catalog-bottom', 2, 0, 0, 1, 1, 1, NOW(), NOW()),
...
(1032, 'en_US', 'Export - at the top', '', ''),
(1032, 'fr_FR', 'Export - en haut', '', ''),
(1033, 'en_US', 'Export - at the top of the column', '', ''),
(1033, 'fr_FR', 'Export - en haut de la colonne', '', ''),
(1034, 'en_US', 'Export - at the bottom of column 1', '', ''),
(1034, 'fr_FR', 'Export - en bas de la colonne 1', '', ''),
(1035, 'en_US', 'Export - bottom', '', ''),
(1035, 'fr_FR', 'Export - bas', '', ''),
...
(1163, 'en_US', 'Layout - at the bottom of the catalog', '', ''),
(1163, 'fr_FR', 'Mise en page - en bas du catlogue', '', ''),
