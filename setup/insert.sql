...
INSERT INTO `config_i18n` (`id`, `locale`, `title`, `chapo`, `description`, `postscriptum`) VALUES
    ...
    (63, 'en_US', 'Stay on the default language at use arrows \"Next\" and \"Previous\" on the product, category, content, folder and brand page. 1 for yes, 0 for no.', NULL, NULL, NULL),    (1, 'es_ES', NULL, NULL, NULL, NULL),
