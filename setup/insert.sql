...
(1, 'order.invoice.top', 1, 0, 1, 1, 1, NOW(), NOW()),
(2, 'order.invoice.delivery.address', 1, 1, 1, 1, 1, NOW(), NOW()),
(3, 'order.invoice.payment.extra', 1, 1, 1, 1, 1, NOW(), NOW()),
(4, 'order.invoice.bottom', 1, 0, 1, 1, 1, NOW(), NOW()),
(5, 'order.invoice.after.javascript.initialization', 1, 0, 1, 1, 1, NOW(), NOW()),
(6, 'order.invoice.stylesheet', 1, 0, 1, 1, 1, NOW(), NOW()),
(7, 'order.invoice.after.javascript.include', 1, 0, 1, 1, 1, NOW(), NOW()),
(8, 'order.payment.gateway.body', 1, 1, 1, 1, 1, NOW(), NOW()),
(9, 'order.payment.gateway.javascript', 1, 1, 1, 1, 1, NOW(), NOW()),
(10, 'order.payment.gateway.after.javascript.initialization', 1, 0, 1, 1, 1, NOW(), NOW()),
(11, 'order.payment.gateway.stylesheet', 1, 0, 1, 1, 1, NOW(), NOW()),
(12, 'order.payment.gateway.after.javascript.include', 1, 0, 1, 1, 1, NOW(), NOW()),
(13, 'sitemap.bottom', 1, 0, 1, 1, 1, NOW(), NOW()),
(14, 'currency.top', 1, 0, 1, 1, 1, NOW(), NOW()),
(15, 'currency.bottom', 1, 0, 1, 1, 1, NOW(), NOW()),
(16, 'currency.stylesheet', 1, 0, 1, 1, 1, NOW(), NOW()),
(17, 'currency.after.javascript.include', 1, 0, 1, 1, 1, NOW(), NOW()),
(18, 'currency.after.javascript.initialization', 1, 0, 1, 1, 1, NOW(), NOW()),
(19, 'login.top', 1, 0, 1, 1, 1, NOW(), NOW()),
(20, 'login.main.top', 1, 0, 1, 1, 1, NOW(), NOW()),
(21, 'login.form.top', 1, 0, 1, 1, 1, NOW(), NOW()),
(22, 'login.form.bottom', 1, 0, 1, 1, 1, NOW(), NOW()),
(23, 'login.main.bottom', 1, 0, 1, 1, 1, NOW(), NOW()),
(24, 'login.bottom', 1, 0, 1, 1, 1, NOW(), NOW()),
(25, 'login.stylesheet', 1, 0, 1, 1, 1, NOW(), NOW()),
(26, 'login.after.javascript.include', 1, 0, 1, 1, 1, NOW(), NOW()),
(27, 'login.after.javascript.initialization', 1, 0, 1, 1, 1, NOW(), NOW()),
(28, 'account.update.top', 1, 0, 1, 1, 1, NOW(), NOW()),
(29, 'account.update.form.top', 1, 0, 1, 1, 1, NOW(), NOW()),
(30, 'account.update.form.bottom', 1, 0, 1, 1, 1, NOW(), NOW()),
(31, 'account.update.bottom', 1, 0, 1, 1, 1, NOW(), NOW()),
(32, 'account.update.stylesheet', 1, 0, 1, 1, 1, NOW(), NOW()),
(33, 'account.update.after.javascript.include', 1, 0, 1, 1, 1, NOW(), NOW()),
(34, 'account.update.after.javascript.initialization', 1, 0, 1, 1, 1, NOW(), NOW()),
(35, 'cart.top', 1, 0, 1, 1, 1, NOW(), NOW()),
(36, 'cart.bottom', 1, 0, 1, 1, 1, NOW(), NOW()),
(37, 'cart.after.javascript.include', 1, 0, 1, 1, 1, NOW(), NOW()),
(38, 'cart.stylesheet', 1, 0, 1, 1, 1, NOW(), NOW()),
(39, 'cart.javascript.initialization', 1, 0, 1, 1, 1, NOW(), NOW()),
(40, 'contact.top', 1, 0, 1, 1, 1, NOW(), NOW()),
(41, 'contact.form.top', 1, 0, 1, 1, 1, NOW(), NOW()),
(42, 'contact.form.bottom', 1, 0, 1, 1, 1, NOW(), NOW()),
(43, 'contact.bottom', 1, 0, 1, 1, 1, NOW(), NOW()),
(44, 'contact.stylesheet', 1, 0, 1, 1, 1, NOW(), NOW()),
(45, 'contact.after.javascript.include', 1, 0, 1, 1, 1, NOW(), NOW()),
(46, 'contact.after.javascript.initialization', 1, 0, 1, 1, 1, NOW(), NOW()),
(47, 'order.placed.body', 1, 1, 1, 1, 1, NOW(), NOW()),
(48, 'order.placed.stylesheet', 1, 0, 1, 1, 1, NOW(), NOW()),
(49, 'order.placed.after.javascript.include', 1, 0, 1, 1, 1, NOW(), NOW()),
(50, 'order.placed.after.javascript.initialization', 1, 0, 1, 1, 1, NOW(), NOW()),
(51, 'search.stylesheet', 1, 0, 1, 1, 1, NOW(), NOW()),
(52, 'search.after.javascript.include', 1, 0, 1, 1, 1, NOW(), NOW()),
(53, 'search.after.javascript.initialization', 1, 0, 1, 1, 1, NOW(), NOW()),
(54, 'register.top', 1, 0, 1, 1, 1, NOW(), NOW()),
(55, 'register.form.top', 1, 0, 1, 1, 1, NOW(), NOW()),
(56, 'register.form.bottom', 1, 0, 1, 1, 1, NOW(), NOW()),
(57, 'register.bottom', 1, 0, 1, 1, 1, NOW(), NOW()),
(58, 'register.stylesheet', 1, 0, 1, 1, 1, NOW(), NOW()),
(59, 'register.after.javascript.include', 1, 0, 1, 1, 1, NOW(), NOW()),
(60, 'register.after.javascript.initialization', 1, 0, 1, 1, 1, NOW(), NOW()),
(61, 'password.top', 1, 0, 1, 1, 1, NOW(), NOW()),
(62, 'password.form.top', 1, 0, 1, 1, 1, NOW(), NOW()),
(63, 'password.form.bottom', 1, 0, 1, 1, 1, NOW(), NOW()),
(64, 'password.bottom', 1, 0, 1, 1, 1, NOW(), NOW()),
(65, 'password.stylesheet', 1, 0, 1, 1, 1, NOW(), NOW()),
(66, 'password.after.javascript.include', 1, 0, 1, 1, 1, NOW(), NOW()),
(67, 'password.after.javascript.initialization', 1, 0, 1, 1, 1, NOW(), NOW()),
(68, 'language.top', 1, 0, 1, 1, 1, NOW(), NOW()),
(69, 'language.bottom', 1, 0, 1, 1, 1, NOW(), NOW()),
(70, 'language.stylesheet', 1, 0, 1, 1, 1, NOW(), NOW()),
(71, 'language.after.javascript.include', 1, 0, 1, 1, 1, NOW(), NOW()),
(72, 'language.after.javascript.initialization', 1, 0, 1, 1, 1, NOW(), NOW()),
(73, 'contact.success', 1, 0, 1, 1, 1, NOW(), NOW()),
(74, 'newsletter.top', 1, 0, 1, 1, 1, NOW(), NOW()),
(75, 'newsletter.bottom', 1, 0, 1, 1, 1, NOW(), NOW()),
(76, 'newsletter.stylesheet', 1, 0, 1, 1, 1, NOW(), NOW()),
(77, 'newsletter.after.javascript.include', 1, 0, 1, 1, 1, NOW(), NOW()),
(78, 'newsletter.after.javascript.initialization', 1, 0, 1, 1, 1, NOW(), NOW()),
(79, 'badresponseorder.stylesheet', 1, 0, 1, 1, 1, NOW(), NOW()),
(80, 'badresponseorder.after.javascript.include', 1, 0, 1, 1, 1, NOW(), NOW()),
(81, 'badresponseorder.javascript.initialization', 1, 0, 1, 1, 1, NOW(), NOW()),
(82, 'content.top', 1, 0, 1, 1, 1, NOW(), NOW()),
(83, 'content.main.top', 1, 0, 1, 1, 1, NOW(), NOW()),
(84, 'content.main.bottom', 1, 0, 1, 1, 1, NOW(), NOW()),
(85, 'content.bottom', 1, 0, 1, 1, 1, NOW(), NOW()),
(86, 'content.stylesheet', 1, 0, 1, 1, 1, NOW(), NOW()),
(87, 'content.after.javascript.include', 1, 0, 1, 1, 1, NOW(), NOW()),
(88, 'content.after.javascript.initialization', 1, 0, 1, 1, 1, NOW(), NOW()),
(89, 'main.head.top', 1, 0, 1, 1, 1, NOW(), NOW()),
(90, 'main.head.bottom', 1, 0, 1, 1, 1, NOW(), NOW()),
(91, 'main.body.top', 1, 0, 1, 1, 1, NOW(), NOW()),
(92, 'main.header.top', 1, 0, 1, 1, 1, NOW(), NOW()),
(93, 'main.navbar.secondary', 1, 0, 1, 1, 1, NOW(), NOW()),
(94, 'main.navbar.primary', 1, 0, 1, 1, 1, NOW(), NOW()),
(95, 'main.header.bottom', 1, 0, 1, 1, 1, NOW(), NOW()),
(96, 'main.content.top', 1, 0, 1, 1, 1, NOW(), NOW()),
(97, 'main.content.bottom', 1, 0, 1, 1, 1, NOW(), NOW()),
(98, 'main.footer.top', 1, 0, 1, 1, 1, NOW(), NOW()),
(99, 'main.footer.body', 1, 0, 1, 1, 1, NOW(), NOW()),
(100, 'main.footer.bottom', 1, 0, 1, 1, 1, NOW(), NOW()),
(101, 'main.body.bottom', 1, 0, 1, 1, 1, NOW(), NOW()),
(102, '404.content', 1, 0, 1, 1, 1, NOW(), NOW()),
(103, '404.stylesheet', 1, 0, 1, 1, 1, NOW(), NOW()),
(104, '404.after.javascript.include', 1, 0, 1, 1, 1, NOW(), NOW()),
(105, '404.after.javascript.initialization', 1, 0, 1, 1, 1, NOW(), NOW()),
(106, 'order.delivery.top', 1, 0, 1, 1, 1, NOW(), NOW()),
(107, 'order.delivery.form.top', 1, 0, 1, 1, 1, NOW(), NOW()),
(108, 'order.delivery.form.bottom', 1, 0, 1, 1, 1, NOW(), NOW()),
(109, 'order.delivery.bottom', 1, 0, 1, 1, 1, NOW(), NOW()),
(110, 'order.delivery.after.javascript.initialization', 1, 0, 1, 1, 1, NOW(), NOW()),
(111, 'order.delivery.stylesheet', 1, 0, 1, 1, 1, NOW(), NOW()),
(112, 'order.delivery.after.javascript.include', 1, 0, 1, 1, 1, NOW(), NOW()),
(113, 'address.create.top', 1, 0, 1, 1, 1, NOW(), NOW()),
(114, 'address.create.form.top', 1, 0, 1, 1, 1, NOW(), NOW()),
(115, 'address.create.form.bottom', 1, 0, 1, 1, 1, NOW(), NOW()),
(116, 'address.create.bottom', 1, 0, 1, 1, 1, NOW(), NOW()),
(117, 'address.create.stylesheet', 1, 0, 1, 1, 1, NOW(), NOW()),
(118, 'address.create.after.javascript.include', 1, 0, 1, 1, 1, NOW(), NOW()),
(119, 'address.create.after.javascript.initialization', 1, 0, 1, 1, 1, NOW(), NOW()),
(120, 'folder.top', 1, 0, 1, 1, 1, NOW(), NOW()),
(121, 'folder.main.top', 1, 0, 1, 1, 1, NOW(), NOW()),
(122, 'folder.main.bottom', 1, 0, 1, 1, 1, NOW(), NOW()),
(123, 'folder.bottom', 1, 0, 1, 1, 1, NOW(), NOW()),
(124, 'folder.stylesheet', 1, 0, 1, 1, 1, NOW(), NOW()),
(125, 'folder.after.javascript.include', 1, 0, 1, 1, 1, NOW(), NOW()),
(126, 'folder.after.javascript.initialization', 1, 0, 1, 1, 1, NOW(), NOW()),
(127, 'order.failed.top', 1, 0, 1, 1, 1, NOW(), NOW()),
(128, 'order.failed.bottom', 1, 0, 1, 1, 1, NOW(), NOW()),
(129, 'order.failed.stylesheet', 1, 0, 1, 1, 1, NOW(), NOW()),
(130, 'order.failed.after.javascript.include', 1, 0, 1, 1, 1, NOW(), NOW()),
(131, 'order.failed.after.javascript.initialization', 1, 0, 1, 1, 1, NOW(), NOW()),
(132, 'category.top', 1, 0, 1, 1, 1, NOW(), NOW()),
(133, 'category.main.top', 1, 0, 1, 1, 1, NOW(), NOW()),
(134, 'category.main.bottom', 1, 0, 1, 1, 1, NOW(), NOW()),
(135, 'category.bottom', 1, 0, 1, 1, 1, NOW(), NOW()),
(136, 'category.stylesheet', 1, 0, 1, 1, 1, NOW(), NOW()),
(137, 'category.after.javascript.include', 1, 0, 1, 1, 1, NOW(), NOW()),
(138, 'category.after.javascript.initialization', 1, 0, 1, 1, 1, NOW(), NOW()),
(139, 'address.update.top', 1, 0, 1, 1, 1, NOW(), NOW()),
(140, 'address.update.form.top', 1, 0, 1, 1, 1, NOW(), NOW()),
(141, 'address.update.form.bottom', 1, 0, 1, 1, 1, NOW(), NOW()),
(142, 'address.update.bottom', 1, 0, 1, 1, 1, NOW(), NOW()),
(143, 'address.update.stylesheet', 1, 0, 1, 1, 1, NOW(), NOW()),
(144, 'address.update.after.javascript.include', 1, 0, 1, 1, 1, NOW(), NOW()),
(145, 'address.update.after.javascript.initialization', 1, 0, 1, 1, 1, NOW(), NOW()),
(146, 'home.body', 1, 0, 1, 1, 1, NOW(), NOW()),
(147, 'home.stylesheet', 1, 0, 1, 1, 1, NOW(), NOW()),
(148, 'home.after.javascript.include', 1, 0, 1, 1, 1, NOW(), NOW()),
(149, 'home.after.javascript.initialization', 1, 0, 1, 1, 1, NOW(), NOW()),
(150, 'account.password.top', 1, 0, 1, 1, 1, NOW(), NOW()),
(151, 'account.password.bottom', 1, 0, 1, 1, 1, NOW(), NOW()),
(152, 'account.password.stylesheet', 1, 0, 1, 1, 1, NOW(), NOW()),
(153, 'account.password.after.javascript.include', 1, 0, 1, 1, 1, NOW(), NOW()),
(154, 'account.password.after.javascript.initialization', 1, 0, 1, 1, 1, NOW(), NOW()),
(155, 'product.top', 1, 0, 1, 1, 1, NOW(), NOW()),
(156, 'product.gallery', 1, 0, 1, 1, 1, NOW(), NOW()),
(157, 'product.details.top', 1, 0, 1, 1, 1, NOW(), NOW()),
(158, 'product.details.bottom', 1, 0, 1, 1, 1, NOW(), NOW()),
(159, 'product.additional', 1, 0, 1, 1, 1, NOW(), NOW()),
(160, 'product.bottom', 1, 0, 1, 1, 1, NOW(), NOW()),
(161, 'product.stylesheet', 1, 0, 1, 1, 1, NOW(), NOW()),
(162, 'product.after.javascript.include', 1, 0, 1, 1, 1, NOW(), NOW()),
(163, 'product.after.javascript.initialization', 1, 0, 1, 1, 1, NOW(), NOW()),
(164, 'account.top', 1, 0, 1, 1, 1, NOW(), NOW()),
(165, 'account.bottom', 1, 0, 1, 1, 1, NOW(), NOW()),
(166, 'account.stylesheet', 1, 0, 1, 1, 1, NOW(), NOW()),
(167, 'account.after.javascript.include', 1, 0, 1, 1, 1, NOW(), NOW()),
(168, 'account.after.javascript.initialization', 1, 0, 1, 1, 1, NOW(), NOW()),
(169, 'view-all.top', 1, 0, 1, 1, 1, NOW(), NOW()),
(170, 'view-all.bottom', 1, 0, 1, 1, 1, NOW(), NOW()),
(171, 'view-all.stylesheet', 1, 0, 1, 1, 1, NOW(), NOW()),
(172, 'view-all.after.javascript.include', 1, 0, 1, 1, 1, NOW(), NOW()),
(173, 'view-all.after.javascript.initialization', 1, 0, 1, 1, 1, NOW(), NOW()),
(174, 'single-product.top', 1, 0, 1, 1, 1, NOW(), NOW()),
(175, 'single-product.bottom', 1, 0, 1, 1, 1, NOW(), NOW()),
(176, 'category.sidebar.top', 1, 0, 1, 1, 1, NOW(), NOW()),
(177, 'category.sidebar.body', 1, 0, 1, 1, 1, NOW(), NOW()),
(178, 'category.sidebar.bottom', 1, 0, 1, 1, 1, NOW(), NOW()),
(179, 'content.sidebar.top', 1, 0, 1, 1, 1, NOW(), NOW()),
(180, 'content.sidebar.body', 1, 0, 1, 1, 1, NOW(), NOW()),
(181, 'content.sidebar.bottom', 1, 0, 1, 1, 1, NOW(), NOW()),
(182, 'order.delivery.extra', 1, 1, 1, 1, 1, NOW(), NOW()),
(183, 'order.delivery.javascript', 1, 1, 1, 1, 1, NOW(), NOW())
;
...
(8, 'fr_FR', 'Passerelle de paiement - corps', '', ''),
(8, 'en_US', 'Payment gateway - body', '', ''),
...
(47, 'fr_FR', 'Commande terminée - corps', '', ''),
(47, 'en_US', 'Placed order - body', '', ''),
...
(67, 'fr_FR', 'Mot de passe perdu - après l\'initialisation du javascript', '', ''),
(67, 'en_US', 'Lost password - after javascript initialisation', '', ''),
...
(79, 'fr_FR', 'badresponseorder.stylesheet - feuille de style CSS', '', ''),
(79, 'en_US', 'badresponseorder.stylesheet - CSS stylesheet', '', ''),
(80, 'fr_FR', 'badresponseorder.after.javascript.include - après l\'inclusion des javascript', '', ''),
(80, 'en_US', 'badresponseorder.after.javascript.include - after javascript include', '', ''),
(81, 'fr_FR', 'badresponseorder.javascript.initialization - initialisation du javascript', '', ''),
(81, 'en_US', 'badresponseorder.javascript.initialization - javascript initialization', '', ''),
...
(90, 'fr_FR', 'Structure HTML - avant la fin de la balise head', '', ''),
(90, 'en_US', 'HTML layout - before the end of the head tag', '', ''),
(91, 'fr_FR', 'Structure HTML - après l\'ouverture de la balise body', '', ''),
(91, 'en_US', 'HTML layout - after the opening of the body tag', '', ''),
(92, 'fr_FR', 'Structure HTML - en haut du header', '', ''),
(92, 'en_US', 'HTML layout - at the top of the header', '', ''),
(93, 'fr_FR', 'Structure HTML - navigation secondaire', '', ''),
(93, 'en_US', 'HTML layout - secondary navigation', '', ''),
(94, 'fr_FR', 'Structure HTML - navigation principale', '', ''),
(94, 'en_US', 'HTML layout - primary navigation', '', ''),
(95, 'fr_FR', 'Structure HTML - en bas du header', '', ''),
(95, 'en_US', 'HTML layout - at the bottom of the header', '', ''),
(96, 'fr_FR', 'Structure HTML - au dessus de la zone de contenu principale', '', ''),
(96, 'en_US', 'HTML layout - before the main content area', '', ''),
(97, 'fr_FR', 'Structure HTML - en dessous de la zone de contenu principale', '', ''),
(97, 'en_US', 'HTML layout - after the main content area', '', ''),
(98, 'fr_FR', 'Structure HTML - en haut du pied de page', '', ''),
(98, 'en_US', 'HTML layout - at the top of the footer', '', ''),
(99, 'fr_FR', 'Structure HTML - corps du pied de page', '', ''),
(99, 'en_US', 'HTML layout - footer body', '', ''),
(100, 'fr_FR', 'Structure HTML - en bas du pied de page', '', ''),
(100, 'en_US', 'HTML layout - bottom of the footer', '', ''),
(101, 'fr_FR', 'Structure HTML - avant la fin de la balise body', '', ''),
(101, 'en_US', 'HTML layout - before the end body tag', '', ''),
(102, 'fr_FR', 'Page introuvable - contenu', '', ''),
(102, 'en_US', '404.content - content', '', ''),
(103, 'fr_FR', 'Page introuvable - feuille de style CSS', '', ''),
(103, 'en_US', '404.stylesheet - CSS stylesheet', '', ''),
(104, 'fr_FR', 'Page introuvable - après l\'inclusion des javascript', '', ''),
(104, 'en_US', '404.after.javascript.include - after javascript include', '', ''),
(105, 'fr_FR', 'Page introuvable - après l\'initialisation du javascript', '', ''),
(105, 'en_US', '404.after.javascript.initialization - after javascript initialisation', '', ''),
(106, 'fr_FR', 'Choix du transporteur - en haut', '', ''),
(106, 'en_US', 'Delivery choice - at the top', '', ''),
(107, 'fr_FR', 'Choix du transporteur - en haut du formulaire', '', ''),
(107, 'en_US', 'Delivery choice - at the top of the form', '', ''),
(108, 'fr_FR', 'Choix du transporteur - en bas du formulaire', '', ''),
(108, 'en_US', 'Delivery choice - at the bottom of the form', '', ''),
(109, 'fr_FR', 'Choix du transporteur - en bas', '', ''),
(109, 'en_US', 'Delivery choice - at the bottom', '', ''),
(110, 'fr_FR', 'Choix du transporteur - après l\'initialisation du javascript', '', ''),
(110, 'en_US', 'Delivery choice - after javascript initialisation', '', ''),
(111, 'fr_FR', 'Choix du transporteur - feuille de style CSS', '', ''),
(111, 'en_US', 'Delivery choice - CSS stylesheet', '', ''),
(112, 'fr_FR', 'Choix du transporteur - après l\'inclusion des javascript', '', ''),
(112, 'en_US', 'Delivery choice - after javascript include', '', ''),
(113, 'fr_FR', 'Création adresse - en haut', '', ''),
(113, 'en_US', 'Address creation - at the top', '', ''),
(114, 'fr_FR', 'Création adresse - en haut du formulaire', '', ''),
(114, 'en_US', 'Address creation - at the top of the form', '', ''),
(115, 'fr_FR', 'Création adresse - en bas du formulaire', '', ''),
(115, 'en_US', 'Address creation - at the bottom of the form', '', ''),
(116, 'fr_FR', 'Création adresse - en bas', '', ''),
(116, 'en_US', 'Address creation - at the bottom', '', ''),
(117, 'fr_FR', 'Création adresse - feuille de style CSS', '', ''),
(117, 'en_US', 'Address creation - CSS stylesheet', '', ''),
(118, 'fr_FR', 'Création adresse - après l\'inclusion des javascript', '', ''),
(118, 'en_US', 'Address creation - after javascript include', '', ''),
(119, 'fr_FR', 'Création adresse - après l\'initialisation du javascript', '', ''),
(119, 'en_US', 'Address creation - after javascript initialisation', '', ''),
(120, 'fr_FR', 'Page dossier - en haut', '', ''),
(120, 'en_US', 'Foldeer page - at the top', '', ''),
(121, 'fr_FR', 'Page dossier - en haut de la zone principal', '', ''),
(121, 'en_US', 'Foldeer page - at the top of the main area', '', ''),
(122, 'fr_FR', 'Page dossier - en bas de la zone principal', '', ''),
(122, 'en_US', 'Foldeer page - at the bottom of the main area', '', ''),
(123, 'fr_FR', 'Page dossier - en bas', '', ''),
(123, 'en_US', 'Foldeer page - at the bottom', '', ''),
(124, 'fr_FR', 'Page dossier - feuille de style CSS', '', ''),
(124, 'en_US', 'Foldeer page - CSS stylesheet', '', ''),
(125, 'fr_FR', 'Page dossier - après l\'inclusion des javascript', '', ''),
(125, 'en_US', 'Foldeer page - after javascript include', '', ''),
(126, 'fr_FR', 'Page dossier - après l\'initialisation du javascript', '', ''),
(126, 'en_US', 'Foldeer page - after javascript initialisation', '', ''),
(127, 'fr_FR', 'Echec de la commande - en haut', '', ''),
(127, 'en_US', 'Order failed - at the top', '', ''),
(128, 'fr_FR', 'Echec de la commande - en bas', '', ''),
(128, 'en_US', 'Order failed - at the bottom', '', ''),
(129, 'fr_FR', 'Echec de la commande - feuille de style CSS', '', ''),
(129, 'en_US', 'Order failed - CSS stylesheet', '', ''),
(130, 'fr_FR', 'Echec de la commande - après l\'inclusion des javascript', '', ''),
(130, 'en_US', 'Order failed - after javascript include', '', ''),
(131, 'fr_FR', 'Echec de la commande - après l\'initialisation du javascript', '', ''),
(131, 'en_US', 'Order failed - after javascript initialisation', '', ''),
(132, 'fr_FR', 'Page catégorie - en haut', '', ''),
(132, 'en_US', 'Category page - at the top', '', ''),
(133, 'fr_FR', 'Page catégorie - en haut de la zone principal', '', ''),
(133, 'en_US', 'Category page - at the top of the main area', '', ''),
(134, 'fr_FR', 'Page catégorie - en bas de la zone principal', '', ''),
(134, 'en_US', 'Category page - at the bottom of the main area', '', ''),
(135, 'fr_FR', 'Page catégorie - en bas', '', ''),
(135, 'en_US', 'Category page - at the bottom', '', ''),
(136, 'fr_FR', 'Page catégorie - feuille de style CSS', '', ''),
(136, 'en_US', 'Category page - CSS stylesheet', '', ''),
(137, 'fr_FR', 'Page catégorie - après l\'inclusion des javascript', '', ''),
(137, 'en_US', 'Category page - after javascript include', '', ''),
(138, 'fr_FR', 'Page catégorie - après l\'initialisation du javascript', '', ''),
(138, 'en_US', 'Category page - after javascript initialisation', '', ''),
(139, 'fr_FR', 'Modification adresse - en haut', '', ''),
(139, 'en_US', 'Address update - at the top', '', ''),
(140, 'fr_FR', 'Modification adresse - en haut du formulaire', '', ''),
(140, 'en_US', 'Address update - at the top of the form', '', ''),
(141, 'fr_FR', 'Modification adresse - en bas du formulaire', '', ''),
(141, 'en_US', 'Address update - at the bottom of the form', '', ''),
(142, 'fr_FR', 'Modification adresse - en bas', '', ''),
(142, 'en_US', 'Address update - at the bottom', '', ''),
(143, 'fr_FR', 'Modification adresse - feuille de style CSS', '', ''),
(143, 'en_US', 'Address update - CSS stylesheet', '', ''),
(144, 'fr_FR', 'Modification adresse - après l\'inclusion des javascript', '', ''),
(144, 'en_US', 'Address update - after javascript include', '', ''),
(145, 'fr_FR', 'Modification adresse - après l\'initialisation du javascript', '', ''),
(145, 'en_US', 'Address update - after javascript initialisation', '', ''),
(146, 'fr_FR', 'Page d\'accueil - corps', '', ''),
(146, 'en_US', 'Home page - body', '', ''),
(147, 'fr_FR', 'Page d\'accueil - feuille de style CSS', '', ''),
(147, 'en_US', 'Home page - CSS stylesheet', '', ''),
(148, 'fr_FR', 'Page d\'accueil - après l\'inclusion des javascript', '', ''),
(148, 'en_US', 'Home page - after javascript include', '', ''),
(149, 'fr_FR', 'Page d\'accueil - après l\'initialisation du javascript', '', ''),
(149, 'en_US', 'Home page - after javascript initialisation', '', ''),
(150, 'fr_FR', 'Changement de mot de passe - en haut', '', ''),
(150, 'en_US', 'Change password - at the top', '', ''),
(151, 'fr_FR', 'Changement de mot de passe - en bas', '', ''),
(151, 'en_US', 'Change password - at the bottom', '', ''),
(152, 'fr_FR', 'Changement de mot de passe - feuille de style CSS', '', ''),
(152, 'en_US', 'Change password - CSS stylesheet', '', ''),
(153, 'fr_FR', 'Changement de mot de passe - après l\'inclusion des javascript', '', ''),
(153, 'en_US', 'Change password - after javascript include', '', ''),
(154, 'fr_FR', 'Changement de mot de passe - après l\'initialisation du javascript', '', ''),
(154, 'en_US', 'Change password - after javascript initialisation', '', ''),
(155, 'fr_FR', 'Page produit - en haut', '', ''),
(155, 'en_US', 'Product page - at the top', '', ''),
(156, 'fr_FR', 'Page produit - gallerie photos', '', ''),
(156, 'en_US', 'Product page - photo gallery', '', ''),
(157, 'fr_FR', 'Page produit - en haut de la zone détail', '', ''),
(157, 'en_US', 'Product page - at the top of the detail', '', ''),
(158, 'fr_FR', 'Page produit - en dessous de la zone de détail', '', ''),
(158, 'en_US', 'Product page - at the bottom of the detail area', '', ''),
(159, 'fr_FR', 'Page produit - informations additionnelles', '', ''),
(159, 'en_US', 'Product page - additional information', '', ''),
(160, 'fr_FR', 'Page produit - en bas', '', ''),
(160, 'en_US', 'Product page - at the bottom', '', ''),
(161, 'fr_FR', 'Page produit - feuille de style CSS', '', ''),
(161, 'en_US', 'Product page - CSS stylesheet', '', ''),
(162, 'fr_FR', 'Page produit - après l\'inclusion des javascript', '', ''),
(162, 'en_US', 'Product page - after javascript include', '', ''),
(163, 'fr_FR', 'Page produit - après l\'initialisation du javascript', '', ''),
(163, 'en_US', 'Product page - after javascript initialisation', '', ''),
(164, 'fr_FR', 'Compte client - en haut', '', ''),
(164, 'en_US', 'customer account - at the top', '', ''),
(165, 'fr_FR', 'Compte client - en bas', '', ''),
(165, 'en_US', 'customer account - at the bottom', '', ''),
(166, 'fr_FR', 'Compte client - feuille de style CSS', '', ''),
(166, 'en_US', 'customer account - CSS stylesheet', '', ''),
(167, 'fr_FR', 'Compte client - après l\'inclusion des javascript', '', ''),
(167, 'en_US', 'customer account - after javascript include', '', ''),
(168, 'fr_FR', 'Compte client - après l\'initialisation du javascript', '', ''),
(168, 'en_US', 'customer account - after javascript initialisation', '', ''),
(169, 'fr_FR', 'Tous les produits - en haut', '', ''),
(169, 'en_US', 'All Products - at the top', '', ''),
(170, 'fr_FR', 'Tous les produits - en bas', '', ''),
(170, 'en_US', 'All Products - at the bottom', '', ''),
(171, 'fr_FR', 'Tous les produits - feuille de style CSS', '', ''),
(171, 'en_US', 'All Products - CSS stylesheet', '', ''),
(172, 'fr_FR', 'Tous les produits - après l\'inclusion des javascript', '', ''),
(172, 'en_US', 'All Products - after javascript include', '', ''),
(173, 'fr_FR', 'Tous les produits - après l\'initialisation du javascript', '', ''),
(173, 'en_US', 'All Products - after javascript initialisation', '', ''),
(174, 'fr_FR', 'Boucle produit - en haut', '', ''),
(174, 'en_US', 'Product loop - at the top', '', ''),
(175, 'fr_FR', 'Boucle produit - en bas', '', ''),
(175, 'en_US', 'Product loop - at the bottom', '', ''),
(176, 'fr_FR', 'Page catégorie - en haut de la sidebar', '', ''),
(176, 'en_US', 'Category page - at the top of the sidebar', '', ''),
(177, 'fr_FR', 'Page catégorie - le corps de la sidebar', '', ''),
(177, 'en_US', 'Category page - the body of the sidebar', '', ''),
(178, 'fr_FR', 'Page catégorie - en bas de la sidebar', '', ''),
(178, 'en_US', 'Category page - at the bottom of the sidebar', '', ''),
(179, 'fr_FR', 'Page de contenu - en haut de la sidebar', '', ''),
(179, 'en_US', 'Content page - at the top of the sidebar', '', ''),
(180, 'fr_FR', 'Page de contenu - le corps de la sidebar', '', ''),
(180, 'en_US', 'Content page - the body of the sidebar', '', ''),
(181, 'fr_FR', 'Page de contenu - en bas de la sidebar', '', ''),
(181, 'en_US', 'Content page - at the bottom of the sidebar', '', ''),
(182, 'fr_FR', 'Choix du transporteur - zone supplémentaire', '', ''),
(182, 'en_US', 'Delivery choice - extra area', '', ''),
(183, 'fr_FR', 'Choix du transporteur - javascript', '', ''),
(183, 'en_US', 'Delivery choice - javascript', '', '')
;
