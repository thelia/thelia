...
INSERT INTO `config_i18n` (`id`, `locale`, `title`, `chapo`, `description`, `postscriptum`) VALUES
    ...
    (53, 'en_US', '[Firewall/Bruteforce] Time to wait between X attempts', NULL, NULL, NULL),
    (54, 'en_US', '[Firewall] Time to wait between X attempts', NULL, NULL, NULL),
    (55, 'en_US', '[Firewall/Bruteforce] Number of allowed attemps', NULL, NULL, NULL),
    (56, 'en_US', '[Firewall] Number of allowed attemps', NULL, NULL, NULL),
    (57, 'en_US', '[Firewall] Activate the firewall', NULL, NULL, NULL),
    (58, 'en_US', 'Allow slash ended uri', NULL, NULL, NULL),
    (59, 'en_US', 'Show error message instead of a white page on a server error', NULL, NULL, NULL),
    (60, 'en_US', 'Filename of the error page', NULL, NULL, NULL),
    ...
    (53, 'fr_FR', '[Pare-feu/Bruteforce] Temps à attendre entre X essais', NULL, NULL, NULL),
    (54, 'fr_FR', '[Pare-feu] Temps à attendre entre X essais', NULL, NULL, NULL),
    (55, 'fr_FR', '[Pare-feu/Bruteforce] Nombre de tentatives autorisées', NULL, NULL, NULL),
    (56, 'fr_FR', '[Pare-feu] Nombre de tentatives autorisées', NULL, NULL, NULL),
    (57, 'fr_FR', '[Pare-feu] Activer le pare-feu', NULL, NULL, NULL),
    (58, 'fr_FR', 'Autoriser les URI terminées par un slash', NULL, NULL, NULL),
    (59, 'fr_FR', 'Afficher un message d\'erreur à la place d\'une page blanche lors d\'une erreur serveur', NULL, NULL, NULL),
    (60, 'fr_FR', 'Nom du fichier de la page d\'erreur', NULL, NULL, NULL)
;
