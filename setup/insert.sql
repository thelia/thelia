...
INSERT INTO `hook` (`id`, `code`, `type`, `by_module`, `native`, `activate`, `position`, `created_at`, `updated_at`) VALUES
  ...
  (159, 'product.bottom', 1, 0, 1, 1, 1, NOW(), NOW()),
  (160, 'product.stylesheet', 1, 0, 1, 1, 1, NOW(), NOW()),
  (161, 'product.after.javascript.include', 1, 0, 1, 1, 1, NOW(), NOW()),
  (162, 'product.after.javascript.initialization', 1, 0, 1, 1, 1, NOW(), NOW()),
  (163, 'account.top', 1, 0, 1, 1, 1, NOW(), NOW()),
  (164, 'account.bottom', 1, 0, 1, 1, 1, NOW(), NOW()),
  (165, 'account.stylesheet', 1, 0, 1, 1, 1, NOW(), NOW()),
  (166, 'account.after.javascript.include', 1, 0, 1, 1, 1, NOW(), NOW()),
  (167, 'account.after.javascript.initialization', 1, 0, 1, 1, 1, NOW(), NOW()),
  (168, 'view-all.top', 1, 0, 1, 1, 1, NOW(), NOW()),
  (169, 'view-all.bottom', 1, 0, 1, 1, 1, NOW(), NOW()),
  (170, 'view-all.stylesheet', 1, 0, 1, 1, 1, NOW(), NOW()),
  (171, 'view-all.after.javascript.include', 1, 0, 1, 1, 1, NOW(), NOW()),
  (172, 'view-all.after.javascript.initialization', 1, 0, 1, 1, 1, NOW(), NOW()),
  (173, 'single-product.top', 1, 0, 1, 1, 1, NOW(), NOW()),
  (174, 'single-product.bottom', 1, 0, 1, 1, 1, NOW(), NOW()),
  (175, 'category.sidebar.top', 1, 0, 1, 1, 1, NOW(), NOW()),
  (176, 'category.sidebar.body', 1, 0, 1, 1, 1, NOW(), NOW()),
  (177, 'category.sidebar.bottom', 1, 0, 1, 1, 1, NOW(), NOW()),
  (178, 'content.sidebar.top', 1, 0, 1, 1, 1, NOW(), NOW()),
  (179, 'content.sidebar.body', 1, 0, 1, 1, 1, NOW(), NOW()),
  (180, 'content.sidebar.bottom', 1, 0, 1, 1, 1, NOW(), NOW()),
  (181, 'order.delivery.extra', 1, 1, 1, 1, 1, NOW(), NOW()),
  (182, 'order.delivery.javascript', 1, 1, 1, 1, 1, NOW(), NOW())
;
...
INSERT INTO  `hook_i18n` (`id`, `locale`, `title`, `description`, `chapo`) VALUES
  ...
  (159, 'fr_FR', 'Page produit - en bas', '', ''),
  (159, 'en_US', 'Product page - at the bottom', '', ''),
  (160, 'fr_FR', 'Page produit - feuille de style CSS', '', ''),
  (160, 'en_US', 'Product page - CSS stylesheet', '', ''),
  (161, 'fr_FR', 'Page produit - après l\'inclusion des javascript', '', ''),
  (161, 'en_US', 'Product page - after javascript include', '', ''),
  (162, 'fr_FR', 'Page produit - après l\'initialisation du javascript', '', ''),
  (162, 'en_US', 'Product page - after javascript initialisation', '', ''),
  (163, 'fr_FR', 'Compte client - en haut', '', ''),
  (163, 'en_US', 'customer account - at the top', '', ''),
  (164, 'fr_FR', 'Compte client - en bas', '', ''),
  (164, 'en_US', 'customer account - at the bottom', '', ''),
  (165, 'fr_FR', 'Compte client - feuille de style CSS', '', ''),
  (165, 'en_US', 'customer account - CSS stylesheet', '', ''),
  (166, 'fr_FR', 'Compte client - après l\'inclusion des javascript', '', ''),
  (166, 'en_US', 'customer account - after javascript include', '', ''),
  (167, 'fr_FR', 'Compte client - après l\'initialisation du javascript', '', ''),
  (167, 'en_US', 'customer account - after javascript initialisation', '', ''),
  (168, 'fr_FR', 'Tous les produits - en haut', '', ''),
  (168, 'en_US', 'All Products - at the top', '', ''),
  (169, 'fr_FR', 'Tous les produits - en bas', '', ''),
  (169, 'en_US', 'All Products - at the bottom', '', ''),
  (170, 'fr_FR', 'Tous les produits - feuille de style CSS', '', ''),
  (170, 'en_US', 'All Products - CSS stylesheet', '', ''),
  (171, 'fr_FR', 'Tous les produits - après l\'inclusion des javascript', '', ''),
  (171, 'en_US', 'All Products - after javascript include', '', ''),
  (172, 'fr_FR', 'Tous les produits - après l\'initialisation du javascript', '', ''),
  (172, 'en_US', 'All Products - after javascript initialisation', '', ''),
  (173, 'fr_FR', 'Boucle produit - en haut', '', ''),
  (173, 'en_US', 'Product loop - at the top', '', ''),
  (174, 'fr_FR', 'Boucle produit - en bas', '', ''),
  (174, 'en_US', 'Product loop - at the bottom', '', ''),
  (175, 'fr_FR', 'Page catégorie - en haut de la sidebar', '', ''),
  (175, 'en_US', 'Category page - at the top of the sidebar', '', ''),
  (176, 'fr_FR', 'Page catégorie - le corps de la sidebar', '', ''),
  (176, 'en_US', 'Category page - the body of the sidebar', '', ''),
  (177, 'fr_FR', 'Page catégorie - en bas de la sidebar', '', ''),
  (177, 'en_US', 'Category page - at the bottom of the sidebar', '', ''),
  (178, 'fr_FR', 'Page de contenu - en haut de la sidebar', '', ''),
  (178, 'en_US', 'Content page - at the top of the sidebar', '', ''),
  (179, 'fr_FR', 'Page de contenu - le corps de la sidebar', '', ''),
  (179, 'en_US', 'Content page - the body of the sidebar', '', ''),
  (180, 'fr_FR', 'Page de contenu - en bas de la sidebar', '', ''),
  (180, 'en_US', 'Content page - at the bottom of the sidebar', '', ''),
  (181, 'fr_FR', 'Choix du transporteur - zone supplémentaire', '', ''),
  (181, 'en_US', 'Delivery choice - extra area', '', ''),
  (182, 'fr_FR', 'Choix du transporteur - javascript', '', ''),
  (182, 'en_US', 'Delivery choice - javascript', '', '')
;
