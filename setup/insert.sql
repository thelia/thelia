...
INSERT INTO `resource_i18n` (`id`, `locale`, `title`, `chapo`, `description`, `postscriptum`) VALUES
    ...
    (55, 'en_US', 'Configuration / Tag', NULL, NULL, NULL),
    ...
    (55, 'fr_FR', 'Configuration / Étiquette', NULL, NULL, NULL),
    ...
    (55, 'ru_RU', NULL, NULL, NULL, NULL)
;


INSERT INTO `message_i18n` (`id`, `locale`, `title`, `subject`, `text_message`, `html_message`) VALUES
    (1, 'cs_CZ', NULL, 'Vaše objednávka {{ order_ref }} v obchodě {{ config(\"store_name\") }}', NULL, NULL),
    (2, 'cs_CZ', NULL, 'Obnovte své heslo v obchodě {{ config(\"store_name\") }}', NULL, NULL),
    (3, 'cs_CZ', NULL, 'Nová objednávka {{ order_ref }} v obchodě {{ config(\"store_name\") }}', NULL, NULL),
    (4, 'cs_CZ', NULL, 'Informace o účtu v obchodě {{ config(\"store_name\") }} byly změněny.', NULL, NULL),
    (5, 'cs_CZ', NULL, 'Pro Vás byl vytvořen účet v obchodě {{ config(\"store_name\") }}', NULL, NULL),
    (6, 'cs_CZ', NULL, 'Žádost o nové heslo v obchodě {{ config(\"store_name\") }}', NULL, NULL),
    (7, 'cs_CZ', NULL, 'Váš odběr novinek z obchodu {{ config(\"store_name\") }}', NULL, NULL),
    ...
    (6, 'de_DE', NULL, 'Neues Passwort für {{ config(\"store_name\") }} angefordert', NULL, NULL),
    (7, 'de_DE', NULL, 'Ihr Newsletter-Abonnement bei {{ config(\"store_name\") }}', NULL, NULL),
    ...
    (4, 'it_IT', NULL, 'Le informazioni del tuo account su {{ config(\"store_name\") }} sono state modificate.', NULL, NULL),
    (5, 'it_IT', NULL, 'È stato creato un account {{ config(\"store_name\") }} per te', NULL, NULL),
    (6, 'it_IT', NULL, 'Richiesta di una nuova password su {{ config(\"store_name\") }}', NULL, NULL),
    (7, 'it_IT', NULL, 'La tua iscrizione alla newsletter di {{ config(\"store_name\") }}', NULL, NULL),
