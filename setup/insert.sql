...
INSERT INTO `hook_i18n` (`id`, `locale`, `title`, `chapo`, `description`) VALUES
    ...
    (2039, 'de_DE', NULL, NULL, NULL),
    (2040, 'de_DE', NULL, NULL, NULL),
    (2041, 'de_DE', NULL, NULL, NULL),
    (2042, 'de_DE', NULL, NULL, NULL),
    (2043, 'de_DE', NULL, NULL, NULL),
    (2044, 'de_DE', NULL, NULL, NULL),
    (2045, 'de_DE', NULL, NULL, NULL),
    (2046, 'de_DE', NULL, NULL, NULL),
    (2047, 'de_DE', NULL, NULL, NULL),
    (2048, 'de_DE', NULL, NULL, NULL),
    (2049, 'de_DE', NULL, NULL, NULL),
    (2050, 'de_DE', NULL, NULL, NULL),
    (2051, 'de_DE', NULL, NULL, NULL),
    (2052, 'de_DE', NULL, NULL, NULL),
    (2053, 'de_DE', NULL, NULL, NULL),
    (2054, 'de_DE', NULL, NULL, NULL),
    (2055, 'de_DE', NULL, NULL, NULL),
    (2056, 'de_DE', NULL, NULL, NULL),
    (2057, 'de_DE', NULL, NULL, NULL),
    (2058, 'de_DE', NULL, NULL, NULL),
    (2059, 'de_DE', NULL, NULL, NULL),
    (2060, 'de_DE', NULL, NULL, NULL),
    (2061, 'de_DE', NULL, NULL, NULL),
    ...
    (2037, 'en_US', 'Brand edit - right column top', NULL, NULL),
    (2038, 'en_US', 'Brand edit - right column bottom', NULL, NULL),
    (2039, 'en_US', 'Category edit - right column top', NULL, NULL),
    (2040, 'en_US', 'Category edit - right column bottom', NULL, NULL),
    (2041, 'en_US', 'Content edit - right column top', NULL, NULL),
    (2042, 'en_US', 'Content edit - right column bottom', NULL, NULL),
    (2043, 'en_US', 'Folder edit - right column top', NULL, NULL),
    (2044, 'en_US', 'Folder edit - right column bottom', NULL, NULL),
    (2045, 'en_US', 'Product edit - right column top', NULL, NULL),
    (2046, 'en_US', 'Product edit - right column bottom', NULL, NULL),
    (2047, 'en_US', 'Email - layout - CSS', NULL, NULL),
    (2048, 'en_US', 'Email - layout - footer', NULL, NULL),
    (2049, 'en_US', 'Email - order confirmation - before address', NULL, NULL),
    (2050, 'en_US', 'Email - order confirmation - delivery address', NULL, NULL),
    (2051, 'en_US', 'Email - order confirmation - after address', NULL, NULL),
    (2052, 'en_US', 'Email - order confirmation - order product', NULL, NULL),
    (2053, 'en_US', 'Email - order confirmation - before products', NULL, NULL),
    (2054, 'en_US', 'Email - order confirmation - after products', NULL, NULL),
    (2055, 'en_US', 'Email - order confirmation - footer', NULL, NULL),
    (2056, 'en_US', 'Email - order notification - before address', NULL, NULL),
    (2057, 'en_US', 'Email - order notification - delivery address', NULL, NULL),
    (2058, 'en_US', 'Email - order notification - after address', NULL, NULL),
    (2059, 'en_US', 'Email - order notification - order product', NULL, NULL),
    (2060, 'en_US', 'Email - order notification - before products', NULL, NULL),
    (2061, 'en_US', 'Email - order notification - after products', NULL, NULL),
    ...
    (2039, 'es_ES', NULL, NULL, NULL),
    (2040, 'es_ES', NULL, NULL, NULL),
    (2041, 'es_ES', NULL, NULL, NULL),
    (2042, 'es_ES', NULL, NULL, NULL),
    (2043, 'es_ES', NULL, NULL, NULL),
    (2044, 'es_ES', NULL, NULL, NULL),
    (2045, 'es_ES', NULL, NULL, NULL),
    (2046, 'es_ES', NULL, NULL, NULL),
    (2047, 'es_ES', NULL, NULL, NULL),
    (2048, 'es_ES', NULL, NULL, NULL),
    (2049, 'es_ES', NULL, NULL, NULL),
    (2050, 'es_ES', NULL, NULL, NULL),
    (2051, 'es_ES', NULL, NULL, NULL),
    (2052, 'es_ES', NULL, NULL, NULL),
    (2053, 'es_ES', NULL, NULL, NULL),
    (2054, 'es_ES', NULL, NULL, NULL),
    (2055, 'es_ES', NULL, NULL, NULL),
    (2056, 'es_ES', NULL, NULL, NULL),
    (2057, 'es_ES', NULL, NULL, NULL),
    (2058, 'es_ES', NULL, NULL, NULL),
    (2059, 'es_ES', NULL, NULL, NULL),
    (2060, 'es_ES', NULL, NULL, NULL),
    (2061, 'es_ES', NULL, NULL, NULL),
    ...
    (2037, 'fr_FR', 'Édition d\'une marque - en haut de la colonne de droite', NULL, NULL),
    (2038, 'fr_FR', 'Édition d\'une marque - en bas de la colonne de droite', NULL, NULL),
    (2039, 'fr_FR', 'Édition d\'une catégorie - en haut de la colonne de droite', NULL, NULL),
    (2040, 'fr_FR', 'Édition d\'une catégorie - en bas de la colonne de droite', NULL, NULL),
    (2041, 'fr_FR', 'Édition d\'un contenu - en haut de la colonne de droite', NULL, NULL),
    (2042, 'fr_FR', 'Édition d\'un contenu  - en bas de la colonne de droite', NULL, NULL),
    (2043, 'fr_FR', 'Édition d\'un dossier - en haut de la colonne de droite', NULL, NULL),
    (2044, 'fr_FR', 'Édition d\'un dossier - en bas de la colonne de droite', NULL, NULL),
    (2045, 'fr_FR', 'Édition d\'un produit - en haut de la colonne de droite', NULL, NULL),
    (2046, 'fr_FR', 'Édition d\'un produit - en bas de la colonne de droite', NULL, NULL),
    (2047, 'fr_FR', 'Email - layout - CSS', NULL, NULL),
    (2048, 'fr_FR', 'Email - layout - pied de page', NULL, NULL),
    (2049, 'fr_FR', 'Email - confirmation commande - avant adresses', NULL, NULL),
    (2050, 'fr_FR', 'Email - confirmation commande - adresse de livraison', NULL, NULL),
    (2051, 'fr_FR', 'Email - confirmation commande - après adresses', NULL, NULL),
    (2052, 'fr_FR', 'Email - confirmation commande - produit de la commande', NULL, NULL),
    (2053, 'fr_FR', 'Email - confirmation commande - avant produits', NULL, NULL),
    (2054, 'fr_FR', 'Email - confirmation commande - après produits', NULL, NULL),
    (2055, 'fr_FR', 'Email - confirmation commande - pied de page', NULL, NULL),
    (2056, 'fr_FR', 'Email - notification commande - avant adresses', NULL, NULL),
    (2057, 'fr_FR', 'Email - notification commande - adresse de livraison', NULL, NULL),
    (2058, 'fr_FR', 'Email - notification commande - après adresses', NULL, NULL),
    (2059, 'fr_FR', 'Email - notification commande - produit de la commande', NULL, NULL),
    (2060, 'fr_FR', 'Email - notification commande - avant produits', NULL, NULL),
    (2061, 'fr_FR', 'Email - notification commande - après produits', NULL, NULL)
;
