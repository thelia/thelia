...
(43, 'thelia_version','2.4.2', 1, 1, NOW(), NOW()),
(44, 'thelia_major_version','2', 1, 1, NOW(), NOW()),
(45, 'thelia_minus_version','4', 1, 1, NOW(), NOW()),
...
INSERT INTO `country_i18n` (`id`, `locale`, `title`, `chapo`, `description`, `postscriptum`) VALUES
    ...
    (1, 'cs_CZ', 'Afghánistán', NULL, NULL, NULL),
    (2, 'cs_CZ', 'Jižní Afrika', NULL, NULL, NULL),
    (3, 'cs_CZ', 'Albánie', NULL, NULL, NULL),
    (4, 'cs_CZ', 'Alžírsko', NULL, NULL, NULL),
    (5, 'cs_CZ', 'Německo', NULL, NULL, NULL),
    (6, 'cs_CZ', 'Andorra', NULL, NULL, NULL),
    (7, 'cs_CZ', 'Angola', NULL, NULL, NULL),
    (8, 'cs_CZ', 'Antigua a Barbuda', NULL, NULL, NULL),
    (9, 'cs_CZ', 'Saudská arábie', NULL, NULL, NULL),
    (10, 'cs_CZ', 'Argentina', NULL, NULL, NULL),
    (11, 'cs_CZ', 'Arménie', NULL, NULL, NULL),
    (12, 'cs_CZ', 'Austrálie', NULL, NULL, NULL),
    (13, 'cs_CZ', 'Rakousko', NULL, NULL, NULL),
    (14, 'cs_CZ', 'Ázerbajdžán', NULL, NULL, NULL),
    (15, 'cs_CZ', 'Bahamy', NULL, NULL, NULL),
    (16, 'cs_CZ', 'Bahrajn', NULL, NULL, NULL),
    (17, 'cs_CZ', 'Bangladéš', NULL, NULL, NULL),
    (18, 'cs_CZ', 'Barbados', NULL, NULL, NULL),
    (19, 'cs_CZ', 'Bělorusko', NULL, NULL, NULL),
    (20, 'cs_CZ', 'Belgie', NULL, NULL, NULL),
    (21, 'cs_CZ', 'Belize', NULL, NULL, NULL),
    (22, 'cs_CZ', 'Benin', NULL, NULL, NULL),
    (23, 'cs_CZ', 'Bhútán', NULL, NULL, NULL),
    (24, 'cs_CZ', 'Bělorusko', NULL, NULL, NULL),
    (25, 'cs_CZ', 'Barma', NULL, NULL, NULL),
    (26, 'cs_CZ', 'Bolívie', NULL, NULL, NULL),
    (27, 'cs_CZ', 'Bosna a Hercegovina', NULL, NULL, NULL),
    (28, 'cs_CZ', 'Botswana', NULL, NULL, NULL),
    (29, 'cs_CZ', 'Brazílie', NULL, NULL, NULL),
    (30, 'cs_CZ', 'Brunej', NULL, NULL, NULL),
    (31, 'cs_CZ', 'Bulharsko', NULL, NULL, NULL),
    (32, 'cs_CZ', 'Burkina', NULL, NULL, NULL),
    (33, 'cs_CZ', 'Burundi', NULL, NULL, NULL),
    (34, 'cs_CZ', 'Kambodža', NULL, NULL, NULL),
    (35, 'cs_CZ', 'Kamerun', NULL, NULL, NULL),
    (37, 'cs_CZ', 'Kapverdy', NULL, NULL, NULL),
    (38, 'cs_CZ', 'Chile', NULL, NULL, NULL),
    (39, 'cs_CZ', 'Čína', NULL, NULL, NULL),
    (40, 'cs_CZ', 'Kypr', NULL, NULL, NULL),
    (41, 'cs_CZ', 'Kolumbie', NULL, NULL, NULL),
    (42, 'cs_CZ', 'Komory', NULL, NULL, NULL),
    (43, 'cs_CZ', 'Kongo', NULL, NULL, NULL),
    (44, 'cs_CZ', 'Cookovy ostrovy', NULL, NULL, NULL),
    (45, 'cs_CZ', 'Severní Korea', NULL, NULL, NULL),
    (46, 'cs_CZ', 'Jižní Korea', NULL, NULL, NULL),
    (47, 'cs_CZ', 'Kostarika', NULL, NULL, NULL),
    (48, 'cs_CZ', 'Pobřeží slonoviny', NULL, NULL, NULL),
    (49, 'cs_CZ', 'Chorvatsko', NULL, NULL, NULL),
    (50, 'cs_CZ', 'Kuba', NULL, NULL, NULL),
    (51, 'cs_CZ', 'Dánsko', NULL, NULL, NULL),
    (52, 'cs_CZ', 'Džibuti', NULL, NULL, NULL),
    (53, 'cs_CZ', 'Dominika', NULL, NULL, NULL),
    (54, 'cs_CZ', 'Egypt', NULL, NULL, NULL),
    (55, 'cs_CZ', 'Spojené arabské emiráty', NULL, NULL, NULL),
    (56, 'cs_CZ', 'Ekvádor', NULL, NULL, NULL),
    (57, 'cs_CZ', 'Eritrea', NULL, NULL, NULL),
    (58, 'cs_CZ', 'Španělsko', NULL, NULL, NULL),
    (59, 'cs_CZ', 'Estonsko', NULL, NULL, NULL),
    (61, 'cs_CZ', 'Etiopie', NULL, NULL, NULL),
    (62, 'cs_CZ', 'Fidži', NULL, NULL, NULL),
    (63, 'cs_CZ', 'Finsko', NULL, NULL, NULL),
    (64, 'cs_CZ', 'Metropolita Francie', NULL, NULL, NULL),
    (65, 'cs_CZ', 'Gabon', NULL, NULL, NULL),
    (66, 'cs_CZ', 'Gambie', NULL, NULL, NULL),
    (67, 'cs_CZ', 'Gruzie', NULL, NULL, NULL),
    (68, 'cs_CZ', 'Ghana', NULL, NULL, NULL),
    (69, 'cs_CZ', 'Řecko', NULL, NULL, NULL),
    (70, 'cs_CZ', 'Grenada', NULL, NULL, NULL),
    (71, 'cs_CZ', 'Guatemala', NULL, NULL, NULL),
    (72, 'cs_CZ', 'Guinea', NULL, NULL, NULL),
    (73, 'cs_CZ', 'Guinea-Bissau', NULL, NULL, NULL),
    (74, 'cs_CZ', 'Rovníková Guinea', NULL, NULL, NULL),
    (75, 'cs_CZ', 'Guyana', NULL, NULL, NULL),
    (76, 'cs_CZ', 'Haiti', NULL, NULL, NULL),
    (77, 'cs_CZ', 'Honduras', NULL, NULL, NULL),
    (78, 'cs_CZ', 'Maďarsko', NULL, NULL, NULL),
    (79, 'cs_CZ', 'Indie', NULL, NULL, NULL),
    (80, 'cs_CZ', 'Indonésie', NULL, NULL, NULL),
    (81, 'cs_CZ', 'Írán', NULL, NULL, NULL),
    (82, 'cs_CZ', 'Irák', NULL, NULL, NULL),
    (83, 'cs_CZ', 'Irsko', NULL, NULL, NULL),
    (84, 'cs_CZ', 'Island', NULL, NULL, NULL),
    (85, 'cs_CZ', 'Izrael', NULL, NULL, NULL),
    (86, 'cs_CZ', 'Itálie', NULL, NULL, NULL),
    (87, 'cs_CZ', 'Jamaica', NULL, NULL, NULL),
    (88, 'cs_CZ', 'Japonsko', NULL, NULL, NULL),
    (89, 'cs_CZ', 'Jordán', NULL, NULL, NULL),
    (90, 'cs_CZ', 'Kazachstán', NULL, NULL, NULL),
    (91, 'cs_CZ', 'Keňa', NULL, NULL, NULL),
    (92, 'cs_CZ', 'Kyrgyzstán', NULL, NULL, NULL),
    (93, 'cs_CZ', 'Kiribati', NULL, NULL, NULL),
    (94, 'cs_CZ', 'Kuvajt', NULL, NULL, NULL),
    (95, 'cs_CZ', 'Laos', NULL, NULL, NULL),
    (96, 'cs_CZ', 'Lesotho', NULL, NULL, NULL),
    (97, 'cs_CZ', 'Lotyšsko', NULL, NULL, NULL),
    (98, 'cs_CZ', 'Libanon', NULL, NULL, NULL),
    (99, 'cs_CZ', 'Libérie', NULL, NULL, NULL),
    (100, 'cs_CZ', 'Libye', NULL, NULL, NULL),
    (101, 'cs_CZ', 'Lichtenštejnsko', NULL, NULL, NULL),
    (102, 'cs_CZ', 'Litva', NULL, NULL, NULL),
    (103, 'cs_CZ', 'Lucembursko', NULL, NULL, NULL),
    (104, 'cs_CZ', 'Makedonie', NULL, NULL, NULL),
    (105, 'cs_CZ', 'Madagaskar', NULL, NULL, NULL),
    (106, 'cs_CZ', 'Malajsie', NULL, NULL, NULL),
    (107, 'cs_CZ', 'Malawi', NULL, NULL, NULL),
    (108, 'cs_CZ', 'Maledivy', NULL, NULL, NULL),
    (109, 'cs_CZ', 'Mali', NULL, NULL, NULL),
    (110, 'cs_CZ', 'Malta', NULL, NULL, NULL),
    (111, 'cs_CZ', 'Maroko', NULL, NULL, NULL),
    (112, 'cs_CZ', 'Marshallovy ostrovy', NULL, NULL, NULL),
    (113, 'cs_CZ', 'Mauricius', NULL, NULL, NULL),
    (114, 'cs_CZ', 'Mauretánie', NULL, NULL, NULL),
    (115, 'cs_CZ', 'Mexiko', NULL, NULL, NULL),
    (116, 'cs_CZ', 'Mikronésie', NULL, NULL, NULL),
    (117, 'cs_CZ', 'Moldavsko', NULL, NULL, NULL),
    (118, 'cs_CZ', 'Monako', NULL, NULL, NULL),
    (119, 'cs_CZ', 'Mongolsko', NULL, NULL, NULL),
    (120, 'cs_CZ', 'Mosambik', NULL, NULL, NULL),
    (121, 'cs_CZ', 'Namibie', NULL, NULL, NULL),
    (122, 'cs_CZ', 'Nauru', NULL, NULL, NULL),
    (123, 'cs_CZ', 'Nepál', NULL, NULL, NULL),
    (124, 'cs_CZ', 'Nikaragua', NULL, NULL, NULL),
    (125, 'cs_CZ', 'Niger', NULL, NULL, NULL),
    (126, 'cs_CZ', 'Nigérie', NULL, NULL, NULL),
    (127, 'cs_CZ', 'Niue', NULL, NULL, NULL),
    (128, 'cs_CZ', 'Norsko', NULL, NULL, NULL),
    (129, 'cs_CZ', 'Nový Zéland', NULL, NULL, NULL),
    (130, 'cs_CZ', 'Omán', NULL, NULL, NULL),
    (131, 'cs_CZ', 'Uganda', NULL, NULL, NULL),
    (132, 'cs_CZ', 'Uzbekistán', NULL, NULL, NULL),
    (133, 'cs_CZ', 'Pákistán', NULL, NULL, NULL),
    (134, 'cs_CZ', 'Panama', NULL, NULL, NULL),
    (135, 'cs_CZ', 'Papua Nueva Guinea', NULL, NULL, NULL),
    (136, 'cs_CZ', 'Paraguay', NULL, NULL, NULL),
    (137, 'cs_CZ', 'Holandsko', NULL, NULL, NULL),
    (138, 'cs_CZ', 'Peru', NULL, NULL, NULL),
    (139, 'cs_CZ', 'Filipíny', NULL, NULL, NULL),
    (140, 'cs_CZ', 'Polsko', NULL, NULL, NULL),
    (141, 'cs_CZ', 'Portugalsko', NULL, NULL, NULL),
    (142, 'cs_CZ', 'Katar', NULL, NULL, NULL),
    (143, 'cs_CZ', 'Středoafrická republika', NULL, NULL, NULL),
    (144, 'cs_CZ', 'Dominikánská republika', NULL, NULL, NULL),
    (145, 'cs_CZ', 'Česká republika', NULL, NULL, NULL),
    (146, 'cs_CZ', 'Rumunsko', NULL, NULL, NULL),
    (147, 'cs_CZ', 'Spojené království', NULL, NULL, NULL),
    (148, 'cs_CZ', 'Rusko', NULL, NULL, NULL),
    (149, 'cs_CZ', 'Rwanda', NULL, NULL, NULL),
    (150, 'cs_CZ', 'Svatý Kryštof a Nevis', NULL, NULL, NULL),
    (151, 'cs_CZ', 'Svatá Lucie', NULL, NULL, NULL),
    (152, 'cs_CZ', 'San Marino', NULL, NULL, NULL),
    (153, 'cs_CZ', 'Svatý Vincenc a Grenadiny', NULL, NULL, NULL),
    (154, 'cs_CZ', 'Solomonovy ostrovy', NULL, NULL, NULL),
    (155, 'cs_CZ', 'El Salvador', NULL, NULL, NULL),
    (156, 'cs_CZ', 'Západní Samoa', NULL, NULL, NULL),
    (157, 'cs_CZ', 'Svatý Tomáš a Princův ostrov', NULL, NULL, NULL),
    (158, 'cs_CZ', 'Senegal', NULL, NULL, NULL),
    (159, 'cs_CZ', 'Seychely', NULL, NULL, NULL),
    (160, 'cs_CZ', 'Sierra Leone', NULL, NULL, NULL),
    (161, 'cs_CZ', 'Singapur', NULL, NULL, NULL),
    (162, 'cs_CZ', 'Slovensko', NULL, NULL, NULL),
    (163, 'cs_CZ', 'Slovinsko', NULL, NULL, NULL),
    (164, 'cs_CZ', 'Somálsko', NULL, NULL, NULL),
    (165, 'cs_CZ', 'Súdán', NULL, NULL, NULL),
    (166, 'cs_CZ', 'Srí Lanka', NULL, NULL, NULL),
    (167, 'cs_CZ', 'Švédsko', NULL, NULL, NULL),
    (168, 'cs_CZ', 'Švýcarsko', NULL, NULL, NULL),
    (169, 'cs_CZ', 'Surinam', NULL, NULL, NULL),
    (170, 'cs_CZ', 'Svazijsko', NULL, NULL, NULL),
    (171, 'cs_CZ', 'Sýrie', NULL, NULL, NULL),
    (172, 'cs_CZ', 'Tádžikistán', NULL, NULL, NULL),
    (173, 'cs_CZ', 'Tanzanie', NULL, NULL, NULL),
    (174, 'cs_CZ', 'Čad', NULL, NULL, NULL),
    (175, 'cs_CZ', 'Thajsko', NULL, NULL, NULL),
    (176, 'cs_CZ', 'Jít', NULL, NULL, NULL),
    (177, 'cs_CZ', 'Tonga', NULL, NULL, NULL),
    (178, 'cs_CZ', 'Trinidad a Tobago', NULL, NULL, NULL),
    (179, 'cs_CZ', 'Tunisko', NULL, NULL, NULL),
    (180, 'cs_CZ', 'Turkmenistán', NULL, NULL, NULL),
    (181, 'cs_CZ', 'krocan', NULL, NULL, NULL),
    (182, 'cs_CZ', 'Tuvalu', NULL, NULL, NULL),
    (183, 'cs_CZ', 'Ukrajina', NULL, NULL, NULL),
    (184, 'cs_CZ', 'Uruguay', NULL, NULL, NULL),
    (185, 'cs_CZ', 'Vatikán', NULL, NULL, NULL),
    (186, 'cs_CZ', 'Vanuatu', NULL, NULL, NULL),
    (187, 'cs_CZ', 'Venezuela', NULL, NULL, NULL),
    (188, 'cs_CZ', 'Vietnam', NULL, NULL, NULL),
    (189, 'cs_CZ', 'Jemen', NULL, NULL, NULL),
    (191, 'cs_CZ', 'Zair', NULL, NULL, NULL),
    (192, 'cs_CZ', 'Zambie', NULL, NULL, NULL),
    (193, 'cs_CZ', 'Zimbabwe', NULL, NULL, NULL),
    (196, 'cs_CZ', 'USA', NULL, NULL, NULL),
    (246, 'cs_CZ', 'Kanada', NULL, NULL, NULL),
    (259, 'cs_CZ', 'Guadeloupe', NULL, NULL, NULL),
    (260, 'cs_CZ', 'Francouzská Guyana', NULL, NULL, NULL),
    (261, 'cs_CZ', 'Martinik', NULL, NULL, NULL),
    (262, 'cs_CZ', 'Mayotte', NULL, NULL, NULL),
    (263, 'cs_CZ', 'Réunion (La)', NULL, NULL, NULL),
    (264, 'cs_CZ', 'St Pierre a Miquelon', NULL, NULL, NULL),
    (265, 'cs_CZ', 'Nouvelle-Calédonie', NULL, NULL, NULL),
    (266, 'cs_CZ', 'Polynésie française', NULL, NULL, NULL),
    (267, 'cs_CZ', 'Wallis-et-Futuna', NULL, NULL, NULL),
    (269, 'cs_CZ', 'Hongkong', NULL, NULL, NULL),
    (270, 'cs_CZ', 'Svatý Bartoloměj', NULL, NULL, NULL),
    (271, 'cs_CZ', 'Svatý Martin (francouzská část)', NULL, NULL, NULL),
    (272, 'cs_CZ', 'Francouzská jižní území', NULL, NULL, NULL),
    ...
    (260, 'en_US', 'French Guiana', NULL, NULL, NULL),
    (261, 'en_US', 'Martinique', NULL, NULL, NULL),
    (262, 'en_US', 'Mayotte', NULL, NULL, NULL),
    (263, 'en_US', 'Reunion Island', NULL, NULL, NULL),
    (264, 'en_US', 'St Pierre et Miquelon', NULL, NULL, NULL),
    (265, 'en_US', 'Nouvelle-Calédonie', NULL, NULL, NULL),
    (266, 'en_US', 'French Polynesia', NULL, NULL, NULL),
    (267, 'en_US', 'Wallis and futuna', NULL, NULL, NULL),
    (269, 'en_US', 'Hong Kong', NULL, NULL, NULL),
    (270, 'en_US', 'Saint Bartholomew', NULL, NULL, NULL),
    ...
    (196, 'es_ES', 'Estados Unidos', NULL, NULL, NULL),
    (246, 'es_ES', 'Canadá', NULL, NULL, NULL),
    ...
    (2, 'it_IT', 'Sud Africa', NULL, NULL, NULL),
    ...
    (19, 'it_IT', 'Bielorussia', NULL, NULL, NULL),
    (20, 'it_IT', 'Belgio', NULL, NULL, NULL),
    (21, 'it_IT', 'Belize', NULL, NULL, NULL),
    (22, 'it_IT', 'Benigno', NULL, NULL, NULL),
    ...
    (27, 'it_IT', 'Bosnia Erzegovina', NULL, NULL, NULL),
    ...
    (64, 'it_IT', 'Francia metropolitana', NULL, NULL, NULL),
    ...
    (70, 'it_IT', 'Bomba a mano', NULL, NULL, NULL),
    (71, 'it_IT', 'Guatemala', NULL, NULL, NULL),
    (72, 'it_IT', 'Guinea', NULL, NULL, NULL),
    (73, 'it_IT', 'Guinea-Bissao', NULL, NULL, NULL),
    ...
    (104, 'it_IT', 'Macedonia', NULL, NULL, NULL),
    ...
    (112, 'it_IT', 'Marshall', NULL, NULL, NULL),
    (113, 'it_IT', 'Maurizio', NULL, NULL, NULL),
    (114, 'it_IT', 'Mauritania', NULL, NULL, NULL),
    (115, 'it_IT', 'Messico', NULL, NULL, NULL),
    (116, 'it_IT', 'Micronesia', NULL, NULL, NULL),
    (117, 'it_IT', 'Moldova', NULL, NULL, NULL),
    (118, 'it_IT', 'Principato di Monaco', NULL, NULL, NULL),
    ...
    (135, 'it_IT', 'Papua', NULL, NULL, NULL),
    (136, 'it_IT', 'Paraguay', NULL, NULL, NULL),
    (137, 'it_IT', 'Olanda', NULL, NULL, NULL),
    ...
    (143, 'it_IT', 'Repubblica Centrafricana', NULL, NULL, NULL),
    (144, 'it_IT', 'Repubblica Dominicana', NULL, NULL, NULL),
    (145, 'it_IT', 'Repubblica Ceca', NULL, NULL, NULL),
    ...
    (151, 'it_IT', 'Santa Lucia', NULL, NULL, NULL),
    (152, 'it_IT', 'San Marino', NULL, NULL, NULL),
    (153, 'it_IT', 'Saint Vincent e Grenadine', NULL, NULL, NULL),
    (154, 'it_IT', 'Salomone', NULL, NULL, NULL),
    (155, 'it_IT', 'Salvador', NULL, NULL, NULL),
    (156, 'it_IT', 'Samoa occidentali', NULL, NULL, NULL),
    (157, 'it_IT', 'Sao Tome e Principe', NULL, NULL, NULL),
    ...
    (191, 'it_IT', 'Zaire', NULL, NULL, NULL),
    ...
    (260, 'it_IT', 'Guiana francese', NULL, NULL, NULL),
    (261, 'it_IT', 'Martinica', NULL, NULL, NULL),
    (262, 'it_IT', 'Mayotte', NULL, NULL, NULL),
    (263, 'it_IT', 'L incontro', NULL, NULL, NULL),
    (264, 'it_IT', 'St Pierre e Miquelon', NULL, NULL, NULL),
    ...
    (270, 'it_IT', 'San Bartolomeo', NULL, NULL, NULL),
    (271, 'it_IT', 'Saint-Martin (Antille francesi)', NULL, NULL, NULL),
