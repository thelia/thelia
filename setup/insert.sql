...
INSERT INTO `config_i18n` (`id`, `locale`, `title`, `chapo`, `description`, `postscriptum`) VALUES
    ...
    (73, 'fr_FR', 'Autoriser l\'installation des modules par fichier ZIP.', NULL, NULL, NULL),    (74, 'fr_FR', NULL, NULL, NULL, NULL),    (1, 'ru_RU', 'Проверять доступный запас товара (1) или игнорировать его (0) при отображении и изменении количества в заказе', NULL, NULL, NULL),
...
INSERT INTO `module_i18n` (`id`, `locale`, `title`, `chapo`, `description`, `postscriptum`) VALUES
    ...
    (21, 'fr_FR', 'Contenu de la page d\'accueil de l\'administration', NULL, NULL, NULL),    (1, 'ru_RU', 'Слайдер на главной', NULL, NULL, NULL),
...
INSERT INTO `hook_i18n` (`id`, `locale`, `title`, `chapo`, `description`) VALUES
    ...
    (2038, 'fr_FR', NULL, NULL, NULL),    (2001, 'ru_RU', 'Счет-фактура - CSS', NULL, NULL),
...
INSERT INTO `hook_i18n` (`id`, `locale`, `title`, `chapo`, `description`) VALUES
    ...
    (3028, 'fr_FR', NULL, NULL, NULL),    (3000, 'ru_RU', 'Email html - каркас - CSS', NULL, NULL),
