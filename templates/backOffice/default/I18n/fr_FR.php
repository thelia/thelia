...
return [
    ...
    'Back to the modules list' => 'Retour à la liste des modules',
    'Best taxed price' => 'Meilleur prix TTC',
    'Beware, you access the protected modules' => 'Attention , vous accédez aux modules protégés',
    'Block' => 'Bloc',
    'Block :' => 'Bloc :',
    ...
    'Delete all combinations' => 'Supprimer toutes les combinaisons de déclinaison',
    ...
    'Do you really want to delete ALL combinations for this product ? All related data will be deleted.' => 'Voulez-vous vraiment supprimer toutes les déclinaisons de ce produit ? Toutes les données associées (prix, stocks, ...) seront supprimées',
    ...
    'If you change the template, all the prices will be reset and you have to configure them again.' => 'En changeant de template, les prix vont être réinitialisés et vous devrez les reconfigurer',
    ...
    'Set default' => 'Présenté par défaut',
