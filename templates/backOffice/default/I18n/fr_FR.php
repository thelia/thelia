...
return [
    ...
    '<strong>Warning</strong>, this setting is active but no domain is defined for: %languages. These languages are served from whichever domain the visitor arrived on.' => '<strong>Attention</strong>, ce réglage est actif mais aucun domaine n\'est défini pour : %languages. Ces langues sont servies depuis le domaine par lequel le visiteur est arrivé.',
    ...
    'EAN Code' => 'Code EAN',
    'Each combination has its own file to download. Only the documents of this product which are not visible can be selected, so that they cannot be downloaded for free.' => 'Chaque déclinaison a son propre fichier à télécharger. Seuls les documents non visibles de ce produit peuvent être sélectionnés, afin qu\'ils ne soient pas téléchargeables gratuitement.',
    ...
    'No document is associated with this virtual product: your customers will not be able to download anything.' => 'Aucun document n\'est associé à ce produit virtuel : vos clients ne pourront rien télécharger.',
