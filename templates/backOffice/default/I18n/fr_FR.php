...
return array(
	...
	'Select a content and click (+) to add it to this product' => 'Choisissez un contenu, et cliquez [+] pour l\'attacher au produit',
	...
	'This category doesn\'t contains any products. To add a new product, <strong>click the + button</strong> above.' => 'Cette catégorie n\'a aucun produit. Pour créer un nouveau produit, <strong>cliquez sur le bouton +</strong> ci-dessus.',
	'Name' => 'Nom',
	'Enter here the category name in the default language (%title)' => 'Entrez ici le nom de la catégorie dans la langue par défaut (%title)',
