...
return array(
    ...
    'Core hook of Thelia.' => 'Hook natif de Thelia',
    'Countries' => 'Pays',
    ...
    'If checked, it indicates that this hook is used by a hook block. Else by hook function.' => 'Indique que ce hook utilise un bloc smarty hookBlock. sinon une fonction smarty hook.',
    ...
    'Product\'s attributes included in this sale operation' => 'Declinaisons incluses dans cette promotion',
    'Products' => 'Produits',
    ...
    'Sets the number of decimal points' => 'Nombre de chiffres après la virgule',
    ...
    'The method name that will handle the hook event.' => 'Le nom de la méthode qui va traiter l\'event du hook.',
    ...
    'The service id that will handle the hook (defined in the config.xml file of the module).' => 'L\'id du service qui va traiter le hook (défini dans le fichier config.xml du module)',
