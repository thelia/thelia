...
return array(
    ...
    'French 19.6% VAT with ecotax is the applicance of the ecotax (on the product price) then the appliance of the 19.6% tax (on the product price + the ecotax amount).' => '"French 20% VAT with Ecotax" first add the "Ecotax" amount to the product price, and then applies the "20% VAT" tax to the total amount.',
    'From' => 'From',
