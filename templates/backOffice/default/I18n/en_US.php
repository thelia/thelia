...
return array(
    ...
    'Graft this module' => 'Graft this module',
    'H:i:s' => 'H:i:s',
    ...
    'Hook short description' => 'Hook short description',
    ...
    'If checked, it indicates that this hook is used by a hook block. Else by hook function.' => 'If checked, it indicates that this hook is used by a hook block. Else by hook function.',
    ...
    'Sets the number of decimal points' => 'Sets the number of decimal points',
    ...
    'There is no files to associate to your product. Only documents that are not visible can be selected !' => 'There is no files to associate to your product. Only documents that are not visible can be selected !',
