...
return array(
    ...
    'EAN Code' => 'EAN Code',
    'Ecotax is a tax wich add a defined amount (throug a product feature) to the product price.' => 'Ecotax is a tax wich adds an amount defined by a product feature to the product price.',
    ...
    'French 19.6% VAT with ecotax is the applicance of the ecotax (on the product price) then the applicance of the 19.6% tax (on the product price + the ecotax amount).' => '"French 20% VAT with Ecotax" first add the "Ecotax" amount to the product price, and then applies the "20% VAT" tax to the total amount.',
    'From' => 'From',
    ...
    'Tax rule taxes will be update for the following countries :' => 'Tax rule will be updated for the following countries :',
