...
return [
    ...
    'EAN Code' => 'EAN Code',
    'Each combination has its own file to download. Only the documents of this product which are not visible can be selected, so that they cannot be downloaded for free.' => 'Each combination has its own file to download. Only the documents of this product which are not visible can be selected, so that they cannot be downloaded for free.',
    ...
    'Edit next image' => 'Edit next image',
    ...
    'Edit previous image' => 'Edit previous image',
    ...
    'No' => 'No',
    'No API key has been created yet. Click the [+} button to create one.' => 'No API key has been created yet. Click the [+} button to create one.',
    ...
    'No brand' => 'No brand',
    'No brand found for "%term"' => 'No brand found for "%term"',
    ...
    'No coupon for this order' => 'No coupon for this order',
    ...
    'No document is associated with this virtual product: your customers will not be able to download anything.' => 'No document is associated with this virtual product: your customers will not be able to download anything.',
    ...
    'No transaction for this order' => 'No transaction for this order',
    ...
    'N° ISO' => 'N° ISO',
    'OK' => 'OK',
    'ORDER TOTAL WITH TAXES' => 'ORDER TOTAL WITH TAXES',
    'Official' => 'Official',
    'Online' => 'Online',
    ...
    'Order placed on %order_date at %order_time' => 'Order placed on %order_date at %order_time',
    ...
    'Save' => 'Save',
    'Save SMTP configuration' => 'Save SMTP configuration',
    ...
    'Select unassigned countries' => 'Select unassigned countries',
    ...
    'Shipping with taxes' => 'Shipping with taxes',
    ...
    'Toggle all rights' => 'Toggle all rights',
    ...
    'Total with taxes after discount' => 'Total with taxes after discount',
    'Total with taxes before discount' => 'Total with taxes before discount',
    ...
    'View' => 'View',
    'View details and edit this order' => 'View details and edit this order',
