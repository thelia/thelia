...
namespace BackOfficeDefaultTwigBundle\Form\Folder;
...
final class FolderType extends AbstractType
{
    ...
    public function buildForm(FormBuilderInterface $builder, array $options): void
    {
        $builder
            ->add('title', TextType::class, [
                ...
                'label' => $this->translator->trans('Folder title'),
            ])
            ->add('parent', IntegerType::class, [
                'constraints' => [new NotBlank()],
                'label' => $this->translator->trans('Parent folder'),
            ])
            ...
            ->add('visible', CheckboxType::class, [
                'required' => false,
                'label' => $this->translator->trans('This folder is online'),
            ]);
    ...
    {
        $resolver
            ->setDefaults(['include_id' => false, 'include_description' => false, 'csrf_token_id' => 'admin.folder'])
