...
<!--[if (gte IE 9)|!(IE)]><!--><html class="no-js" lang="{lang attr="code"}"> <!--<![endif]-->
<head>
...
<body class="{block name="body-class"}{/block}" itemscope itemtype="http://schema.org/WebPage">
        ...
        <div class="header-container" itemscope itemtype="http://schema.org/WPHeader">
            ...
            <div class="navbar" itemscope itemtype="http://schema.org/SiteNavigationElement">
                <div class="container">
                    ...
                    <nav class="navbar-collapse collapse nav-main" aria-label="{intl l="Main Navigation"}" role="navigation">
                        <ul class="nav navbar-nav navbar-cart navbar-right">
                        {loop type="auth" name="customer_info_block" role="CUSTOMER" context="front"}
                            <li><a class="logout" href="{url path="/logout"}">{intl l="Log out!"}</a></li>
                            <li><a class="account" href="{url path="/account"}">{intl l="My Account"}</a></li>
                        {/loop}
                        {elseloop rel="customer_info_block"}
                            <li><a class="register" href="{url path="/register"}">{intl l="Register!"}</a></li>
                            <li class="dropdown">
                                ...
                                <div class="dropdown-menu">
                                    ...
                                    <form id="form-login-mini" action="{url path="/login"}" method="post" {form_enctype form=$form}>
                                        ...
                                        {form_field form=$form field="success_url"}<input name="{$name}" type="hidden" value="{navigate to="current"}">{/form_field}
                                        {form_field form=$form field="email"}
                                        <div class="form-group group-email">
                                            <label for="{$label_attr.for}-mini">{intl l="Email address"}</label>
                                            <input class="form-control" id="{$label_attr.for}-mini" name="{$name}" type="email" maxlength="255" aria-required="true" required>
                                        </div><!-- /.form-group -->
                                        {/form_field}
                                        ...
                                        <div class="form-group group-password">
                                            ...
                                            <input class="form-control" id="{$label_attr.for}-mini" name="{$name}" type="password" maxlength="255" aria-required="true" required>
                                        </div><!-- /.form-group -->
                                        {/form_field}

                                        {form_field form=$form field="account"}<input name="{$name}" type="hidden" value="1">{/form_field}
                                        <div class="group-btn">
                                          <button class="btn btn-login-mini" type="submit">{intl l="Sign In"}</button>
                                          <a class="btn btn-register-mini" href="{url path="/register"}">{intl l="Register"}</a>
                                        </div>
                                    </form>
                                    {/form}
                                </div>
                        ...
                        <ul class="nav navbar-nav navbar-categories">
                            ...
                            {loop type="category" name="category.navigation" parent="0"}<li><a href="{$URL}">{$TITLE}</a></li>
                            {/loop}
                        </ul>
                    </nav>
                </div>
            ...
            <header class="container" role="banner">
                <div class="header">
                    <h1 class="logo">
                        <a href="{navigate to="index"}" title="{$store_name}">{images file='assets/img/logo.gif'}<img src="{$asset_url}" alt="{$store_name}">{/images}</a>
                    </h1>

                    <div class="language-container">

                        <div class="search-container">
                            <form id="form-search" action="{url path="/search"}" method="get" aria-labelledby="search-label" role="search">
                                <label id="search-label" for="q">{intl l="Search a product"}</label>
                                <div class="input-group">
                                    <input class="form-control" id="q" name="q" type="search" placeholder="{intl l="Search..."}" autocomplete="off" aria-required="true" required pattern=".{ldelim}2,{rdelim}" title="{intl l="Minimum 2 characters."}">
                                    <div class="input-group-btn">
                                        <button class="btn btn-search" type="submit"><i class="icon-search"></i><span>{intl l="Search"}</span></button>
                                    </div>
                                </div>
                            </form>
                        ...
                        <div class="language-switch" aria-labelledby="language-label" role="form">
                            <span class="dropdown-label" id="language-label">{intl l="Language:"}</span>
                        ...
                        <div class="currency-switch" aria-labelledby="currency-label" role="form">
                            <span class="dropdown-label" id="currency-label">{intl l="Currency:"}</span>
        ...
        <main class="main-container" role="main">
            <div class="container">
                {block name="breadcrumb"}
                    {include file="misc/breadcrumb.tpl"}
                {/block}
                <div id="content">
                ...
                <div class="container">
                    <div class="banner banner-col-3">
                        <div class="col">
                            ...
                            {intl l="Free shipping"}
                            <small>{intl l="Orders over $50"}</small>
                        </div>
                        <div class="col">
                            <span class="icon-credit-card"></span>
                            {intl l="Secure payment"}
                            <small>{intl l="Multi-payment platform"}</small>
                        </div>
                        <div class="col">
                            <span class="icon-info"></span>
                            {intl l="Need help ?"}
                            <small>{intl l="Questions ? See our F.A.Q."}</small>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="blocks block-col-4">
                        ...
                        <div class="col">
                            <section class="block block-default">
                                ...
                                <div class="block-content">
                                    <ul>
                                    {loop name="footer_links" type="content" folder="2"}<li><a href="{$URL}">{$TITLE}</a></li>{/loop}
                            ...
                            <section class="block block-social">
                                ...
                                <div class="block-content">
                                    ...
                                    <ul role="presentation">
                                        <li>
                                            <a class="facebook" data-toggle="tooltip" data-placement="top" href="http://facebook.com" rel="nofollow" title="{intl l="Facebook"}" target="_blank">
                                        ...
                                        <li>
                                            <a class="twitter" data-toggle="tooltip" data-placement="top" href="https://twitter.com" rel="nofollow" title="{intl l="Twitter"}" target="_blank">
                                                <span class="icon-stack">
                                                    <span class="icon-circle icon-stack-base"></span>
                                        ...
                                        <li>
                                            <a class="instagram" data-toggle="tooltip" data-placement="top" href="http://instagram.com" rel="nofollow" title="{intl l="Instagram"}" target="_blank">
                                                <span class="icon-stack">
                                                    <span class="icon-circle icon-stack-base"></span>
                                        ...
                                        <li>
                                            <a class="google-plus" data-toggle="tooltip" data-placement="top" href="http://www.google.com" rel="nofollow" title="{intl l="Google+"}" target="_blank">
                                                <span class="icon-stack">
                                                    <span class="icon-circle icon-stack-base"></span>
                                        ...
                                        <li>
                                            <a class="youtube" data-toggle="tooltip" data-placement="top" href="http://www.youtube.com" rel="nofollow" title="{intl l="Youtube"}" target="_blank">
                                                <span class="icon-stack">
                                                    <span class="icon-circle icon-stack-base"></span>
                                        ...
                                        <li>
                                            <a class="rss" data-toggle="tooltip" data-placement="top" href="#rss" rel="nofollow" title="{intl l="RSS"}" target="_blank">
                                                <span class="icon-stack">
                                                    <span class="icon-circle icon-stack-base"></span>
                                ...
                                <div class="block-content">
                                    ...
                                    <form id="form-newsletter-mini" action="{url path="/newsletter"}" method="post">
                                        ...
                                        <div class="form-group">
                                            <label for="{$label_attr.for}-mini">{intl l="Email address"}</label>
                                            <input class="form-control" id="{$label_attr.for}-mini" name="{$name}" type="email" maxlength="255" placeholder="{intl l="Your email address"}" aria-describedby="newsletter-describe" {if $required} aria-required="true" required{/if} autocomplete="off">
                                        </div>
                                        {/form_field}
                                        <button class="btn btn-subscribe" type="submit">{intl l="Subscribe"}</button>
                                    </form>
                                    {/form}
                                </div><!-- /.block-content -->
                            </section>
                                    ...
                                    <ul>
                                        <li class="contact-address">
                                          <address class="adr" itemprop="address" itemscope itemtype="http://schema.org/PostalAddress">
                                            ...
                                            <span class="locality" itemprop="addressLocality">{config key="store_city"}{if {config key="store_country"} }{loop type="country" name="address.country.title" id={config key="store_country"}}, <span class="country-name">{$TITLE}</span>{/loop}{/if}</span>
                                          </address>
                                        </li>
                                        {if {config key="store_phone"} }
                                            <li class="contact-phone"><span class="tel" itemprop="telephone">{config key="store_phone"}</span></li>
                                        {/if}
                                        {if {config key="store_email"} }
                                            <li class="contact-email">{mailto address={config key="store_email"} encode="hex" extra='class="email" itemprop="email"'}</li>
                                        {/if}
                                    </ul>
                                </div>
                            </section>
            ...
            <footer class="footer-info" role="contentinfo">
                <div class="container">
                    <div class="info">
                        ...
                        <section class="copyright">{intl l="Copyright"} &copy;
                            <time datetime="{'Y-m-d'|date}">{'Y'|date}</time>
                            <a href="http://thelia.net" rel="external">Thelia</a>
                        </section>
                    </div>
                </div>
            </footer><!-- /.footer-info -->
    ...
    <script>if (typeof jQuery == 'undefined') { {javascripts file='assets/js/libs/jquery.js'} document.write(unescape("%3Cscript src='{$asset_url}' %3E%3C/script%3E"));{/javascripts}}</script>

    <script src="//ajax.aspnetcdn.com/ajax/jquery.validate/1.11.1/jquery.validate.min.js"></script>

    {javascripts file='assets/js/bootstrap/bootstrap.js'}<script src="{$asset_url}"></script>{/javascripts}
    {javascripts file='assets/js/plugins/bootbox/bootbox.js'}<script src="{$asset_url}"></script>{/javascripts}

    {block name="after-javascript-include"}{/block}
    {block name="javascript-initialization"}{/block}

    <!-- Custom scripts -->
    {javascripts file='assets/js/script.js'}<script src="{$asset_url}"></script>{/javascripts}
</body>
</html>