...
return array(
    ...
    'Demo product description' => 'Описание демо товара',
    'Demo product title' => 'Название демо товара',
    ...
    'Product Empty Message' => 'Это действительно быстро добавить товар.<ol><li>Выберите <strong>NEW</strong> во вкладке подробнее, если вы хотите видеть товар в разделе новых товаров.</li><li>Выберите <strong>SALE</strong> во вкладке подробнее, если вы хотите видеть товар в разделе специальное предложение.</li></ol>',
    ...
    'Save %amount%sign on these products' => 'Сэкономьте %amount%sign приобретая эти товары',
