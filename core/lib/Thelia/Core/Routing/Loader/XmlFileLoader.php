...
/*
 * This file is a copy of Symfony's routing XmlFileLoader, kept by Thelia because the
 * Config/routing.xml files shipped by modules are part of the module contract: Symfony
 * deprecated its XML routing loader in 7.4 and removes it in 8.0, while Thelia keeps
 * loading module routing.xml files (see Thelia\Core\Routing\ModuleXmlLoader).
 *
...
namespace Thelia\Core\Routing\Loader;

use Symfony\Component\Config\Loader\FileLoader;
use Symfony\Component\Config\Resource\FileResource;
use Symfony\Component\Config\Util\XmlUtils;
use Thelia\Core\Routing\Loader\Traits\HostTrait;
use Thelia\Core\Routing\Loader\Traits\LocalizedRouteTrait;
use Thelia\Core\Routing\Loader\Traits\PrefixTrait;
