...
class SchemaCombiner
{
     ...
     */
    protected static function getOwnerDocument(\DOMElement $element): ?\DOMDocument
    {
     ...
     */
    public function combine(array $schemaDocuments = [], array $externalSchemaDocuments = []): array
    {
