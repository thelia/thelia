...
/**
 * Turns a consent on or off, which is how a shop stops asking for one without
 * deleting the acceptances already collected under it.
 */
class ConsentToggleActiveEvent extends ConsentEvent
{
