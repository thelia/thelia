...
/**
 * Class ContentI18Import
 * @package Thelia\ImportExport\Import\Type
 */
class ContentI18Import extends ImportHandler
{
    /**
     * @return string|array
     *
    ...
    {
        //return ["id", "content_title", "content_description","content_chapo","content_postscriptum","page_title", "meta_description", "meta_keywords", "url"];
        return(["id"]);
    }
}
