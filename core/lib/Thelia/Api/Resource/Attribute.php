...
class Attribute extends AbstractTranslatableResource
{
    ...
    #[Groups([self::GROUP_ADMIN_READ, AttributeAv::GROUP_ADMIN_READ, AttributeAv::GROUP_ADMIN_WRITE, Product::GROUP_ADMIN_READ_SINGLE, AttributeCombination::GROUP_ADMIN_WRITE])]
    public ?int $id = null;
