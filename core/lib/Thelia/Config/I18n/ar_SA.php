...
return [
    ...
    'Message' => 'الرسالة',
    'Message content: %message%' => 'محتوى الرسالة:٪ message٪',
    ...
    'Cart is empty or contains no items' => 'السلة فارغة أو لا تحتوي على أي عناصر',
    'Delivery address has no country' => 'عنوان التسليم لا يتضمن دولة',
    'Delivery address is required' => 'عنوان التسليم مطلوب',
    'Delivery address not found' => 'لم يتم العثور على عنوان التسليم',
    'Delivery module does not accept this cart' => 'الوحدة النمطية للتسليم لا تقبل هذه السلة',
    'Delivery module does not deliver to this address' => 'الوحدة النمطية للتسليم لا توصل إلى هذا العنوان',
    'Delivery module is not available' => 'الوحدة النمطية للتسليم غير متاحة',
    'Delivery module is required' => 'الوحدة النمطية للتسليم مطلوبة',
    'Delivery module not found' => 'لم يتم العثور على الوحدة النمطية للتسليم',
    'Invalid delivery configuration' => 'إعدادات التسليم غير صحيحة',
    'Invalid payment configuration' => 'إعدادات الدفع غير صحيحة',
    'Invoice address is required' => 'عنوان الفاتورة مطلوب',
    'Invoice address not found' => 'لم يتم العثور على عنوان الفاتورة',
    'Not enough stock for product %ref' => 'المخزون غير كافٍ للمنتج %ref',
    'Payment module does not accept this cart' => 'الوحدة النمطية للدفع لا تقبل هذه السلة',
    'Payment module is not available' => 'الوحدة النمطية للدفع غير متاحة',
    'Payment module is required' => 'الوحدة النمطية للدفع مطلوبة',
    'Payment module not found' => 'لم يتم العثور على الوحدة النمطية للدفع',
    'Required address is missing' => 'العنوان المطلوب مفقود',
    'The billing address is missing information an invoice requires' => 'عنوان الفاتورة تنقصه بيانات مطلوبة لإصدار الفاتورة',
    'This order cannot be placed yet.' => 'لا يمكن تأكيد هذا الطلب بعد.',
    'This order is already being placed. Please wait a moment and try again.' => 'هذا الطلب قيد التأكيد بالفعل. يرجى الانتظار قليلاً ثم المحاولة مرة أخرى.',
    'This order requires an account.' => 'يتطلب هذا الطلب وجود حساب.',
    'This shop is not asking for the consent "%consent".' => 'هذا المتجر لا يطلب الموافقة "%consent".',
    'You must accept "%consent" to place this order.' => 'يجب قبول "%consent" لتأكيد هذا الطلب.',
];
