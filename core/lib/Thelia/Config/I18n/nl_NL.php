...
return [
    ...
    'Cart is empty or contains no items' => 'De winkelwagen is leeg of bevat geen artikelen',
    'Delivery address has no country' => 'Het verzendadres heeft geen land',
    'Delivery address is required' => 'Een verzendadres is verplicht',
    'Delivery address not found' => 'Verzendadres niet gevonden',
    'Delivery module does not accept this cart' => 'De verzendmodule accepteert deze winkelwagen niet',
    'Delivery module does not deliver to this address' => 'De verzendmodule levert niet op dit adres',
    'Delivery module is not available' => 'De verzendmodule is niet beschikbaar',
    'Delivery module is required' => 'Een verzendmodule is verplicht',
    'Delivery module not found' => 'Verzendmodule niet gevonden',
    'Invalid delivery configuration' => 'Ongeldige verzendconfiguratie',
    'Invalid payment configuration' => 'Ongeldige betaalconfiguratie',
    'Invoice address is required' => 'Een factuuradres is verplicht',
    'Invoice address not found' => 'Factuuradres niet gevonden',
    'Not enough stock for product %ref' => 'Onvoldoende voorraad voor product %ref',
    'Payment module does not accept this cart' => 'De betaalmodule accepteert deze winkelwagen niet',
    'Payment module is not available' => 'De betaalmodule is niet beschikbaar',
    'Payment module is required' => 'Een betaalmodule is verplicht',
    'Payment module not found' => 'Betaalmodule niet gevonden',
    'Required address is missing' => 'Er ontbreekt een verplicht adres',
    'The billing address is missing information an invoice requires' => 'Op het factuuradres ontbreken gegevens die voor een factuur nodig zijn',
    'This order cannot be placed yet.' => 'Deze bestelling kan nog niet worden geplaatst.',
    'This order is already being placed. Please wait a moment and try again.' => 'Deze bestelling wordt al geplaatst. Wacht een moment en probeer het opnieuw.',
