...
return [
    ...
    'Message' => 'Wiadomość',
    'Message content: %message%' => 'Treść wiadomości: %message%',
    ...
    'type' => 'typ',
    'Cart is empty or contains no items' => 'Koszyk jest pusty lub nie zawiera żadnych pozycji',
    'Delivery address has no country' => 'Adres dostawy nie zawiera kraju',
    'Delivery address is required' => 'Adres dostawy jest wymagany',
    'Delivery address not found' => 'Nie odnaleziono adresu dostawy',
    'Delivery module does not accept this cart' => 'Moduł dostawy nie akceptuje tego koszyka',
    'Delivery module does not deliver to this address' => 'Moduł dostawy nie realizuje dostaw pod ten adres',
    'Delivery module is not available' => 'Moduł dostawy jest niedostępny',
    'Delivery module is required' => 'Moduł dostawy jest wymagany',
    'Delivery module not found' => 'Nie odnaleziono modułu dostawy',
    'Invalid delivery configuration' => 'Nieprawidłowa konfiguracja dostawy',
    'Invalid payment configuration' => 'Nieprawidłowa konfiguracja płatności',
    'Invoice address is required' => 'Adres do faktury jest wymagany',
    'Invoice address not found' => 'Nie odnaleziono adresu do faktury',
    'Not enough stock for product %ref' => 'Niewystarczająca ilość produktu %ref w magazynie',
    'Payment module does not accept this cart' => 'Moduł płatności nie akceptuje tego koszyka',
    'Payment module is not available' => 'Moduł płatności jest niedostępny',
    'Payment module is required' => 'Moduł płatności jest wymagany',
    'Payment module not found' => 'Nie odnaleziono modułu płatności',
    'Required address is missing' => 'Brakuje wymaganego adresu',
    'The billing address is missing information an invoice requires' => 'W adresie rozliczeniowym brakuje danych wymaganych do wystawienia faktury',
    'This order cannot be placed yet.' => 'Tego zamówienia nie można jeszcze złożyć.',
    'This order is already being placed. Please wait a moment and try again.' => 'To zamówienie jest już składane. Proszę chwilę poczekać i spróbować ponownie.',
    'This order requires an account.' => 'To zamówienie wymaga konta.',
    'This shop is not asking for the consent "%consent".' => 'Ten sklep nie wymaga zgody "%consent".',
    'You must accept "%consent" to place this order.' => 'Aby złożyć to zamówienie, należy zaakceptować "%consent".',
];
