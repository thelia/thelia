...
return [
    ...
    'Message' => 'Pesan',
    'Message content: %message%' => 'Isi pesan: %pesan%',
    ...
    "Sender's e-mail address: %email%" => 'Alamat email pengirim: %email%',
    'Sender name: %name%' => 'Nama pengirim: %nama%',
    ...
    'Cart is empty or contains no items' => 'Keranjang kosong atau tidak berisi item',
    'Delivery address has no country' => 'Alamat pengiriman tidak memiliki negara',
    'Delivery address is required' => 'Alamat pengiriman wajib diisi',
    'Delivery address not found' => 'Alamat pengiriman tidak ditemukan',
    'Delivery module does not accept this cart' => 'Modul pengiriman tidak menerima keranjang ini',
    'Delivery module does not deliver to this address' => 'Modul pengiriman tidak mengirim ke alamat ini',
    'Delivery module is not available' => 'Modul pengiriman tidak tersedia',
    'Delivery module is required' => 'Modul pengiriman wajib dipilih',
    'Delivery module not found' => 'Modul pengiriman tidak ditemukan',
    'Invalid delivery configuration' => 'Konfigurasi pengiriman tidak valid',
    'Invalid payment configuration' => 'Konfigurasi pembayaran tidak valid',
    'Invoice address is required' => 'Alamat faktur wajib diisi',
    'Invoice address not found' => 'Alamat faktur tidak ditemukan',
    'Not enough stock for product %ref' => 'Stok tidak mencukupi untuk produk %ref',
    'Payment module does not accept this cart' => 'Modul pembayaran tidak menerima keranjang ini',
    'Payment module is not available' => 'Modul pembayaran tidak tersedia',
    'Payment module is required' => 'Modul pembayaran wajib dipilih',
    'Payment module not found' => 'Modul pembayaran tidak ditemukan',
    'Required address is missing' => 'Alamat yang diperlukan tidak ada',
    'The billing address is missing information an invoice requires' => 'Alamat penagihan tidak memuat informasi yang diperlukan untuk faktur',
    'This order cannot be placed yet.' => 'Pesanan ini belum dapat dibuat.',
    'This order is already being placed. Please wait a moment and try again.' => 'Pesanan ini sedang dibuat. Mohon tunggu sebentar lalu coba lagi.',
    'This order requires an account.' => 'Pesanan ini memerlukan akun.',
    'This shop is not asking for the consent "%consent".' => 'Toko ini tidak meminta persetujuan "%consent".',
    'You must accept "%consent" to place this order.' => 'Anda harus menyetujui "%consent" untuk membuat pesanan ini.',
];
