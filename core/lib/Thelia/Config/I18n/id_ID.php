...
return array(
    ...
    '\'%type\' loop class should extends Thelia\Core\Template\Element\BaseLoop' => '\'% tipe\' loop kelas harus meluas Thelia\\Core\\Template\\Element\\BaseLoop',
    'A currency with code "%name" already exists.' => 'Mata uang dengan kode "%name" sudah ada.',
    'A loop named \'%name\' already exists in the current scope.' => 'Sebuah loop yang bernama \'%name\' sudah ada dalam lingkup saat ini.',
    ...
    'Add to all product templates' => 'Tambahkan ke semua produk template',
    ...
    'Alerts' => 'Peringatan',
    'Alpha code 2 *' => 'Alpha kode 2 *',
    'Alpha code 3 *' => 'Alpha kode 3 *',
    ...
    'By cart total amount' => 'Dengan jumlah total keranjang',
    ...
    'Cannot instanciante module "%name%": the namespace is null. Maybe the model is not loaded ?' => 'Tidak instanciante modul "%name%": namespace null. Mungkin model tidak dimuat?',
    'Cart item count condition' => 'Gerobak kondisi jumlah barang',
    ...
    'City' => 'kota',
    'Combination builder' => 'Kombinasi builder',
    'Compagny' => 'Compagny',
    'Company' => 'perusahaan',
    ...
    'ISO Code *' => 'Kode ISO *',
    'If a translation is missing or incomplete :' => 'Jika terjemahan hilang atau tidak lengkap:',
    ...
    'Image position updated' => 'Posisi gambar Diperbarui',
    'Images deleted successfully' => 'Gambar dihapus berhasil',
