...
return [
    ...
    'Message' => 'Üzenet',
    'Message content: %message%' => 'Üzenet tartalma: %message%',
    ...
    'Cart is empty or contains no items' => 'A kosár üres, vagy nem tartalmaz tételt',
    'Delivery address has no country' => 'A szállítási címhez nincs megadva ország',
    'Delivery address is required' => 'A szállítási cím megadása kötelező',
    'Delivery address not found' => 'A szállítási cím nem található',
    'Delivery module does not accept this cart' => 'A szállítási modul nem fogadja el ezt a kosarat',
    'Delivery module does not deliver to this address' => 'A szállítási modul nem szállít erre a címre',
    'Delivery module is not available' => 'A szállítási modul nem érhető el',
    'Delivery module is required' => 'A szállítási modul megadása kötelező',
    'Delivery module not found' => 'A szállítási modul nem található',
    'Invalid delivery configuration' => 'Érvénytelen szállítási beállítás',
    'Invalid payment configuration' => 'Érvénytelen fizetési beállítás',
    'Invoice address is required' => 'A számlázási cím megadása kötelező',
    'Invoice address not found' => 'A számlázási cím nem található',
    'Not enough stock for product %ref' => 'Nincs elegendő készlet a(z) %ref termékből',
    'Payment module does not accept this cart' => 'A fizetési modul nem fogadja el ezt a kosarat',
    'Payment module is not available' => 'A fizetési modul nem érhető el',
    'Payment module is required' => 'A fizetési modul megadása kötelező',
    'Payment module not found' => 'A fizetési modul nem található',
    'Required address is missing' => 'Hiányzik egy kötelező cím',
    'The billing address is missing information an invoice requires' => 'A számlázási címről hiányoznak a számla kiállításához szükséges adatok',
    'This order cannot be placed yet.' => 'Ez a megrendelés még nem adható le.',
    'This order is already being placed. Please wait a moment and try again.' => 'Ez a megrendelés már leadás alatt áll. Kérjük, várjon egy pillanatot, majd próbálja újra.',
    'This order requires an account.' => 'Ehhez a megrendeléshez fiók szükséges.',
    'This shop is not asking for the consent "%consent".' => 'Ez az áruház nem kéri a(z) "%consent" hozzájárulást.',
    'You must accept "%consent" to place this order.' => 'A megrendelés leadásához el kell fogadnia a(z) "%consent" feltételt.',
];
