...
return [
    ...
    'Message' => 'Správa',
    'Message content: %message%' => 'Obsah správy: %message%',
    ...
    'Cart is empty or contains no items' => 'Košík je prázdny alebo neobsahuje žiadne položky',
    'Delivery address has no country' => 'Adresa dodania nemá uvedenú krajinu',
    'Delivery address is required' => 'Adresa dodania je povinná',
    'Delivery address not found' => 'Adresa dodania nebola nájdená',
    'Delivery module does not accept this cart' => 'Dodací modul neakceptuje tento košík',
    'Delivery module does not deliver to this address' => 'Dodací modul nedoručuje na túto adresu',
    'Delivery module is not available' => 'Dodací modul nie je dostupný',
    'Delivery module is required' => 'Dodací modul je povinný',
    'Delivery module not found' => 'Dodací modul nebol nájdený',
    'Invalid delivery configuration' => 'Neplatné nastavenie dodania',
    'Invalid payment configuration' => 'Neplatné nastavenie platby',
    'Invoice address is required' => 'Fakturačná adresa je povinná',
    'Invoice address not found' => 'Fakturačná adresa nebola nájdená',
    'Not enough stock for product %ref' => 'Nedostatok tovaru na sklade pre produkt %ref',
    'Payment module does not accept this cart' => 'Platobný modul neakceptuje tento košík',
    'Payment module is not available' => 'Platobný modul nie je dostupný',
    'Payment module is required' => 'Platobný modul je povinný',
    'Payment module not found' => 'Platobný modul nebol nájdený',
    'Required address is missing' => 'Chýba povinná adresa',
    'The billing address is missing information an invoice requires' => 'Vo fakturačnej adrese chýbajú údaje potrebné na vystavenie faktúry',
    'This order cannot be placed yet.' => 'Túto objednávku zatiaľ nie je možné odoslať.',
    'This order is already being placed. Please wait a moment and try again.' => 'Táto objednávka sa už odosiela. Počkajte prosím chvíľu a skúste to znova.',
    'This order requires an account.' => 'Táto objednávka vyžaduje účet.',
    'This shop is not asking for the consent "%consent".' => 'Tento obchod nevyžaduje súhlas "%consent".',
    'You must accept "%consent" to place this order.' => 'Na odoslanie tejto objednávky musíte súhlasiť s "%consent".',
];
