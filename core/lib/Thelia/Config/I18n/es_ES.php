...
return [
    ...
    'Message' => 'Mensaje',
    'Message content: %message%' => 'Contenido del mensaje: %message%',
    ...
    "Sender's e-mail address: %email%" => 'Dirección de correo electrónico del remitente: %email%',
    'Sender name: %name%' => 'Nombre del remitente: %name%.',
    ...
    'Cart is empty or contains no items' => 'El carrito está vacío o no contiene ningún artículo',
    'Delivery address has no country' => 'La dirección de entrega no tiene país',
    'Delivery address is required' => 'Se requiere una dirección de entrega',
    'Delivery address not found' => 'Dirección de entrega no encontrada',
    'Delivery module does not accept this cart' => 'El módulo de entrega no acepta este carrito',
    'Delivery module does not deliver to this address' => 'El módulo de entrega no realiza envíos a esta dirección',
    'Delivery module is not available' => 'El módulo de entrega no está disponible',
    'Delivery module is required' => 'Se requiere un módulo de entrega',
    'Delivery module not found' => 'Módulo de entrega no encontrado',
    'Invalid delivery configuration' => 'Configuración de entrega no válida',
    'Invalid payment configuration' => 'Configuración de pago no válida',
    'Invoice address is required' => 'Se requiere una dirección de facturación',
    'Invoice address not found' => 'Dirección de facturación no encontrada',
    'Not enough stock for product %ref' => 'No hay existencias suficientes para el producto %ref',
    'Payment module does not accept this cart' => 'El módulo de pago no acepta este carrito',
    'Payment module is not available' => 'El módulo de pago no está disponible',
    'Payment module is required' => 'Se requiere un módulo de pago',
    'Payment module not found' => 'Módulo de pago no encontrado',
    'Required address is missing' => 'Falta una dirección obligatoria',
    'The billing address is missing information an invoice requires' => 'A la dirección de facturación le faltan datos necesarios para emitir una factura',
    'This order cannot be placed yet.' => 'Este pedido todavía no se puede realizar.',
    'This order is already being placed. Please wait a moment and try again.' => 'Este pedido ya se está realizando. Por favor, espere un momento e inténtelo de nuevo.',
