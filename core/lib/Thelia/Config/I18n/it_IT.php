...
return [
    ...
    'Message content: %message%' => 'Contenuto del messaggio: %messaggio%',
    ...
    'Search' => 'Ricerca',
    "Sender's e-mail address: %email%" => 'Indirizzo e-mail del mittente: %email%',
    'Sender name: %name%' => 'Nome mittente: %name%',
    ...
    'Cart is empty or contains no items' => 'Il carrello è vuoto o non contiene articoli',
    'Delivery address has no country' => 'L\'indirizzo di spedizione non indica alcun paese',
    'Delivery address is required' => 'L\'indirizzo di spedizione è obbligatorio',
    'Delivery address not found' => 'Indirizzo di spedizione non trovato',
    'Delivery module does not accept this cart' => 'Il modulo di spedizione non accetta questo carrello',
    'Delivery module does not deliver to this address' => 'Il modulo di spedizione non effettua consegne a questo indirizzo',
    'Delivery module is not available' => 'Il modulo di spedizione non è disponibile',
    'Delivery module is required' => 'Il modulo di spedizione è obbligatorio',
    'Delivery module not found' => 'Modulo di spedizione non trovato',
    'Invalid delivery configuration' => 'Configurazione di spedizione non valida',
    'Invalid payment configuration' => 'Configurazione di pagamento non valida',
    'Invoice address is required' => 'L\'indirizzo di fatturazione è obbligatorio',
    'Invoice address not found' => 'Indirizzo di fatturazione non trovato',
    'Not enough stock for product %ref' => 'Disponibilità di magazzino insufficiente per il prodotto %ref',
    'Payment module does not accept this cart' => 'Il modulo di pagamento non accetta questo carrello',
    'Payment module is not available' => 'Il modulo di pagamento non è disponibile',
    'Payment module is required' => 'Il modulo di pagamento è obbligatorio',
    'Payment module not found' => 'Modulo di pagamento non trovato',
    'Required address is missing' => 'Manca un indirizzo obbligatorio',
    'The billing address is missing information an invoice requires' => 'All\'indirizzo di fatturazione mancano i dati necessari per emettere una fattura',
    'This order cannot be placed yet.' => 'Questo ordine non può ancora essere effettuato.',
    'This order is already being placed. Please wait a moment and try again.' => 'Questo ordine è già in corso di conferma. Attenda un momento e riprovi.',
