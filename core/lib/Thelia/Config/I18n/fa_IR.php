...
return [
    ...
    'Message' => 'پيام',
    'Message content: %message%' => 'محتوای پیام: %message%',
    ...
    "Sender's e-mail address: %email%" => 'آدرس ایمیل فرستنده: %email%',
    'Sender name: %name%' => 'نام فرستنده: %name%',
    ...
    'Cart is empty or contains no items' => 'سبد خرید خالی است یا هیچ کالایی ندارد',
    'Delivery address has no country' => 'آدرس تحویل کشور ندارد',
    'Delivery address is required' => 'آدرس تحویل الزامی است',
    'Delivery address not found' => 'آدرس تحویل یافت نشد',
    'Delivery module does not accept this cart' => 'ماژول تحویل این سبد خرید را نمی‌پذیرد',
    'Delivery module does not deliver to this address' => 'ماژول تحویل به این آدرس تحویل نمی‌دهد',
    'Delivery module is not available' => 'ماژول تحویل در دسترس نیست',
    'Delivery module is required' => 'ماژول تحویل الزامی است',
    'Delivery module not found' => 'ماژول تحویل یافت نشد',
    'Invalid delivery configuration' => 'پیکربندی تحویل نامعتبر است',
    'Invalid payment configuration' => 'پیکربندی پرداخت نامعتبر است',
    'Invoice address is required' => 'آدرس فاکتور الزامی است',
    'Invoice address not found' => 'آدرس فاکتور یافت نشد',
    'Not enough stock for product %ref' => 'موجودی کافی برای محصول %ref وجود ندارد',
    'Payment module does not accept this cart' => 'ماژول پرداخت این سبد خرید را نمی‌پذیرد',
    'Payment module is not available' => 'ماژول پرداخت در دسترس نیست',
    'Payment module is required' => 'ماژول پرداخت الزامی است',
    'Payment module not found' => 'ماژول پرداخت یافت نشد',
    'Required address is missing' => 'آدرس الزامی وارد نشده است',
    'The billing address is missing information an invoice requires' => 'آدرس صورت‌حساب اطلاعات لازم برای صدور فاکتور را ندارد',
    'This order cannot be placed yet.' => 'این سفارش هنوز قابل ثبت نیست.',
    'This order is already being placed. Please wait a moment and try again.' => 'این سفارش در حال ثبت است. لطفاً کمی صبر کنید و دوباره تلاش کنید.',
    'This order requires an account.' => 'این سفارش به یک حساب کاربری نیاز دارد.',
    'This shop is not asking for the consent "%consent".' => 'این فروشگاه رضایت "%consent" را درخواست نمی‌کند.',
    'You must accept "%consent" to place this order.' => 'برای ثبت این سفارش باید "%consent" را بپذیرید.',
];
