...
return [
    ...
    'Cart is empty or contains no items' => 'עגלת הקניות ריקה או שאינה מכילה פריטים',
    'Delivery address has no country' => 'לכתובת המשלוח אין מדינה',
    'Delivery address is required' => 'נדרשת כתובת משלוח',
    'Delivery address not found' => 'כתובת המשלוח לא נמצאה',
    'Delivery module does not accept this cart' => 'מודול המשלוח אינו מקבל עגלה זו',
    'Delivery module does not deliver to this address' => 'מודול המשלוח אינו מבצע משלוחים לכתובת זו',
    'Delivery module is not available' => 'מודול המשלוח אינו זמין',
    'Delivery module is required' => 'נדרש מודול משלוח',
    'Delivery module not found' => 'מודול המשלוח לא נמצא',
    'Invalid delivery configuration' => 'הגדרות משלוח שגויות',
    'Invalid payment configuration' => 'הגדרות תשלום שגויות',
    'Invoice address is required' => 'נדרשת כתובת לחשבונית',
    'Invoice address not found' => 'כתובת החשבונית לא נמצאה',
    'Not enough stock for product %ref' => 'אין מספיק מלאי עבור המוצר %ref',
    'Payment module does not accept this cart' => 'מודול התשלום אינו מקבל עגלה זו',
    'Payment module is not available' => 'מודול התשלום אינו זמין',
    'Payment module is required' => 'נדרש מודול תשלום',
    'Payment module not found' => 'מודול התשלום לא נמצא',
    'Required address is missing' => 'חסרה כתובת נדרשת',
    'The billing address is missing information an invoice requires' => 'בכתובת החיוב חסרים פרטים הנדרשים להפקת חשבונית',
    'This order cannot be placed yet.' => 'לא ניתן לבצע הזמנה זו עדיין.',
    'This order is already being placed. Please wait a moment and try again.' => 'הזמנה זו כבר מבוצעת. אנא המתינו רגע ונסו שוב.',
    'This order requires an account.' => 'הזמנה זו מחייבת חשבון.',
    'This shop is not asking for the consent "%consent".' => 'חנות זו אינה מבקשת את ההסכמה "%consent".',
    'You must accept "%consent" to place this order.' => 'יש לאשר את "%consent" כדי לבצע הזמנה זו.',
];
