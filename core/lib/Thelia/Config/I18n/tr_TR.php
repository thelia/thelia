...
return [
    ...
    'Message' => 'Mesaj',
    'Mesaj içeriği: %message%' => 'Mesaj içeriği: %message%',
    ...
    "Sender's e-mail address: %email%" => 'Gönderenin e-posta adresi: e-posta%',
    'Sender name: %name%' => 'Gönderen adı: %name%',
    ...
    'Cart is empty or contains no items' => 'Sepet boş veya hiç ürün içermiyor',
    'Delivery address has no country' => 'Teslimat adresinde ülke bilgisi yok',
    'Delivery address is required' => 'Teslimat adresi gereklidir',
    'Delivery address not found' => 'Teslimat adresi bulunamadı',
    'Delivery module does not accept this cart' => 'Teslimat modülü bu sepeti kabul etmiyor',
    'Delivery module does not deliver to this address' => 'Teslimat modülü bu adrese teslimat yapmıyor',
    'Delivery module is not available' => 'Teslimat modülü kullanılamıyor',
    'Delivery module is required' => 'Teslimat modülü gereklidir',
    'Delivery module not found' => 'Teslimat modülü bulunamadı',
    'Invalid delivery configuration' => 'Geçersiz teslimat yapılandırması',
    'Invalid payment configuration' => 'Geçersiz ödeme yapılandırması',
    'Invoice address is required' => 'Fatura adresi gereklidir',
    'Invoice address not found' => 'Fatura adresi bulunamadı',
    'Not enough stock for product %ref' => '%ref ürünü için yeterli stok yok',
    'Payment module does not accept this cart' => 'Ödeme modülü bu sepeti kabul etmiyor',
    'Payment module is not available' => 'Ödeme modülü kullanılamıyor',
    'Payment module is required' => 'Ödeme modülü gereklidir',
    'Payment module not found' => 'Ödeme modülü bulunamadı',
    'Required address is missing' => 'Gerekli adres eksik',
    'The billing address is missing information an invoice requires' => 'Fatura adresinde, fatura düzenlemek için gereken bilgiler eksik',
    'This order cannot be placed yet.' => 'Bu sipariş henüz verilemez.',
    'This order is already being placed. Please wait a moment and try again.' => 'Bu sipariş zaten veriliyor. Lütfen biraz bekleyip tekrar deneyin.',
    'This order requires an account.' => 'Bu sipariş için bir hesap gereklidir.',
    'This shop is not asking for the consent "%consent".' => 'Bu mağaza "%consent" onayını istemiyor.',
    'You must accept "%consent" to place this order.' => 'Bu siparişi vermek için "%consent" onayını kabul etmelisiniz.',
];
