...
return array(
    ...
    'A name such as Europe or Overseas' => 'Böyle Avrupa veya Yurtdışı gibi bir isim',
    ...
    'A user already exists with this email address. Please login or if you\'ve forgotten your password, go to Reset Your Password.' => 'Bir kullanıcı bu e-posta adresi ile zaten. Lütfen giriş yapın veya parolanızı unuttuysanız, parolanızı sıfırlamak için gidin.',
    ...
    'Activate logs only for these files' => 'Bu dosyalar için yalnızca günlüklerini etkinleştirme',
    ...
    'Address ID not found' => 'Adres ID değil kurmak',
    ...
    'Administrator ID not found' => 'Yönetici ID değil kurmak',
    'Administrators' => 'Yönetici',
    'Advertise this product as new' => 'Bu ürün olarak yeni reklam',
    'Alerts' => 'Uyarılar',
    'All Products' => 'Tüm Ürünler',
    'All countries' => 'Bütün ülkeler',
    'All shipping methods' => 'Tüm nakliye yöntemleri',
    'An error happend while copying %prev to %dest' => '%dest için %prev kopyalanırken bir hata oluştu',
    'An error occurred while adding this file to the archive: %file' => 'Arşive bu dosya eklenirken bir hata oluştu: %file',
    'An unknown error append' => 'Bilinmeyen bir hata oluştu',
    ...
    'Bad index value %idx' => 'Kötü dizin değeri %idx',
    ...
    'Cannot find a default country. Please define one.' => 'Bu varsayılan ülke bulunamıyor. Lütfen birini tanımlayabilirsiniz.',
    ...
    'Delivery' => 'Teslimat',
    'Delivery choice' => 'Teslimat seçim',
    ...
    'Document' => 'DÖKÜMAN',
    'Don\'t repeat keywords over and over in a row. Rather, put in keyword phrases.' => 'Defalarca üst üste anahtar kelimeleri tekrar etme. Bunun yerine, anahtar kelime öbekleri koymak.',
    'EAN Code' => 'EAN kodu',
    'Edit' => 'Düzenle',
    ...
    'Error while creating the directory "%directory"' => '"%directory" dizini oluşturulurken hata oluştu',
    'Error while writing the file into the archive, error message: %errmes' => 'Arşiv, hata iletisi dosyaya yazma hatası: %errmes',
    'Errors' => 'Hatalar',
    'Errors occurred while importing the file: %errors' => 'Dosya alınırken hata oluştu: %errors',
    'Export' => 'Dışa aktarma',
    ...
    'Failed to deactivate hook with id %s' => 'Kanca ile kimliği %s devre dışı bırakmak başarısız oldu',
    'Failed to delete selected countries' => 'Seçilen ülkeler silme başarısız oldu',
    'Failed to find a payment Module with ID=%mid for order ID=%oid' => 'Bir ödeme modülü kimliği bulmak başarısız oldu % orta Sipariş No =%oid =',
    ...
    'File is too large, please retry with a file having a size less than %size%.' => 'Dosya çok büyük, lütfen %size% daha az bir boyutu olan bir dosyayla yeniden deneyin.',
    'File to upload' => 'Yüklemek için dosya',
    'Files with the following extension are not allowed: %extension, please do an archive of the file if you want to upload it' => 'Aşağıdaki uzantılı dosyalar verilir: %extension, bir arşiv dosyası yüklemek istiyorsanız, lütfen',
    'First Name' => 'Adı',
    'Firstname' => 'Adı',
    'Fixed Amount Discount' => 'Sabit tutar iskonto',
    'Fixed amount discount for selected attribute values' => 'Seçilen özniteliği değerleri için sabit tutar iskonto',
    ...
    'Free product when buying one or more selected products' => 'Bir satın alma ücretsiz ürün veya daha fazla seçili ürünler',
    ...
    'Hook title' => 'Kanca başlık',
    'Hooks' => 'Kanca',
    'Host' => 'Ana bilgisayar',
    'I would like to receive the newsletter or the latest news.' => 'Haber bülteninde veya en son haberleri almak istiyorum.',
    ...
    'Image' => 'Resim',
    'Import successfully done, %numb row(s) have been changed' => 'Muvaffakiyetli bitmiş, satırları değiştirilmiş %numb alma',
    'Impossible to delete a customer who already have orders' => 'Emir zaten verdin olan bir müşteri silmek imkansız',
    'In' => 'İçinde',
    'Include documents' => 'Belgeleri içer',
    ...
    'It is not allowed to delete the default currency' => 'Varsayılan para birimi silmek için izin verilmez',
    'It is not allowed to delete the default language' => 'Bu varsayılan dil silmek için izin verilmez',
    ...
    'Main area' => 'Ana alan',
    'Make sure it uses keywords found within the page itself.' => 'Kurmak belgili tanımlık sayfa içinde anahtar kelimeler kullanıldığından emin olun.',
    ...
    'Make this address as my primary address' => 'Benim birincil adresi olarak bu adresi yapmak',
    ...
    'Only if order billing country is %op% <strong>%countries_list%</strong>' => 'Le de facturation de la commande est %op% <strong>%countries_list%</strong> öder ',
    ...
    'Percentage discount for selected attribute values' => 'Seçilen özniteliği değerleri için yüzde indirim',
    ...
    'Prevent mailing template modification or deletion, except for super-admin' => 'Posta şablonu değiştirme ya da silmek, super-yönetici dışında önlemek',
    'Prevent variable modification or deletion, except for super-admin' => 'Değişken değiştirme ya da silmek, super-yönetici dışında önlemek',
    ...
    'Rate from &euro; *' => 'Düşük oranı &euro; *',
    ...
    'Replace current image by this file' => 'Bu dosyadaki  şu anki görüntüsünü değiştirin',
    'Reseller' => 'Bayi',
    ...
    'Select the brand logo amongst the brand images' => 'Marka görüntüler arasında marka logosu seçin',
    'Select the categories of the products covered by this operation' => 'Bu işlem tarafından kapsanan ürün kategorileri seçin',
    ...
    'Select the parent category of this category.' => 'Bu kategorinin ana kategori seçin.',
    'Select the product attributes included in this operation' => 'Bu işlem dahil ürün özellikleri seçin',
    ...
    'Store logs into text file' => 'Stok günlükleri içine metin eğe',
    'Store logs into text file, up to a certian size, then a new file is created' => 'O zaman yeni bir dosya oluşturulur stok günlükleri metin dosyası belirli bir boyuta kadar içine',
    ...
    'Tax' => 'Kdv',
    'Tax ID not found in tax list JSON' => 'Vergi kimlik numarası vergi listesinde JSON bulunamadı',
    'Tax list is not valid JSON' => 'Vergi listesi geçerli JSON değil',
    ...
    'The archive builder "%name" doesn\'t exist' => '"%name" Arşiv Oluşturucusu yok',
    'The brand name or title' => 'Marka adı veya başlık',
    'The cache directory "%env" is not writable' => '"%env" önbellek dizini yazılabilir değil',
    'The cache file %file is not readable' => 'Önbellek dosyası %file okunabilir değil',
    'The cart item count should match the condition' => 'Sepeti madde sayısı koşulla eşleşmesi',
    'The category title' => 'Kategori başlığı',
    'The changes could on the Zip Archive not be commited' => 'Değişiklikleri kabul edilen Zip Arşiv olamazdı',
    'The class "%class" doesn\'t exist' => '"%class" sınıfı yok',
    'The class "%class" must be a subclass of %baseClass' => '"%class" sınıfı %baseClass bir alt sınıfı olmalıdır',
    'The class "%class" must extend %baseClass' => '"%class" sınıfı %baseClass genişletmeniz gerekir',
    'The column %column that you want to sort doesn\'t exist' => 'Sıralamak istediğiniz sütun %column yok',
    ...
    'The content is not correct' => 'İçeriği doğru değil',
    ...
    'The directory %dir has not been created in the archive' => 'Dizin %dir arşivde oluşturulmadı',
    'The extension "%ext" is not allowed' => '"%ext" uzantısı izin verilmez',
    'The file %file has not been deleted' => 'Dosya %file silinmez',
    'The file %file is missing or is not readable' => 'Dosya %file eksik veya okunabilir değil',
    'The file %file is not readable' => 'Dosya %file okunabilir değil',
    'The file %path has been successfully downloaded' => 'Dosya %path başarıyla karşıdan yüklenmiş olan',
    'The file name must be valid' => 'Dosya adı geçerli olmalıdır',
    'The filename is not correct' => 'Dosya adı doğru değil',
    'The following columns are missing: %columns' => 'Aşağıdaki sütunları eksik: %columns',
    'The formatter "%name" doesn\'t exist' => 'Biçemleyici "%name" diye biri yok',
    ...
    'The loop "%loop" doesn\'t exist' => '"%loop" döngü yok',
    ...
    'The method "%class"::buildDataSet must return an array or a ModelCriteria' => '"%class" yöntemi:: buildDataSet gerekir dönmek bir dizi ya da bir ModelCriteria',
    'The method name that will handle the hook event.' => 'Kanca olay işleyecek yöntemi adı.',
    'The module "%name%" is currently in use by at least one order, and can\'t be deleted.' => '"%name%" modül şu anda en az bir siparişi tarafından kullanılıyor ve silinemez.',
    'The module %module has been installed successfully.' => 'Modül %module başarıyla yüklendi.',
    ...
    'The product sale element reference %id doesn\'t exist' => 'Ürün satış element başvurusu %id yok',
    ...
    'The sale name or descriptive title' => 'Satılık adı veya açıklayıcı bir başlık',
    'The sale name or title' => 'Satılık adı veya başlık',
    ...
    'There are no files to associate.' => 'Var hayır eğe ilişkilendirmek için.',
    ...
    'There\'s a problem, the extension "%ext" has been found, but has no formatters nor archive builder' => 'Bir sorun, "%ext" uzantısı bulundu, ama hiçbir biçimlendiricilere ne de Arşiv Oluşturucu',
    ...
    'This coupon adds a free product to the cart if one of the selected products is in the cart.' => 'Seçili ürün sepetinizde ise bu kupon bir ürün sepetine ekler.',
    ...
    'This is the subject of the e-mail, such as \'Your order is confirmed\'.' => '\'Sipariş doğruladı gibi\' e-postanın konusunu bu.',
    'This login already exists' => 'Bu oturum açma zaten var',
    ...
    'This template is in use in some of your products, and cannot be deleted. Delete it from all your products and try again.' => 'Bu şablon, ürünlerden bazıları kullanılıyor ve silinemez. Tüm ürünler silin ve yeniden deneyin.',
    'This the unique name of this message. Do not change this value unless you understand what you do.' => 'Bu bu iletiyi benzersiz adı. Ne anlamak sürece bu değeri değiştirmeyin.',
    ...
    'Unable to write the file %file into the archive' => 'Arşiv dosyası %file yazılamıyor',
    ...
    'Unknown error while deleting the file %file' => 'Dosya %file silinirken bilinmeyen hata oluştu',
    ...
    'You must define an environment when you use an archive builder' => 'Bir arşiv Oluşturucusu kullandığınızda bir ortam tanımlamanız gerekir',
    'You tried to load a bad formatted XML' => 'Kötü biçimlendirilmiş bir XML yüklemek için çalıştın',
    'You\'ve submitted this form too many times. ' => 'Bu formu çok kez gönderdiniz. ',
    'Your Email Address' => 'E-posta adresiniz',
    'Your Message' => 'Mesajınız',
    'Your archive must contain one of these file and doesn\'t: %files' => 'Senin Arşiv bu dosya birini içermelidir ve değil: %files',
    ...
    'Your zip must contain 1 root directory which is the root folder directory of your module' => 'Senin ZIP modülünüzün kök klasör dizini 1 kök dizini içermelidir',
    'Zip Error' => 'ZIP hata',
    'Zip code' => 'Posta Kodu',
    'Zone' => 'Bölge',
    '[%zip_head] ' => '[%zip_head] ',
    ...
    'after combinations' => 'sonra kombinasyonları',
    ...
    'at the bottom of the system area' => 'belgili tanımlık sistem alan alt kısmında',
    ...
    'at the top of the shipping area' => 'Sevkiyat alanı üst kısmında',
    'at the top of the sidebar' => 'kenar çubuğu üstündeki',
    'at the top of the system area' => 'belgili tanımlık sistem alan üst kısmında',
    ...
    'thousands separator' => 'Binler ayıracı',
