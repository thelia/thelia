...
return [
    ...
    'Product base price excluding taxes' => 'Prix de base HT',
    ...
    'Product price excluding taxes *' => 'Prix HT',
    'Product price including taxes' => 'Prix TTC',
    ...
    'Product sale element ID' => 'ID déclinaison',
    'Product sale element ID *' => 'ID déclinaison',
    ...
    'You can attach this product to more categories in the "Associations" tab.' => 'Vous pouvez associer ce produit à d\'autres catégories dans l\'onglet "Associations"',
