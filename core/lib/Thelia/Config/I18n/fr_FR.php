...
return [
    ...
    'Amount' => 'Montant',
    'An administrator with thie email address already exists' => 'Cet e-mail est déjà utilisé par un autre administrateur.',
    'An administrator with this email address already exists' => 'Un compte administrateur avec cette adresse e-mail existe déjà',
    ...
    'Banner' => 'Bannière',
    'Banner of the website. Used in the e-mails send to the customers.' => 'Bannière du site utilisée dans le contenu des e-mails envoyés aux clients.',
    ...
    'Change short title for' => 'Changer la civilité abrégée de',
    ...
    'Contact and sender email address' => "Adresse e-mail de contact, et d'envoi des e-mails de la boutique",
    'Contact page' => 'Page contact',
    'Content' => 'Contenu',
    'Content page' => 'Page de contenu',
    'Content title *' => 'Titre du contenu *',
    'Contents' => 'Contenus',
    'Copy of %tpl' => 'Copie de %tpl',
    ...
    'Coupon conditions cannot be verified.' => 'Les conditions du coupon ne peuvent pas être vérifiées.',
    'Critical' => 'Critique',
    ...
    'Enter here the order status code' => 'Indiquez ici le code de ce statut de commande',
    'Enter here the order status name in the default language (%title%)' => 'Indiquez le libellé de ce statut dans la langue par défaut (%title%) ',
    ...
    'Error occurred while cancelling order ref. %ref, ID %id: %err' => "Une erreur est survenue lors de l'annulation de la commande %ref, ID %id: %err",
    'Error occurred while saving payment transaction %transaction_ref for order ID %id.' => 'La transaction %transaction_ref n\'a pas pu être enregistrée pour la commande ID %id.',
    ...
    'Further submissions will be ignored during %time' => 'Les accès à ce formulaire seront bloqués pendant %time',
    ...
    'Lastname' => 'Nom',
    'Layout' => 'Mise en page',
    'Leave blank to keep current customer password' => 'Laissez ce champ vide pour ne pas changer le mot de passe',
    ...
    'Order status color' => 'Couleur associée à ce statut',
    'Order status name' => 'Libellé du statut de commande',
    'Orders' => 'Commandes',
    ...
    'Payment transaction %transaction_ref for order ref. %ref, ID %id has been successfully saved.' => 'La transaction %transaction_ref pour la commande ref. %ref ID %id a bien été enregistrée',
    ...
    'Send test e-mail to:' => 'Envoyer un e-mail de test à: ',
    ...
    'Sitemap' => 'Sitemap',
    'Some commands use this status.' => 'Il existe des commandes qui utilisent ce statut',
    'Something goes wrong, error is : %err' => "Quelque chose ne va pas, l'erreur est : %err",
    'Something goes wrong, the message was not sent to recipient. Error is : %err' => 'Quelque chose n\'a pas fonctionné, le message n\'a pas pu être envoyé. L\'erreur est : %err',
    ...
    'The mailing template in HTML format.' => 'Le template du e-mail au format HTML',
    'The mailing template in text-only format.' => 'Le template du e-mail au format texte',
    ...
    'The order status code' => 'Le code du statut de commande',
    'The order status name or title' => 'Le libellé ou le nom du statut de commande',
    'The parent template "%parent" of template "%name" could not be found' => 'Le template parent "%parent" du template "%name" n\'a pas été trouvé',
    ...
    'The template "%name" requires Thelia %version or newer' => 'Le template "%name" requiert Thelia %version au minimum',
    ...
    'This code is already used.' => 'Ce code est déjà utilisé par un autre statut.',
    ...
    'This is not a hexadecimal color.' => "Ce n'est pas une couleur hexadecimale valide.",
    'This is not a valid code.' => "Ce code n'est pas valide.",
    'This is the contact email address, and the sender email of all e-mails sent by your store.' => 'Il s\'agit de l\'adresse de contact, et de l\'adresse de l\'expéditeur des e-mails envoyés par la boutique',
    ...
    'This status is protected.' => 'Ce statut de commande est protégé',
    ...
    'You must sign in or register before using this coupon.' => "Vous devez vous connecter ou vous enregistrer avant d'utiliser ce coupon.",
    "You probably didn't inject the missing variable to preview the HTML. Error is : %err" => 'Vous n\'avez probablement pas injecté la variable manquante pour prévisualiser le code HTML. L\'erreur est : %err',
    'You should select a state for this country.' => 'Vous devez sélectionner un État pour ce pays.',
    "You're not currently connected to the administration panel. Please log in to access this page" => 'Vous n\'êtes pas connecté à l\'administration de la boutique. Merci de vous identifier pour accéder à cette page.',
    ...
    'Buy X, get Y offered' => 'X achetés, Y offerts',
    ...
    'mailing system modification' => 'Modification du système d\'envoi de e-mail.',
    'main area' => 'zone principale',
    'middle' => 'au milieu',
    'minute(s)' => 'minute(s)',
    ...
    'Offers a quantity of a product, entirely or with a discount, when the cart contains a given quantity of selected products.' => 'Offre une quantité d\'un produit, entièrement ou avec une remise, quand le panier contient une quantité donnée de produits sélectionnés.',
    'Only if the order is shipped with %op% <strong>%modules_list%</strong>' => 'Seulement si la commande est livrée avec %op% <strong>%modules_list%</strong>',
    'Please select at least one triggering product or category' => 'Merci de choisir au moins un produit ou une catégorie déclencheur',
    'Please select the discount type of the offer' => 'Merci de choisir le type de remise de l\'offre',
    'Please select what triggers the offer: a product, a category or a selection' => 'Merci de choisir ce qui déclenche l\'offre : un produit, une catégorie ou une sélection',
    'Please select which products are offered' => 'Merci de choisir quels produits sont offerts',
    'The coupon applies to the selected delivery methods' => 'La promotion s\'applique pour les modes de livraison sélectionnés',
    'The coupon fields are missing or invalid' => 'Les champs de la promotion sont manquants ou invalides',
    'The discount amount must be positive' => 'Le montant de la remise doit être positif',
    'The discount percentage must be between 0 and 100' => 'Le pourcentage de remise doit être compris entre 0 et 100',
    'The offered quantity must be at least 1' => 'La quantité offerte doit être au moins 1',
    'The offered quantity must be lower than the triggering quantity when the offer is taken from the triggering products' => 'La quantité offerte doit être inférieure à la quantité déclenchante quand l\'offre est prise parmi les produits déclencheurs',
    'The triggering quantity must be at least 1' => 'La quantité déclenchante doit être au moins 1',
    'You must choose a delivery method before using this coupon.' => 'Vous devez choisir un mode de livraison avant d\'utiliser ce coupon.',
    'Cart is empty or contains no items' => 'Le panier est vide ou ne contient aucun article',
    'Delivery address has no country' => 'L\'adresse de livraison n\'a pas de pays',
    'Delivery address is required' => 'Une adresse de livraison est requise',
    'Delivery address not found' => 'Adresse de livraison introuvable',
    'Delivery module does not accept this cart' => 'Le module de livraison n\'accepte pas ce panier',
    'Delivery module does not deliver to this address' => 'Le module de livraison ne livre pas à cette adresse',
    'Delivery module is not available' => 'Le module de livraison n\'est pas disponible',
    'Delivery module is required' => 'Un module de livraison est requis',
    'Delivery module not found' => 'Module de livraison introuvable',
    'Invalid delivery configuration' => 'Configuration de livraison invalide',
    'Invalid payment configuration' => 'Configuration de paiement invalide',
    'Invoice address is required' => 'Une adresse de facturation est requise',
    'Invoice address not found' => 'Adresse de facturation introuvable',
    'Not enough stock for product %ref' => 'Stock insuffisant pour le produit %ref',
    'Payment module does not accept this cart' => 'Le module de paiement n\'accepte pas ce panier',
    'Payment module is not available' => 'Le module de paiement n\'est pas disponible',
    'Payment module is required' => 'Un module de paiement est requis',
    'Payment module not found' => 'Module de paiement introuvable',
    'Required address is missing' => 'Une adresse requise est manquante',
