...
return array(
    ...
    ' note: only non-visible documents can be associated.' => 'remarque : seuls les documents non visibles peuvent être associés.',
    ...
    'A short description, used when a summary or an introduction is required' => 'Un texte court, utilisé quand un résumé ou une introduction est nécessaire.',
    ...
    'An error happend while copying %prev to %dest' => 'Une erreur s\'est produite pendant la copie du %prev vers %dest',
    ...
    'Bad tax list JSON' => 'Le fichier JSON de la liste des taxes est incorrect',
    ...
    'Cart total amount is' => 'Le montant total du panier est',
    'Catalog' => 'Catalogue',
    ...
    'Contact and sender email address' => 'Adresse email de contact, et d\'envoi des mails de la boutique',
    'Contact page' => 'Page contact',
    'Content' => 'Contenu',
    'Content page' => 'Page de contenu',
    'Content title *' => 'Titre du contenu *',
    'Contents' => 'Contenus',
    'Core hook of Thelia.' => 'Hook Thelia officiel',
    'Countries' => 'Pays',
    'Country' => 'Pays',
    ...
    'Coupon code %code is disabled.' => 'Le coupon code %code est désactivé.',
    'Critical' => 'Critique',
    ...
    'Default product sale element' => 'Produit par défaut',
    ...
    'Error while writing the file into the archive, error message: %errmes' => 'Erreur lors de l\'écriture du fichier dans l\'archive, message d\'erreur: %errmes',
    'Errors' => 'Erreurs',
    ...
    'Failed to deactivate hook with id %s' => 'Impossible de désactiver le hook avec l\'id : %s',
    ...
    'If checked, this hook will be used by a hook block. If not, by hook function.' => 'Indique que ce hook utilise un bloc smarty hookBlock. sinon une fonction smarty hook.',
    'Image' => 'Image',
    'Import successfully done, %numb row(s) have been changed' => 'L\'import s\'est correctement déroulé, %numb ligne(s) ont été modifiées',
    'Impossible to delete a customer who already have orders' => 'Impossible de supprimer un client si celui-ci a déjà passé une commande',
    'In' => 'Compris dans',
    ...
    'Is it the default product sale element ?' => 'Est-ce le produit par défaut ?',
    ...
    'Loop must implements \'PropelSearchLoopInterface\' to be versionable' => 'Les classes \'boucle\' doivent implémenter \'PropelSearchLoopInterface\' pour être versionnables',
    ...
    'Only hookable modules are displayed in this menu.' => 'Seul les modules qu\'il est possible de placer dans un hook sont affichés',
    ...
    'Product ID *' => 'ID produit *',
    'Product attributes' => 'Déclinaisons',
    ...
    'Product sale element ID *' => 'ID du produit *',
    ...
    'Store Business Identification Number (SIRET, etc).' => 'Numéro d\'enregistrement de votre société (SIRET, par exemple)',
    ...
    'The content is not correct' => 'Le contenu n\'est pas correct.',
    ...
    'The extension "%ext" is not allowed' => 'L\'extension "%ext" n\'est pas autorisé',
    ...
    'The formatter "%name" doesn\'t exist' => 'Le formateur "%name" n\'existe pas',
    ...
    'The product sale element id %id doesn\'t exist' => 'La déclinaison id %id n\'existe pas',
    'The product sale element reference %id doesn\'t exist' => 'La déclinaison référence %id n\'existe pas',
    ...
    'There\'s a problem, the extension "%ext" has been found, but has no formatters nor archive builder' => 'Une erreur est survenue, l\'extension "%ext" a été reconnue, mais il n\'existe pas de formateur ni de format d\'archive correspondant',
    ...
    'This condition is always true' => 'Cette condition est toujours vérifiée',
    ...
    'This is the message purpose, such as \'Order confirmation\'.' => 'Il s\'agit du rôle de ce message, comme "Confirmation de commande".',
    'This is the subject of the e-mail, such as \'Your order is confirmed\'.' => 'Le sujet de l\'e-mail, par exemple "Confirmation de votre commande".',
    ...
    'This the unique name of this message. Do not change this value unless you understand what you do.' => 'Il s\'agit du nom unique du message. Ne modifiez pas ce champ, à moins de savoir exactement ce que vous faites.',
    ...
    'You have to configure your store email first !' => 'Vous devez d\'abord configurer l\'email de votre boutique !',
    'You must define an environment when you use an archive builder' => 'Vous devez définir un environnement quand vous utilisez avec constructeur d\'archive',
    'You tried to load a bad formatted XML' => 'Vous avez essayé de charger un XML mal formaté',
    ...
    'Your configuration seems to be ok. Checked out your mailbox : %email%' => 'Votre configuration semble correct. Vérifiez vos emails : %email%',
    ...
    'mailing system modification' => 'modification du système de mailing',
    'main area' => 'zone principale',
    'middle' => 'au milieu',
    'minute(s)' => 'minute(s)',
    'password confirmation is not the same as password field' => 'la confirmation du mot de passe ne correspond pas',
    'password must be composed of at least 4 characters' => 'Le mot de passe doit être composé d\'au moins 4 caractères',
    'payment module %s is not a Thelia\Module\PaymentModuleInterface' => 'Le module de livraison %s n\'est pas du type Thelia\Module\DeliveryModuleInterface',
    'pdf' => 'pdf',
    ...
    'quantity value is not valid' => 'La quantité n\'est pas valide',
