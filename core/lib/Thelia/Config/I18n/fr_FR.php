...
return array(
    ...
    'Failed to send confirmation email for order %order_ref to customer %cust_email, ref. %cust_ref' => 'Echec de l\'envoi du mail de confirmation de la commande %order_ref au client %cust_email, ref. %cust_ref',
    'Failed to send notification email to shop manager %email for order %order_ref ' => 'Echec de l\'envoi du mail de notification de la commande %order_ref au gestionnaire %email',
