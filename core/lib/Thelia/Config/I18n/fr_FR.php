...
return array(
    ...
    ' note: only non-visible documents can be associated.' => 'remarque : seul les documents non visibles peuvent être associés.',
    ...
    '%s have dependencies to module %s. You have to deactivate these modules before.' => '%s a des dépendances aux modules %s. Vous devez d\'abord désactiver ces module.',
    ...
    'Additional address information' => 'Complement d\'adresse',
    ...
    'Email addresses of notification recipients' => 'Adresses emails des destinataires des notifications',
    'Email test from : %store%' => 'Email de test de : %store%',
    'Emergency' => 'Urgence',
    ...
    'Enter here the mail template purpose in the default language (%title%)' => 'Indiquez la fonction de ce message dans la langue par defaut (%title%)',
    ...
    'Mail template purpose' => 'Fontion de ce message',
    ...
    'Missing \'rel\' parameter in ifhook/elsehook arguments' => 'L\'attribut \'rel\' est manquant pour le ifhook/elsehook',
    ...
    'Missing \'type\' parameter in {hasflash} function arguments' => 'Paramètre \'type\' manquant dans la fonction {hasflash}',
    'Missing or invalid data: %s' => 'Donnée manquante ou non valide : %s',
    'Module' => 'Module',
    'Module ID not found' => 'Id du module non trouvé',
    'Module directory doesn\'t exist.' => 'Le dossier du module n\'existe pas.',
    'Module hook' => 'Module hook',
    'Module should have a config.xml in the Config directory.' => 'Le module doit avoir un fichier config.xml dans le dossier Config.',
    'Module should have a module.xml in the Config directory.' => 'Le module doit avoir un fichier module.xml dans le dossier Config.',
    'Modules' => 'Modules',
    'Name' => 'Nom',
    'Name *' => 'Nom *',
    ...
    'Sitemap' => 'Sitemap',
    'Sorry, an error occured.' => 'Désolé, une erreur a été généré.',
    'Sorry, an error occured: %msg' => 'Désolé, une erreur est survenue : %msg',
    'Sorry, an error occured: %s' => 'Désolé, une erreur a été généré : %s',
    ...
    'The module definition has not been initialized.' => 'La définition du module n\'a pas été initialisé.',
    'The module descriptor has not been initialized.' => 'Le descripteur du module n\'a pas été initialisé.',
    'The module has to be activated.' => 'Le module doit être activé.',
    'The module is already installed in the same or greater version.' => 'Le module est déjà installé dans une version égale ou supérieure.',
    'The module is not valid : %message' => 'Le module n\'est pas valide : %message',
    'The module requires a version of Thelia <= %version' => 'Le module requiert Thelia en version <= %version',
    'The module requires a version of Thelia >= %version' => 'Le module requiert Thelia en version >= %version',
    'The module requires this activated modules : %modules' => 'Le module requiert les modules activés suivant : %modules',
    ...
    'The resource %res has not been found' => 'La ressoure %res n\'a pas été trouvé',
    ...
    'This is a comma separated list of email addresses where store notifications (such as order placed) are sent.' => 'Indiquez la liste des adresses emails, séparées par des virgules, auxquelles seront envoyées les notification de la boutique, comme les nouvelles commandes.',
