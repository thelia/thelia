...
return [
    ...
    'Zone' => '区域',
    'Cart is empty or contains no items' => '购物车为空或不包含任何商品',
    'Delivery address has no country' => '配送地址未填写国家',
    'Delivery address is required' => '请填写配送地址',
    'Delivery address not found' => '未找到配送地址',
    'Delivery module does not accept this cart' => '配送模块不接受此购物车',
    'Delivery module does not deliver to this address' => '配送模块不配送到该地址',
    'Delivery module is not available' => '配送模块不可用',
    'Delivery module is required' => '请选择配送模块',
    'Delivery module not found' => '未找到配送模块',
    'Invalid delivery configuration' => '配送配置无效',
    'Invalid payment configuration' => '支付配置无效',
    'Invoice address is required' => '请填写发票地址',
    'Invoice address not found' => '未找到发票地址',
    'Not enough stock for product %ref' => '产品 %ref 库存不足',
    'Payment module does not accept this cart' => '支付模块不接受此购物车',
    'Payment module is not available' => '支付模块不可用',
    'Payment module is required' => '请选择支付模块',
    'Payment module not found' => '未找到支付模块',
    'Required address is missing' => '缺少必填地址',
    'The billing address is missing information an invoice requires' => '账单地址缺少开具发票所需的信息',
    'This order cannot be placed yet.' => '此订单暂时无法提交。',
    'This order is already being placed. Please wait a moment and try again.' => '此订单正在提交中。请稍候片刻后重试。',
    'This order requires an account.' => '此订单需要账户。',
    'This shop is not asking for the consent "%consent".' => '本店未要求"%consent"同意。',
    'You must accept "%consent" to place this order.' => '您必须接受"%consent"才能提交此订单。',
];
