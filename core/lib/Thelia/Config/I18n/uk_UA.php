...
return [
    ...
    'Cart is empty or contains no items' => 'Корзина порожня або не містить товарів',
    'Delivery address has no country' => 'В адресі доставки не вказано країну',
    'Delivery address is required' => 'Необхідно вказати адресу доставки',
    'Delivery address not found' => 'Адресу доставки не знайдено',
    'Delivery module does not accept this cart' => 'Модуль доставки не приймає цю корзину',
    'Delivery module does not deliver to this address' => 'Модуль доставки не здійснює доставку за цією адресою',
    'Delivery module is not available' => 'Модуль доставки недоступний',
    'Delivery module is required' => 'Необхідно вибрати модуль доставки',
    'Delivery module not found' => 'Модуль доставки не знайдено',
    'Invalid delivery configuration' => 'Неправильні налаштування доставки',
    'Invalid payment configuration' => 'Неправильні налаштування оплати',
    'Invoice address is required' => 'Необхідно вказати адресу для виставлення рахунку',
    'Invoice address not found' => 'Адресу для виставлення рахунку не знайдено',
    'Not enough stock for product %ref' => 'Недостатньо товару %ref на складі',
    'Payment module does not accept this cart' => 'Модуль оплати не приймає цю корзину',
    'Payment module is not available' => 'Модуль оплати недоступний',
    'Payment module is required' => 'Необхідно вибрати модуль оплати',
    'Payment module not found' => 'Модуль оплати не знайдено',
    'Required address is missing' => 'Відсутня обов’язкова адреса',
    'The billing address is missing information an invoice requires' => 'В адресі для виставлення рахунку бракує даних, потрібних для оформлення рахунку',
    'This order cannot be placed yet.' => 'Це замовлення поки що неможливо оформити.',
    'This order is already being placed. Please wait a moment and try again.' => 'Це замовлення вже оформлюється. Будь ласка, зачекайте хвилинку і спробуйте ще раз.',
    'This order requires an account.' => 'Для цього замовлення потрібен обліковий запис.',
    'This shop is not asking for the consent "%consent".' => 'Цей магазин не запитує згоду "%consent".',
    'You must accept "%consent" to place this order.' => 'Щоб оформити це замовлення, необхідно прийняти "%consent".',
];
