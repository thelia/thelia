...
return array(
    ...
    'Failed to send confirmation email for order %order_ref to customer %cust_email, ref. %cust_ref' => 'Failed to send confirmation email for order %order_ref to customer %cust_email, ref. %cust_ref',
    'Failed to send notification email to shop manager %email for order %order_ref ' => 'Failed to send notification email to shop manager %email for order %order_ref ',
