...
return [
    ...
    'A SIRET number must contain exactly 14 digits.' => 'A SIRET number must contain exactly 14 digits.',
    ...
    'A VAT number is required as soon as a company name is given.' => 'A VAT number is required as soon as a company name is given.',
    'A VAT number may not exceed 20 characters.' => 'A VAT number may not exceed 20 characters.',
    'A VAT number must start with a two letter country code followed by 2 to 13 alphanumeric characters.' => 'A VAT number must start with a two letter country code followed by 2 to 13 alphanumeric characters.',
    ...
    'The checksum of this SIRET number is invalid, please check the number you typed.' => 'The checksum of this SIRET number is invalid, please check the number you typed.',
    'The checksum of this VAT number is invalid, please check the number you typed.' => 'The checksum of this VAT number is invalid, please check the number you typed.',
    ...
    'The SIREN of this VAT number does not match the first 9 digits of the SIRET number.' => 'The SIREN of this VAT number does not match the first 9 digits of the SIRET number.',
    ...
    'Buy X, get Y offered' => 'Buy X, get Y offered',
    ...
    'middle' => 'middle',
    'minute(s)' => 'minute(s)',
    'Offers a quantity of a product, entirely or with a discount, when the cart contains a given quantity of selected products.' => 'Offers a quantity of a product, entirely or with a discount, when the cart contains a given quantity of selected products.',
    'Only if the order is shipped with %op% <strong>%modules_list%</strong>' => 'Only if the order is shipped with %op% <strong>%modules_list%</strong>',
    ...
    'Please select at least one triggering product or category' => 'Please select at least one triggering product or category',
    'Please select the discount type of the offer' => 'Please select the discount type of the offer',
    'Please select what triggers the offer: a product, a category or a selection' => 'Please select what triggers the offer: a product, a category or a selection',
    'Please select which products are offered' => 'Please select which products are offered',
    ...
    'The coupon applies to the selected delivery methods' => 'The coupon applies to the selected delivery methods',
    'The coupon fields are missing or invalid' => 'The coupon fields are missing or invalid',
    'The discount amount must be positive' => 'The discount amount must be positive',
    'The discount percentage must be between 0 and 100' => 'The discount percentage must be between 0 and 100',
    'The offered quantity must be at least 1' => 'The offered quantity must be at least 1',
    'The offered quantity must be lower than the triggering quantity when the offer is taken from the triggering products' => 'The offered quantity must be lower than the triggering quantity when the offer is taken from the triggering products',
    'The triggering quantity must be at least 1' => 'The triggering quantity must be at least 1',
    ...
    'You must choose a delivery method before using this coupon.' => 'You must choose a delivery method before using this coupon.',
    'Cart is empty or contains no items' => 'Cart is empty or contains no items',
    'Delivery address has no country' => 'Delivery address has no country',
    'Delivery address is required' => 'Delivery address is required',
    'Delivery address not found' => 'Delivery address not found',
    'Delivery module does not accept this cart' => 'Delivery module does not accept this cart',
    'Delivery module does not deliver to this address' => 'Delivery module does not deliver to this address',
    'Delivery module is not available' => 'Delivery module is not available',
    'Delivery module is required' => 'Delivery module is required',
    'Delivery module not found' => 'Delivery module not found',
    'Invalid delivery configuration' => 'Invalid delivery configuration',
    'Invalid payment configuration' => 'Invalid payment configuration',
    'Invoice address is required' => 'Invoice address is required',
    'Invoice address not found' => 'Invoice address not found',
    'Not enough stock for product %ref' => 'Not enough stock for product %ref',
    'Payment module does not accept this cart' => 'Payment module does not accept this cart',
    'Payment module is not available' => 'Payment module is not available',
    'Payment module is required' => 'Payment module is required',
    'Payment module not found' => 'Payment module not found',
    'Required address is missing' => 'Required address is missing',
    'The billing address is missing information an invoice requires' => 'The billing address is missing information an invoice requires',
    'This order cannot be placed yet.' => 'This order cannot be placed yet.',
    'This order is already being placed. Please wait a moment and try again.' => 'This order is already being placed. Please wait a moment and try again.',
