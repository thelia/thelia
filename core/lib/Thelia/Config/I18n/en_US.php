...
return array(
    ...
    'Failed to deactivate hook %s' => 'Failed to deactivate hook %s',
    ...
    'The method "%method" has not been found in "%classname"' => 'The method "%method" has not been found in "%classname"',
