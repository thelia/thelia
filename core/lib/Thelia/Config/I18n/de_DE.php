...
return [
    ...
    'Message' => 'Nachricht',
    'Message content: %message%' => 'Inhalt der Nachricht: %message%',
    ...
    'Cart is empty or contains no items' => 'Der Warenkorb ist leer oder enthält keine Artikel',
    'Delivery address has no country' => 'Die Lieferadresse enthält kein Land',
    'Delivery address is required' => 'Eine Lieferadresse ist erforderlich',
    'Delivery address not found' => 'Die Lieferadresse wurde nicht gefunden',
    'Delivery module does not accept this cart' => 'Das Liefermodul akzeptiert diesen Warenkorb nicht',
    'Delivery module does not deliver to this address' => 'Das Liefermodul liefert nicht an diese Adresse',
    'Delivery module is not available' => 'Das Liefermodul ist nicht verfügbar',
    'Delivery module is required' => 'Ein Liefermodul ist erforderlich',
    'Delivery module not found' => 'Das Liefermodul wurde nicht gefunden',
    'Invalid delivery configuration' => 'Ungültige Lieferkonfiguration',
    'Invalid payment configuration' => 'Ungültige Zahlungskonfiguration',
    'Invoice address is required' => 'Eine Rechnungsadresse ist erforderlich',
    'Invoice address not found' => 'Die Rechnungsadresse wurde nicht gefunden',
    'Not enough stock for product %ref' => 'Nicht genügend Lagerbestand für das Produkt %ref',
    'Payment module does not accept this cart' => 'Das Zahlungsmodul akzeptiert diesen Warenkorb nicht',
    'Payment module is not available' => 'Das Zahlungsmodul ist nicht verfügbar',
    'Payment module is required' => 'Ein Zahlungsmodul ist erforderlich',
    'Payment module not found' => 'Das Zahlungsmodul wurde nicht gefunden',
    'Required address is missing' => 'Eine erforderliche Adresse fehlt',
    'The billing address is missing information an invoice requires' => 'Der Rechnungsadresse fehlen Angaben, die für eine Rechnung erforderlich sind',
    'This order cannot be placed yet.' => 'Diese Bestellung kann noch nicht aufgegeben werden.',
    'This order is already being placed. Please wait a moment and try again.' => 'Diese Bestellung wird bereits aufgegeben. Bitte warten Sie einen Moment und versuchen Sie es erneut.',
