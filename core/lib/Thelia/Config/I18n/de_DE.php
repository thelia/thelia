...
return array(
    ...
    ' note: only non-visible documents can be associated.' => 'Nur nicht-sichtbaren Dokumente können assoziieren werden.',
    '"%param" parameter cannot be empty in loop type: %type, name: %name' => '"%param" Parameter kann im Schleifentyp nicht leer sein: %type, Name: %name',
    ...
    '%s have dependencies to module %s. You have to deactivate these modules before.' => '%s sind abhängig von Modul %s. Sie müssen diesen Modulen zuerst deaktivieren. ',
    '%type% position updated' => '%type% Position aktualisiert',
    '%type% visibility updated' => '%type% Sichtbarkeit aktualisiert',
    'A comma separated list of email addresses' => 'E-Mail-Adressen Liste durch Komma getrennt ',
    ...
    'A message with name "%name" already exists.' => 'Ein Nachricht mit der Name "%name" existiert bereits.',
    ...
    'A user already exists with this email address. Please login or if you\'ve forgotten your password, go to Reset Your Password.' => 'Ein Benutzer existiert bereits mit dieser E-Mail-Adresse. Bitte einloggen oder wenn Sie Ihr Passwort vergessen haben clicken Sie auf Passwort zurücksetzen',
    'A value for attribute "%name" is already present in the combination' => 'Eine Angabe für die Deklination "%name" ist bereits in der Kombination',
    'A variable with name "%name" already exists.' => 'Eine Angabe mit der Name "%name" existiert bereits',
    'Activate logs only for these IP Addresses' => 'Logs nur für diese IP Adressen aktivieren',
    'Activate logs only for these files' => 'Logs nur für diese Dateien aktivieren',
    'Activate this sale' => 'Dieses Sonderangebot aktivieren',
    'Active' => 'Aktiv',
    'Add to all product templates' => 'Zu allen Produkt Vorlagen anwenden',
    'Additional address' => 'Zusätzliche Adresse',
    'Additional address information' => 'Erweitere Adresse Informationen',
    'Address ID not found' => 'Die Adresse ID wurde nicht gefunden',
    'Address Line 2' => 'Adresse Linie 2',
    'Address Line 3' => 'Adresse Linie 3',
    'Address creation' => 'Adresse Erstellung',
    'Address label' => 'Adresse-Etikett',
    'Address update' => 'Adresse Aktualisierung',
    'Address.' => 'Adresse',
    'Administrator' => 'Administrator',
    'Administrator ID not found' => 'Administrator ID wurde nicht gefunden',
    'Administrators' => 'Administratoren',
    'Advertise this product as new' => 'Dieses Produkt als neu werben',
    'Alerts' => 'Warnungen',
    'All Products' => 'Alle Produkte',
    'All countries' => 'Alle Länder',
    'All shipping methods' => 'Alle Liefermethode',
    'An error happend while copying %prev to %dest' => 'Ein Fehler ist aufgetreten beim Kopieren %prev zu %dest',
    'An error occurred while adding this file to the archive: %file' => 'Ein Fehler ist aufgetreten beim Hinzufügen zu dem Archiv : %file',
    'An unknown error append' => 'Ein unerwarteter Fehler ist aufgetreten',
    'Apply exchange rates on price in %sym' => 'Wechselkurse auf Preise in %sym anwenden',
    'Archive Format' => 'Archiv Format',
    'Associate documents' => 'Zugehörigen Dokumente',
    'Associate images' => 'Zugehörigen Bilder',
    ...
    'Cannot find a default country. Please define one.' => 'Kein standart Land wurde gefunden. Bitte definieren Sie ein. ',
    'Cannot find the shop country. Please select a shop country.' => 'Das Shop-Land wurde nicht gefunden. Bitte wählen Sie ein aus. ',
    ...
    'Cart contains categories condition' => 'Warenkorb enthält Kategorien Bedingungen',
    'Cart contains specific products' => 'Der Warenkorb enthält spezifischen Produkte',
    ...
    'City' => 'Stadt',
    'Combination builder' => 'Kombination Generator',
    'Compagny' => 'Firma',
    'Company' => 'Firma',
    'Company Name' => 'Firma',
    ...
    'Error while creating the directory "%directory"' => 'Fehler beim Erstellung dem Ordner "%directory"',
    'Error while writing the file into the archive, error message: %errmes' => 'Fehler beim Schreiben der Datei in dem Archiv, Fehler : %errmes',
    'Errors' => 'Ferhler',
    'Errors occurred while importing the file: %errors' => 'Fehler beim Importieren der Datei : %errors',
    'Export' => 'Export',
    ...
    'Image' => 'Bild',
    'Import successfully done, %numb row(s) have been changed' => 'Import erfolgreich durchgeführt, %numb Zeile(n) wurde(n) geändert',
    ...
    'Product attributes' => 'Produkt-Deklination',
    ...
    'Service ID' => '',
    'Shipping configuration' => 'Liefer-Konfiuration',
    ...
    'The archive builder "%name" doesn\'t exist' => 'Das Archivformat "%name" existiert nicht',
    'The brand name or title' => 'Markenname oder Titel',
    'The cache directory "%env" is not writable' => 'Der Cache-Ordner "%env" ist nicht beschreibbar',
    'The cache file %file is not readable' => 'Die Cachedatei %file ist nicht lesbar',
    ...
    'The changes could on the Zip Archive not be commited' => 'Die Zip-Archiv-Änderungen konnten nicht gespeichert werden',
    'The class "%class" doesn\'t exist' => '',
    'The class "%class" must be a subclass of %baseClass' => '',
    'The class "%class" must extend %baseClass' => '',
    'The column %column that you want to sort doesn\'t exist' => 'Die Spalte %column die Sie sortieren möchten existiert nicht. ',
    'The container should not be null in this form. Please use the FormFactory to get an instance.' => '',
    'The content is not correct' => 'Das Inhalt ist nicht korrekt',
    ...
    'The directory %dir has not been created in the archive' => 'Der Ordner %dir wurde in dem Archiv nicht erstellt',
    'The extension "%ext" is not allowed' => 'Die Erweiterung "%ext" ist nicht erlaubt',
    'The file %file has not been deleted' => 'Die Datei %file wurde nicht gelöscht',
    'The file %file is missing or is not readable' => 'Die Datei %file fehlt oder ist nicht lesbar',
    'The file %file is not readable' => 'Die Datei %file ist nicht lesbar',
    'The file %path has been successfully downloaded' => 'Die Datei %path wurde heruntergeladen',
    'The file name must be valid' => 'Die Dateiname muss gültig sein',
    'The filename is not correct' => 'Die Dateiname ist nicht korrekt',
    'The following columns are missing: %columns' => 'Die folgenden Spalten fehlen: %columns',
    'The formatter "%name" doesn\'t exist' => 'format',
    ...
    'The product sale element reference %id doesn\'t exist' => 'Die product sale element Referenz %id existiert nicht',
    ...
    'There\'s a problem, the extension "%ext" has been found, but has no formatters nor archive builder' => 'Es gibt ein Problem, die Erweiterung "%ext" wurde gefunden, aber hat keinen Formatierer order Datenkompressionsprogramm',
    ...
    'This login already exists' => 'Dieses Login existiert bereits',
    ...
    'Unable to write the file %file into the archive' => 'Unmöglich die Datei %file in dem Archiv zu schreiben',
    ...
    'Unknown error while deleting the file %file' => 'Unbekannter Fehler beim Löschen der Datei %file',
    ...
    'You must define an environment when you use an archive builder' => 'Sie müssen eine Umgebung definieren, wenn Sie ein Archiv-Builder verwenden',
    'You tried to load a bad formatted XML' => 'Sie haben versucht, eine schlechte formatierte XML zu laden',
    'You\'ve submitted this form too many times. ' => 'Sie haben dieses Formular zu oft vorgelegt.',
    'Your Email Address' => 'Ihre E-mail Adresse',
    'Your Message' => 'Ihre Nachricht',
    'Your archive must contain one of these file and doesn\'t: %files' => 'Ihr Archiv soll eine von diesen Datei erhalten : %files',
