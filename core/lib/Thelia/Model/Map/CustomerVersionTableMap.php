...
class CustomerVersionTableMap extends TableMap
{
     ...
     */
    const BIRTHDAY = 'customer_version.BIRTHDAY';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Id', 'Ref', 'TitleId', 'Firstname', 'Lastname', 'Email', 'Password', 'Algo', 'Birthday', 'Reseller', 'Lang', 'Sponsor', 'Discount', 'RememberMeToken', 'RememberMeSerial', 'CreatedAt', 'UpdatedAt', 'Version', 'VersionCreatedAt', 'VersionCreatedBy', 'OrderIds', 'OrderVersions', ),
        self::TYPE_STUDLYPHPNAME => array('id', 'ref', 'titleId', 'firstname', 'lastname', 'email', 'password', 'algo', 'birthday', 'reseller', 'lang', 'sponsor', 'discount', 'rememberMeToken', 'rememberMeSerial', 'createdAt', 'updatedAt', 'version', 'versionCreatedAt', 'versionCreatedBy', 'orderIds', 'orderVersions', ),
        self::TYPE_COLNAME       => array(CustomerVersionTableMap::ID, CustomerVersionTableMap::REF, CustomerVersionTableMap::TITLE_ID, CustomerVersionTableMap::FIRSTNAME, CustomerVersionTableMap::LASTNAME, CustomerVersionTableMap::EMAIL, CustomerVersionTableMap::PASSWORD, CustomerVersionTableMap::ALGO, CustomerVersionTableMap::BIRTHDAY, CustomerVersionTableMap::RESELLER, CustomerVersionTableMap::LANG, CustomerVersionTableMap::SPONSOR, CustomerVersionTableMap::DISCOUNT, CustomerVersionTableMap::REMEMBER_ME_TOKEN, CustomerVersionTableMap::REMEMBER_ME_SERIAL, CustomerVersionTableMap::CREATED_AT, CustomerVersionTableMap::UPDATED_AT, CustomerVersionTableMap::VERSION, CustomerVersionTableMap::VERSION_CREATED_AT, CustomerVersionTableMap::VERSION_CREATED_BY, CustomerVersionTableMap::ORDER_IDS, CustomerVersionTableMap::ORDER_VERSIONS, ),
        self::TYPE_RAW_COLNAME   => array('ID', 'REF', 'TITLE_ID', 'FIRSTNAME', 'LASTNAME', 'EMAIL', 'PASSWORD', 'ALGO', 'BIRTHDAY', 'RESELLER', 'LANG', 'SPONSOR', 'DISCOUNT', 'REMEMBER_ME_TOKEN', 'REMEMBER_ME_SERIAL', 'CREATED_AT', 'UPDATED_AT', 'VERSION', 'VERSION_CREATED_AT', 'VERSION_CREATED_BY', 'ORDER_IDS', 'ORDER_VERSIONS', ),
        self::TYPE_FIELDNAME     => array('id', 'ref', 'title_id', 'firstname', 'lastname', 'email', 'password', 'algo', 'birthday', 'reseller', 'lang', 'sponsor', 'discount', 'remember_me_token', 'remember_me_serial', 'created_at', 'updated_at', 'version', 'version_created_at', 'version_created_by', 'order_ids', 'order_versions', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Id' => 0, 'Ref' => 1, 'TitleId' => 2, 'Firstname' => 3, 'Lastname' => 4, 'Email' => 5, 'Password' => 6, 'Algo' => 7, 'Birthday' => 8, 'Reseller' => 9, 'Lang' => 10, 'Sponsor' => 11, 'Discount' => 12, 'RememberMeToken' => 13, 'RememberMeSerial' => 14, 'CreatedAt' => 15, 'UpdatedAt' => 16, 'Version' => 17, 'VersionCreatedAt' => 18, 'VersionCreatedBy' => 19, 'OrderIds' => 20, 'OrderVersions' => 21, ),
        self::TYPE_STUDLYPHPNAME => array('id' => 0, 'ref' => 1, 'titleId' => 2, 'firstname' => 3, 'lastname' => 4, 'email' => 5, 'password' => 6, 'algo' => 7, 'birthday' => 8, 'reseller' => 9, 'lang' => 10, 'sponsor' => 11, 'discount' => 12, 'rememberMeToken' => 13, 'rememberMeSerial' => 14, 'createdAt' => 15, 'updatedAt' => 16, 'version' => 17, 'versionCreatedAt' => 18, 'versionCreatedBy' => 19, 'orderIds' => 20, 'orderVersions' => 21, ),
        self::TYPE_COLNAME       => array(CustomerVersionTableMap::ID => 0, CustomerVersionTableMap::REF => 1, CustomerVersionTableMap::TITLE_ID => 2, CustomerVersionTableMap::FIRSTNAME => 3, CustomerVersionTableMap::LASTNAME => 4, CustomerVersionTableMap::EMAIL => 5, CustomerVersionTableMap::PASSWORD => 6, CustomerVersionTableMap::ALGO => 7, CustomerVersionTableMap::BIRTHDAY => 8, CustomerVersionTableMap::RESELLER => 9, CustomerVersionTableMap::LANG => 10, CustomerVersionTableMap::SPONSOR => 11, CustomerVersionTableMap::DISCOUNT => 12, CustomerVersionTableMap::REMEMBER_ME_TOKEN => 13, CustomerVersionTableMap::REMEMBER_ME_SERIAL => 14, CustomerVersionTableMap::CREATED_AT => 15, CustomerVersionTableMap::UPDATED_AT => 16, CustomerVersionTableMap::VERSION => 17, CustomerVersionTableMap::VERSION_CREATED_AT => 18, CustomerVersionTableMap::VERSION_CREATED_BY => 19, CustomerVersionTableMap::ORDER_IDS => 20, CustomerVersionTableMap::ORDER_VERSIONS => 21, ),
        self::TYPE_RAW_COLNAME   => array('ID' => 0, 'REF' => 1, 'TITLE_ID' => 2, 'FIRSTNAME' => 3, 'LASTNAME' => 4, 'EMAIL' => 5, 'PASSWORD' => 6, 'ALGO' => 7, 'BIRTHDAY' => 8, 'RESELLER' => 9, 'LANG' => 10, 'SPONSOR' => 11, 'DISCOUNT' => 12, 'REMEMBER_ME_TOKEN' => 13, 'REMEMBER_ME_SERIAL' => 14, 'CREATED_AT' => 15, 'UPDATED_AT' => 16, 'VERSION' => 17, 'VERSION_CREATED_AT' => 18, 'VERSION_CREATED_BY' => 19, 'ORDER_IDS' => 20, 'ORDER_VERSIONS' => 21, ),
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(CustomerVersionTableMap::BIRTHDAY);
