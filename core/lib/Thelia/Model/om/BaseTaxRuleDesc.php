...
/**
 * Base class that represents a row from the 'tax_rule_desc' table.
 *
 *
 *
 * @package    propel.generator.Thelia.Model.om
 */
abstract class BaseTaxRuleDesc extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'Thelia\\Model\\TaxRuleDescPeer';
