...
/**
 * Base static class for performing query and update operations on the 'order_status_i18n' table.
 *
 *
 *
...
abstract class BaseOrderStatusI18nPeer
{
    ...
    const TM_CLASS = 'OrderStatusI18nTableMap';
    ...
    /**
     * An identiy map to hold any loaded instances of OrderStatusI18n objects.
     ...
     * e.g. OrderStatusI18nPeer::$fieldNames[OrderStatusI18nPeer::TYPE_PHPNAME][0] = 'Id'
     */
