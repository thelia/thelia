...
/**
 * Base class that represents a row from the 'order_feature' table.
 *
 *
 *
 * @package    propel.generator.Thelia.Model.om
 */
abstract class BaseOrderFeature extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'Thelia\\Model\\OrderFeaturePeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        OrderFeaturePeer
     */
