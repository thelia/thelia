...
use Thelia\Model\map\AttributeDescTableMap;

/**
 * Base static class for performing query and update operations on the 'attribute_desc' table.
 *
 *
 *
 * @package propel.generator.Thelia.Model.om
 */
abstract class BaseAttributeDescPeer
{
    ...
    const OM_CLASS = 'Thelia\\Model\\AttributeDesc';

    /** the related TableMap class for this table */
    const TM_CLASS = 'AttributeDescTableMap';
    ...
    const ID = 'attribute_desc.ID';

    /** the column name for the LANG field */
    const LANG = 'attribute_desc.LANG';

    /** the column name for the ATTRIBUTE_ID field */
    const ATTRIBUTE_ID = 'attribute_desc.ATTRIBUTE_ID';

    /** the column name for the TITLE field */
    const TITLE = 'attribute_desc.TITLE';

    /** the column name for the DESCRIPTION field */
    const DESCRIPTION = 'attribute_desc.DESCRIPTION';

    /** the column name for the CHAPO field */
    const CHAPO = 'attribute_desc.CHAPO';

    /** the column name for the CREATED_AT field */
    const CREATED_AT = 'attribute_desc.CREATED_AT';

    /** the column name for the UPDATED_AT field */
    const UPDATED_AT = 'attribute_desc.UPDATED_AT';

    /** The default string format for model objects of the related table **/
    const DEFAULT_STRING_FORMAT = 'YAML';

    /**
     * An identiy map to hold any loaded instances of AttributeDesc objects.
     * This must be public so that other peer classes can access this when hydrating from JOIN
     * queries.
     * @var        array AttributeDesc[]
     */
     ...
     * e.g. AttributeDescPeer::$fieldNames[AttributeDescPeer::TYPE_PHPNAME][0] = 'Id'
     */
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('Id', 'Lang', 'AttributeId', 'Title', 'Description', 'Chapo', 'CreatedAt', 'UpdatedAt', ),
