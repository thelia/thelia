...
/**
 * Base static class for performing query and update operations on the 'admin_group' table.
 *
 *
 *
 * @package propel.generator.Thelia.Model.om
 */
abstract class BaseAdminGroupPeer
{
    ...
    const TM_CLASS = 'AdminGroupTableMap';
    ...
    /**
     * An identiy map to hold any loaded instances of AdminGroup objects.
     ...
     * e.g. AdminGroupPeer::$fieldNames[AdminGroupPeer::TYPE_PHPNAME][0] = 'Id'
     */
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('Id', 'GroupId', 'AdminId', 'CreatedAt', 'UpdatedAt', ),
