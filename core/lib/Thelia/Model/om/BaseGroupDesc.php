...
/**
 * Base class that represents a row from the 'group_desc' table.
 *
 *
 *
 * @package    propel.generator.Thelia.Model.om
 */
abstract class BaseGroupDesc extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'Thelia\\Model\\GroupDescPeer';
