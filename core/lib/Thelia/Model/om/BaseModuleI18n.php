...
/**
 * Base class that represents a row from the 'module_i18n' table.
 *
 *
 *
 * @package    propel.generator.Thelia.Model.om
 */
abstract class BaseModuleI18n extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'Thelia\\Model\\ModuleI18nPeer';
