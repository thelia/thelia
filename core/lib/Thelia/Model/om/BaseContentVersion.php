...
/**
 * Base class that represents a row from the 'content_version' table.
 *
 *
 *
 * @package    propel.generator.Thelia.Model.om
 */
abstract class BaseContentVersion extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'Thelia\\Model\\ContentVersionPeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        ContentVersionPeer
     */
