...
/**
 * Base class that represents a row from the 'message_version' table.
 *
 *
 *
 * @package    propel.generator.Thelia.Model.om
 */
abstract class BaseMessageVersion extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'Thelia\\Model\\MessageVersionPeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        MessageVersionPeer
     */
