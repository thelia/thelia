...
/**
 * Base static class for performing query and update operations on the 'order_status' table.
 *
 *
 *
...
abstract class BaseOrderStatusPeer
{
    ...
    const TM_CLASS = 'OrderStatusTableMap';
    ...
    /**
     * An identiy map to hold any loaded instances of OrderStatus objects.
     ...
     * e.g. OrderStatusPeer::$fieldNames[OrderStatusPeer::TYPE_PHPNAME][0] = 'Id'
     */
