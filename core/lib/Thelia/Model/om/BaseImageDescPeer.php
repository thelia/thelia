...
use Thelia\Model\map\ImageDescTableMap;

/**
 * Base static class for performing query and update operations on the 'image_desc' table.
 *
 *
 *
 * @package propel.generator.Thelia.Model.om
 */
abstract class BaseImageDescPeer
{
    ...
    const OM_CLASS = 'Thelia\\Model\\ImageDesc';

    /** the related TableMap class for this table */
    const TM_CLASS = 'ImageDescTableMap';
    ...
    const ID = 'image_desc.ID';

    /** the column name for the IMAGE_ID field */
    const IMAGE_ID = 'image_desc.IMAGE_ID';

    /** the column name for the TITLE field */
    const TITLE = 'image_desc.TITLE';

    /** the column name for the DESCRIPTION field */
    const DESCRIPTION = 'image_desc.DESCRIPTION';

    /** the column name for the CHAPO field */
    const CHAPO = 'image_desc.CHAPO';

    /** the column name for the CREATED_AT field */
    const CREATED_AT = 'image_desc.CREATED_AT';

    /** the column name for the UPDATED_AT field */
    const UPDATED_AT = 'image_desc.UPDATED_AT';

    /** The default string format for model objects of the related table **/
    const DEFAULT_STRING_FORMAT = 'YAML';

    /**
     * An identiy map to hold any loaded instances of ImageDesc objects.
     ...
     * e.g. ImageDescPeer::$fieldNames[ImageDescPeer::TYPE_PHPNAME][0] = 'Id'
     */
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('Id', 'ImageId', 'Title', 'Description', 'Chapo', 'CreatedAt', 'UpdatedAt', ),
