 ...
 * @method GroupI18nQuery orderByChapo($order = Criteria::ASC) Order by the chapo column
 * @method GroupI18nQuery orderByPostscriptum($order = Criteria::ASC) Order by the postscriptum column
 *
 ...
 * @method GroupI18nQuery groupByChapo() Group by the chapo column
 * @method GroupI18nQuery groupByPostscriptum() Group by the postscriptum column
 *
 ...
 * @method GroupI18n findOneByChapo(string $chapo) Return the first GroupI18n filtered by the chapo column
 * @method GroupI18n findOneByPostscriptum(string $postscriptum) Return the first GroupI18n filtered by the postscriptum column
 *
 ...
 * @method array findByChapo(string $chapo) Return GroupI18n objects filtered by the chapo column
 * @method array findByPostscriptum(string $postscriptum) Return GroupI18n objects filtered by the postscriptum column
 *
