...
/**
 * Base class that represents a row from the 'rewriting' table.
 *
 *
 *
 * @package    propel.generator.Thelia.Model.om
 */
abstract class BaseRewriting extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'Thelia\\Model\\RewritingPeer';
