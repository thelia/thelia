...
/**
 * Base class that represents a row from the 'delivzone' table.
 *
 *
 *
 * @package    propel.generator.Thelia.Model.om
 */
abstract class BaseDelivzone extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'Thelia\\Model\\DelivzonePeer';
