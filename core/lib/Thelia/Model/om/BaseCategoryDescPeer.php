...
use Thelia\Model\map\CategoryDescTableMap;

/**
 * Base static class for performing query and update operations on the 'category_desc' table.
 *
 *
 *
 * @package propel.generator.Thelia.Model.om
 */
abstract class BaseCategoryDescPeer
{
    ...
    const OM_CLASS = 'Thelia\\Model\\CategoryDesc';

    /** the related TableMap class for this table */
    const TM_CLASS = 'CategoryDescTableMap';
    ...
    const ID = 'category_desc.ID';

    /** the column name for the CATEGORY_ID field */
    const CATEGORY_ID = 'category_desc.CATEGORY_ID';

    /** the column name for the LANG field */
    const LANG = 'category_desc.LANG';

    /** the column name for the TITLE field */
    const TITLE = 'category_desc.TITLE';

    /** the column name for the DESCRIPTION field */
    const DESCRIPTION = 'category_desc.DESCRIPTION';

    /** the column name for the CHAPO field */
    const CHAPO = 'category_desc.CHAPO';

    /** the column name for the POSTSCRIPTUM field */
    const POSTSCRIPTUM = 'category_desc.POSTSCRIPTUM';

    /** the column name for the CREATED_AT field */
    const CREATED_AT = 'category_desc.CREATED_AT';

    /** the column name for the UPDATED_AT field */
    const UPDATED_AT = 'category_desc.UPDATED_AT';

    /** The default string format for model objects of the related table **/
    const DEFAULT_STRING_FORMAT = 'YAML';

    /**
     * An identiy map to hold any loaded instances of CategoryDesc objects.
     * This must be public so that other peer classes can access this when hydrating from JOIN
     * queries.
     * @var        array CategoryDesc[]
     */
     ...
     * e.g. CategoryDescPeer::$fieldNames[CategoryDescPeer::TYPE_PHPNAME][0] = 'Id'
     */
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('Id', 'CategoryId', 'Lang', 'Title', 'Description', 'Chapo', 'Postscriptum', 'CreatedAt', 'UpdatedAt', ),
