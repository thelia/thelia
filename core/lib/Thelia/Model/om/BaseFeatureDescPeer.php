...
use Thelia\Model\map\FeatureDescTableMap;

/**
 * Base static class for performing query and update operations on the 'feature_desc' table.
 *
 *
 *
 * @package propel.generator.Thelia.Model.om
 */
abstract class BaseFeatureDescPeer
{
    ...
    const OM_CLASS = 'Thelia\\Model\\FeatureDesc';

    /** the related TableMap class for this table */
    const TM_CLASS = 'FeatureDescTableMap';
    ...
    const ID = 'feature_desc.ID';

    /** the column name for the FEATURE_ID field */
    const FEATURE_ID = 'feature_desc.FEATURE_ID';

    /** the column name for the LANG field */
    const LANG = 'feature_desc.LANG';

    /** the column name for the TITLE field */
    const TITLE = 'feature_desc.TITLE';

    /** the column name for the DESCRIPTION field */
    const DESCRIPTION = 'feature_desc.DESCRIPTION';

    /** the column name for the CHAPO field */
    const CHAPO = 'feature_desc.CHAPO';

    /** the column name for the CREATED_AT field */
    const CREATED_AT = 'feature_desc.CREATED_AT';

    /** the column name for the UPDATED_AT field */
    const UPDATED_AT = 'feature_desc.UPDATED_AT';

    /** The default string format for model objects of the related table **/
    const DEFAULT_STRING_FORMAT = 'YAML';

    /**
     * An identiy map to hold any loaded instances of FeatureDesc objects.
     * This must be public so that other peer classes can access this when hydrating from JOIN
     * queries.
     * @var        array FeatureDesc[]
     */
     ...
     * e.g. FeatureDescPeer::$fieldNames[FeatureDescPeer::TYPE_PHPNAME][0] = 'Id'
     */
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('Id', 'FeatureId', 'Lang', 'Title', 'Description', 'Chapo', 'CreatedAt', 'UpdatedAt', ),
