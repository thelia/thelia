...
/**
 * Base static class for performing query and update operations on the 'attribute_av' table.
 *
 *
 *
 * @package propel.generator.Thelia.Model.om
 */
abstract class BaseAttributeAvPeer
{
    ...
    const TM_CLASS = 'AttributeAvTableMap';
    ...
    /**
     * An identiy map to hold any loaded instances of AttributeAv objects.
     * This must be public so that other peer classes can access this when hydrating from JOIN
     * queries.
     * @var        array AttributeAv[]
     */
     ...
     * e.g. AttributeAvPeer::$fieldNames[AttributeAvPeer::TYPE_PHPNAME][0] = 'Id'
     */
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('Id', 'AttributeId', 'Position', 'CreatedAt', 'UpdatedAt', ),
