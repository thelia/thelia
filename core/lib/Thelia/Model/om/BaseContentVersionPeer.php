...
/**
 * Base static class for performing query and update operations on the 'content_version' table.
 *
 *
 *
 * @package propel.generator.Thelia.Model.om
 */
abstract class BaseContentVersionPeer
{
    ...
    const TM_CLASS = 'ContentVersionTableMap';
    ...
    /**
     * An identiy map to hold any loaded instances of ContentVersion objects.
     * This must be public so that other peer classes can access this when hydrating from JOIN
     * queries.
     * @var        array ContentVersion[]
     */
     ...
     * e.g. ContentVersionPeer::$fieldNames[ContentVersionPeer::TYPE_PHPNAME][0] = 'Id'
     */
