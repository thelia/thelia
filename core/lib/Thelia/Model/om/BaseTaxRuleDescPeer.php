...
use Thelia\Model\map\TaxRuleDescTableMap;

/**
 * Base static class for performing query and update operations on the 'tax_rule_desc' table.
 *
 *
 *
 * @package propel.generator.Thelia.Model.om
 */
abstract class BaseTaxRuleDescPeer
{
    ...
    const OM_CLASS = 'Thelia\\Model\\TaxRuleDesc';

    /** the related TableMap class for this table */
    const TM_CLASS = 'TaxRuleDescTableMap';
    ...
    const ID = 'tax_rule_desc.ID';

    /** the column name for the TAX_RULE_ID field */
    const TAX_RULE_ID = 'tax_rule_desc.TAX_RULE_ID';

    /** the column name for the LANG field */
    const LANG = 'tax_rule_desc.LANG';

    /** the column name for the TITLE field */
    const TITLE = 'tax_rule_desc.TITLE';

    /** the column name for the DESCRIPTION field */
    const DESCRIPTION = 'tax_rule_desc.DESCRIPTION';

    /** the column name for the CREATED_AT field */
    const CREATED_AT = 'tax_rule_desc.CREATED_AT';

    /** the column name for the UPDATED_AT field */
    const UPDATED_AT = 'tax_rule_desc.UPDATED_AT';

    /** The default string format for model objects of the related table **/
    const DEFAULT_STRING_FORMAT = 'YAML';

    /**
     * An identiy map to hold any loaded instances of TaxRuleDesc objects.
     * This must be public so that other peer classes can access this when hydrating from JOIN
     * queries.
     * @var        array TaxRuleDesc[]
     */
     ...
     * e.g. TaxRuleDescPeer::$fieldNames[TaxRuleDescPeer::TYPE_PHPNAME][0] = 'Id'
     */
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('Id', 'TaxRuleId', 'Lang', 'Title', 'Description', 'CreatedAt', 'UpdatedAt', ),
