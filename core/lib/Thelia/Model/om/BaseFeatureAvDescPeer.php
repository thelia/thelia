...
use Thelia\Model\map\FeatureAvDescTableMap;

/**
 * Base static class for performing query and update operations on the 'feature_av_desc' table.
 *
 *
 *
 * @package propel.generator.Thelia.Model.om
 */
abstract class BaseFeatureAvDescPeer
{
    ...
    const OM_CLASS = 'Thelia\\Model\\FeatureAvDesc';
    ...
    const FEATURE_AV_ID = 'feature_av_desc.FEATURE_AV_ID';

    /** the column name for the LANG field */
    const LANG = 'feature_av_desc.LANG';

    /** the column name for the TITLE field */
    const TITLE = 'feature_av_desc.TITLE';

    /** the column name for the DESCRIPTION field */
    const DESCRIPTION = 'feature_av_desc.DESCRIPTION';
    ...
    /**
     * An identiy map to hold any loaded instances of FeatureAvDesc objects.
     * This must be public so that other peer classes can access this when hydrating from JOIN
     * queries.
     * @var        array FeatureAvDesc[]
     */
