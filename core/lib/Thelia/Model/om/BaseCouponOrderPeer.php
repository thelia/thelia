...
/**
 * Base static class for performing query and update operations on the 'coupon_order' table.
 *
 *
 *
 * @package propel.generator.Thelia.Model.om
 */
abstract class BaseCouponOrderPeer
{
    ...
    const TM_CLASS = 'CouponOrderTableMap';
    ...
    /**
     * An identiy map to hold any loaded instances of CouponOrder objects.
     * This must be public so that other peer classes can access this when hydrating from JOIN
     * queries.
     * @var        array CouponOrder[]
     */
     ...
     * e.g. CouponOrderPeer::$fieldNames[CouponOrderPeer::TYPE_PHPNAME][0] = 'Id'
     */
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('Id', 'OrderId', 'Code', 'Value', 'CreatedAt', 'UpdatedAt', ),
