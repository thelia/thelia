...
use Thelia\Model\map\ContentDescTableMap;

/**
 * Base static class for performing query and update operations on the 'content_desc' table.
 *
 *
 *
 * @package propel.generator.Thelia.Model.om
 */
abstract class BaseContentDescPeer
{
    ...
    const OM_CLASS = 'Thelia\\Model\\ContentDesc';

    /** the related TableMap class for this table */
    const TM_CLASS = 'ContentDescTableMap';
    ...
    const ID = 'content_desc.ID';

    /** the column name for the CONTENT_ID field */
    const CONTENT_ID = 'content_desc.CONTENT_ID';

    /** the column name for the LANG field */
    const LANG = 'content_desc.LANG';

    /** the column name for the TITLE field */
    const TITLE = 'content_desc.TITLE';

    /** the column name for the DESCRIPTION field */
    const DESCRIPTION = 'content_desc.DESCRIPTION';

    /** the column name for the CHAPO field */
    const CHAPO = 'content_desc.CHAPO';

    /** the column name for the POSTSCRIPTUM field */
    const POSTSCRIPTUM = 'content_desc.POSTSCRIPTUM';

    /** the column name for the CREATED_AT field */
    const CREATED_AT = 'content_desc.CREATED_AT';

    /** the column name for the UPDATED_AT field */
    const UPDATED_AT = 'content_desc.UPDATED_AT';

    /** The default string format for model objects of the related table **/
    const DEFAULT_STRING_FORMAT = 'YAML';

    /**
     * An identiy map to hold any loaded instances of ContentDesc objects.
     * This must be public so that other peer classes can access this when hydrating from JOIN
     * queries.
     * @var        array ContentDesc[]
     */
     ...
     * e.g. ContentDescPeer::$fieldNames[ContentDescPeer::TYPE_PHPNAME][0] = 'Id'
     */
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('Id', 'ContentId', 'Lang', 'Title', 'Description', 'Chapo', 'Postscriptum', 'CreatedAt', 'UpdatedAt', ),
