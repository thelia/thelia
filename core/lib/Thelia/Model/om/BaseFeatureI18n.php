...
/**
 * Base class that represents a row from the 'feature_i18n' table.
 *
 *
 *
 * @package    propel.generator.Thelia.Model.om
 */
abstract class BaseFeatureI18n extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'Thelia\\Model\\FeatureI18nPeer';
