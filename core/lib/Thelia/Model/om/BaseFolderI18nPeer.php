...
/**
 * Base static class for performing query and update operations on the 'folder_i18n' table.
 *
 *
 *
 * @package propel.generator.Thelia.Model.om
 */
abstract class BaseFolderI18nPeer
{
    ...
    const TM_CLASS = 'FolderI18nTableMap';
    ...
    /**
     * An identiy map to hold any loaded instances of FolderI18n objects.
     ...
     * e.g. FolderI18nPeer::$fieldNames[FolderI18nPeer::TYPE_PHPNAME][0] = 'Id'
     */
