...
/**
 * Base static class for performing query and update operations on the 'feature_prod' table.
 *
 *
 *
 * @package propel.generator.Thelia.Model.om
 */
abstract class BaseFeatureProdPeer
{
    ...
    const TM_CLASS = 'FeatureProdTableMap';
    ...
    /**
     * An identiy map to hold any loaded instances of FeatureProd objects.
     * This must be public so that other peer classes can access this when hydrating from JOIN
     * queries.
     * @var        array FeatureProd[]
     */
