...
use Thelia\Model\map\OrderStatusDescTableMap;

/**
 * Base static class for performing query and update operations on the 'order_status_desc' table.
 *
 *
 *
 * @package propel.generator.Thelia.Model.om
 */
abstract class BaseOrderStatusDescPeer
{
    ...
    const OM_CLASS = 'Thelia\\Model\\OrderStatusDesc';

    /** the related TableMap class for this table */
    const TM_CLASS = 'OrderStatusDescTableMap';
    ...
    const ID = 'order_status_desc.ID';

    /** the column name for the STATUS_ID field */
    const STATUS_ID = 'order_status_desc.STATUS_ID';

    /** the column name for the LANG field */
    const LANG = 'order_status_desc.LANG';

    /** the column name for the TITLE field */
    const TITLE = 'order_status_desc.TITLE';

    /** the column name for the DESCRIPTION field */
    const DESCRIPTION = 'order_status_desc.DESCRIPTION';

    /** the column name for the CHAPO field */
    const CHAPO = 'order_status_desc.CHAPO';

    /** the column name for the CREATED_AT field */
    const CREATED_AT = 'order_status_desc.CREATED_AT';

    /** the column name for the UPDATED_AT field */
    const UPDATED_AT = 'order_status_desc.UPDATED_AT';

    /** The default string format for model objects of the related table **/
    const DEFAULT_STRING_FORMAT = 'YAML';

    /**
     * An identiy map to hold any loaded instances of OrderStatusDesc objects.
     * This must be public so that other peer classes can access this when hydrating from JOIN
     * queries.
     * @var        array OrderStatusDesc[]
     */
     ...
     * e.g. OrderStatusDescPeer::$fieldNames[OrderStatusDescPeer::TYPE_PHPNAME][0] = 'Id'
     */
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('Id', 'StatusId', 'Lang', 'Title', 'Description', 'Chapo', 'CreatedAt', 'UpdatedAt', ),
