...
use Thelia\Model\map\CustomerTitleDescTableMap;

/**
 * Base static class for performing query and update operations on the 'customer_title_desc' table.
 *
 *
 *
 * @package propel.generator.Thelia.Model.om
 */
abstract class BaseCustomerTitleDescPeer
{
    ...
    const OM_CLASS = 'Thelia\\Model\\CustomerTitleDesc';

    /** the related TableMap class for this table */
    const TM_CLASS = 'CustomerTitleDescTableMap';
    ...
    const ID = 'customer_title_desc.ID';

    /** the column name for the CUSTOMER_TITLE_ID field */
    const CUSTOMER_TITLE_ID = 'customer_title_desc.CUSTOMER_TITLE_ID';

    /** the column name for the LANG field */
    const LANG = 'customer_title_desc.LANG';

    /** the column name for the SHORT field */
    const SHORT = 'customer_title_desc.SHORT';

    /** the column name for the LONG field */
    const LONG = 'customer_title_desc.LONG';

    /** the column name for the CREATED_AT field */
    const CREATED_AT = 'customer_title_desc.CREATED_AT';

    /** the column name for the UPDATED_AT field */
    const UPDATED_AT = 'customer_title_desc.UPDATED_AT';

    /** The default string format for model objects of the related table **/
    const DEFAULT_STRING_FORMAT = 'YAML';

    /**
     * An identiy map to hold any loaded instances of CustomerTitleDesc objects.
     * This must be public so that other peer classes can access this when hydrating from JOIN
     * queries.
     * @var        array CustomerTitleDesc[]
     */
     ...
     * e.g. CustomerTitleDescPeer::$fieldNames[CustomerTitleDescPeer::TYPE_PHPNAME][0] = 'Id'
     */
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('Id', 'CustomerTitleId', 'Lang', 'Short', 'Long', 'CreatedAt', 'UpdatedAt', ),
