 ...
 *
 *
 * @method FeatureCategoryQuery orderById($order = Criteria::ASC) Order by the id column
 * @method FeatureCategoryQuery orderByFeatureId($order = Criteria::ASC) Order by the feature_id column
 * @method FeatureCategoryQuery orderByCategoryId($order = Criteria::ASC) Order by the category_id column
 * @method FeatureCategoryQuery orderByCreatedAt($order = Criteria::ASC) Order by the created_at column
 * @method FeatureCategoryQuery orderByUpdatedAt($order = Criteria::ASC) Order by the updated_at column
 *
 * @method FeatureCategoryQuery groupById() Group by the id column
 * @method FeatureCategoryQuery groupByFeatureId() Group by the feature_id column
 * @method FeatureCategoryQuery groupByCategoryId() Group by the category_id column
 * @method FeatureCategoryQuery groupByCreatedAt() Group by the created_at column
 * @method FeatureCategoryQuery groupByUpdatedAt() Group by the updated_at column
 *
 * @method FeatureCategoryQuery leftJoin($relation) Adds a LEFT JOIN clause to the query
 * @method FeatureCategoryQuery rightJoin($relation) Adds a RIGHT JOIN clause to the query
 * @method FeatureCategoryQuery innerJoin($relation) Adds a INNER JOIN clause to the query
 *
 * @method FeatureCategoryQuery leftJoinCategory($relationAlias = null) Adds a LEFT JOIN clause to the query using the Category relation
 * @method FeatureCategoryQuery rightJoinCategory($relationAlias = null) Adds a RIGHT JOIN clause to the query using the Category relation
 * @method FeatureCategoryQuery innerJoinCategory($relationAlias = null) Adds a INNER JOIN clause to the query using the Category relation
 *
 * @method FeatureCategoryQuery leftJoinFeature($relationAlias = null) Adds a LEFT JOIN clause to the query using the Feature relation
 * @method FeatureCategoryQuery rightJoinFeature($relationAlias = null) Adds a RIGHT JOIN clause to the query using the Feature relation
 * @method FeatureCategoryQuery innerJoinFeature($relationAlias = null) Adds a INNER JOIN clause to the query using the Feature relation
 *
 * @method FeatureCategory findOne(PropelPDO $con = null) Return the first FeatureCategory matching the query
 * @method FeatureCategory findOneOrCreate(PropelPDO $con = null) Return the first FeatureCategory matching the query, or a new FeatureCategory object populated from the query conditions when no match is found
 *
 * @method FeatureCategory findOneById(int $id) Return the first FeatureCategory filtered by the id column
 * @method FeatureCategory findOneByFeatureId(int $feature_id) Return the first FeatureCategory filtered by the feature_id column
 * @method FeatureCategory findOneByCategoryId(int $category_id) Return the first FeatureCategory filtered by the category_id column
 * @method FeatureCategory findOneByCreatedAt(string $created_at) Return the first FeatureCategory filtered by the created_at column
 * @method FeatureCategory findOneByUpdatedAt(string $updated_at) Return the first FeatureCategory filtered by the updated_at column
 *
 * @method array findById(int $id) Return FeatureCategory objects filtered by the id column
 * @method array findByFeatureId(int $feature_id) Return FeatureCategory objects filtered by the feature_id column
 * @method array findByCategoryId(int $category_id) Return FeatureCategory objects filtered by the category_id column
 * @method array findByCreatedAt(string $created_at) Return FeatureCategory objects filtered by the created_at column
 * @method array findByUpdatedAt(string $updated_at) Return FeatureCategory objects filtered by the updated_at column
 *
 * @package    propel.generator.Thelia.Model.om
 */
abstract class BaseFeatureCategoryQuery extends ModelCriteria
{
    /**
     * Initializes internal state of BaseFeatureCategoryQuery object.
     *
    ...
    /**
     * Returns a new FeatureCategoryQuery object.
     *
     * @param     string $modelAlias The alias of a model in the query
     * @param     FeatureCategoryQuery|Criteria $criteria Optional Criteria to build the query from
     *
     * @return FeatureCategoryQuery
     */
    public static function create($modelAlias = null, $criteria = null)
    {
        if ($criteria instanceof FeatureCategoryQuery) {
            return $criteria;
        }
        $query = new FeatureCategoryQuery();
        if (null !== $modelAlias) {
