...
/**
 * Base static class for performing query and update operations on the 'attribute_category' table.
 *
 *
 *
...
abstract class BaseAttributeCategoryPeer
{
    ...
    const TM_CLASS = 'AttributeCategoryTableMap';
    ...
    /**
     * An identiy map to hold any loaded instances of AttributeCategory objects.
     * This must be public so that other peer classes can access this when hydrating from JOIN
     * queries.
     * @var        array AttributeCategory[]
     */
     ...
     * e.g. AttributeCategoryPeer::$fieldNames[AttributeCategoryPeer::TYPE_PHPNAME][0] = 'Id'
     */
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('Id', 'CategoryId', 'AttributeId', 'CreatedAt', 'UpdatedAt', ),
