...
use Thelia\Model\map\FolderDescTableMap;

/**
 * Base static class for performing query and update operations on the 'folder_desc' table.
 *
 *
 *
 * @package propel.generator.Thelia.Model.om
 */
abstract class BaseFolderDescPeer
{
    ...
    const OM_CLASS = 'Thelia\\Model\\FolderDesc';

    /** the related TableMap class for this table */
    const TM_CLASS = 'FolderDescTableMap';
    ...
    const ID = 'folder_desc.ID';

    /** the column name for the FOLDER_ID field */
    const FOLDER_ID = 'folder_desc.FOLDER_ID';

    /** the column name for the LANG field */
    const LANG = 'folder_desc.LANG';

    /** the column name for the TITLE field */
    const TITLE = 'folder_desc.TITLE';

    /** the column name for the DESCRIPTION field */
    const DESCRIPTION = 'folder_desc.DESCRIPTION';

    /** the column name for the CHAPO field */
    const CHAPO = 'folder_desc.CHAPO';

    /** the column name for the POSTSCRIPTUM field */
    const POSTSCRIPTUM = 'folder_desc.POSTSCRIPTUM';

    /** the column name for the CREATED_AT field */
    const CREATED_AT = 'folder_desc.CREATED_AT';

    /** the column name for the UPDATED_AT field */
    const UPDATED_AT = 'folder_desc.UPDATED_AT';

    /** The default string format for model objects of the related table **/
    const DEFAULT_STRING_FORMAT = 'YAML';

    /**
     * An identiy map to hold any loaded instances of FolderDesc objects.
     * This must be public so that other peer classes can access this when hydrating from JOIN
     * queries.
     * @var        array FolderDesc[]
     */
     ...
     * e.g. FolderDescPeer::$fieldNames[FolderDescPeer::TYPE_PHPNAME][0] = 'Id'
     */
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('Id', 'FolderId', 'Lang', 'Title', 'Description', 'Chapo', 'Postscriptum', 'CreatedAt', 'UpdatedAt', ),
