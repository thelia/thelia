...
use Thelia\Model\map\AttributeAvDescTableMap;

/**
 * Base static class for performing query and update operations on the 'attribute_av_desc' table.
 *
 *
 *
 * @package propel.generator.Thelia.Model.om
 */
abstract class BaseAttributeAvDescPeer
{
    ...
    const OM_CLASS = 'Thelia\\Model\\AttributeAvDesc';

    /** the related TableMap class for this table */
    const TM_CLASS = 'AttributeAvDescTableMap';
    ...
    const ID = 'attribute_av_desc.ID';

    /** the column name for the ATTRIBUTE_AV_ID field */
    const ATTRIBUTE_AV_ID = 'attribute_av_desc.ATTRIBUTE_AV_ID';

    /** the column name for the LANG field */
    const LANG = 'attribute_av_desc.LANG';

    /** the column name for the TITLE field */
    const TITLE = 'attribute_av_desc.TITLE';

    /** the column name for the DESCRIPTION field */
    const DESCRIPTION = 'attribute_av_desc.DESCRIPTION';

    /** the column name for the CHAPO field */
    const CHAPO = 'attribute_av_desc.CHAPO';

    /** the column name for the CREATED_AT field */
    const CREATED_AT = 'attribute_av_desc.CREATED_AT';

    /** the column name for the UPDATED_AT field */
    const UPDATED_AT = 'attribute_av_desc.UPDATED_AT';

    /** The default string format for model objects of the related table **/
    const DEFAULT_STRING_FORMAT = 'YAML';

    /**
     * An identiy map to hold any loaded instances of AttributeAvDesc objects.
     * This must be public so that other peer classes can access this when hydrating from JOIN
     * queries.
     * @var        array AttributeAvDesc[]
     */
     ...
     * e.g. AttributeAvDescPeer::$fieldNames[AttributeAvDescPeer::TYPE_PHPNAME][0] = 'Id'
     */
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('Id', 'AttributeAvId', 'Lang', 'Title', 'Description', 'Chapo', 'CreatedAt', 'UpdatedAt', ),
