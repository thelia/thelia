...
/**
 * Base static class for performing query and update operations on the 'group_module' table.
 *
 *
 *
 * @package propel.generator.Thelia.Model.om
 */
abstract class BaseGroupModulePeer
{
    ...
    const TM_CLASS = 'GroupModuleTableMap';
    ...
    /**
     * An identiy map to hold any loaded instances of GroupModule objects.
     * This must be public so that other peer classes can access this when hydrating from JOIN
     * queries.
     * @var        array GroupModule[]
     */
     ...
     * e.g. GroupModulePeer::$fieldNames[GroupModulePeer::TYPE_PHPNAME][0] = 'Id'
     */
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('Id', 'GroupId', 'ModuleId', 'Access', 'CreatedAt', 'UpdatedAt', ),
