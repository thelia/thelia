...
use Thelia\Model\map\ConfigDescTableMap;

/**
 * Base static class for performing query and update operations on the 'config_desc' table.
 *
 *
 *
 * @package propel.generator.Thelia.Model.om
 */
abstract class BaseConfigDescPeer
{
    ...
    const OM_CLASS = 'Thelia\\Model\\ConfigDesc';

    /** the related TableMap class for this table */
    const TM_CLASS = 'ConfigDescTableMap';
    ...
    const ID = 'config_desc.ID';

    /** the column name for the CONFIG_ID field */
    const CONFIG_ID = 'config_desc.CONFIG_ID';

    /** the column name for the LANG field */
    const LANG = 'config_desc.LANG';

    /** the column name for the TITLE field */
    const TITLE = 'config_desc.TITLE';

    /** the column name for the DESCRIPTION field */
    const DESCRIPTION = 'config_desc.DESCRIPTION';

    /** the column name for the CHAPO field */
    const CHAPO = 'config_desc.CHAPO';

    /** the column name for the CREATED_AT field */
    const CREATED_AT = 'config_desc.CREATED_AT';

    /** the column name for the UPDATED_AT field */
    const UPDATED_AT = 'config_desc.UPDATED_AT';

    /** The default string format for model objects of the related table **/
    const DEFAULT_STRING_FORMAT = 'YAML';

    /**
     * An identiy map to hold any loaded instances of ConfigDesc objects.
     * This must be public so that other peer classes can access this when hydrating from JOIN
     * queries.
     * @var        array ConfigDesc[]
     */
     ...
     * e.g. ConfigDescPeer::$fieldNames[ConfigDescPeer::TYPE_PHPNAME][0] = 'Id'
     */
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('Id', 'ConfigId', 'Lang', 'Title', 'Description', 'Chapo', 'CreatedAt', 'UpdatedAt', ),
