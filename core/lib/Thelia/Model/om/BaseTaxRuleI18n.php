...
/**
 * Base class that represents a row from the 'tax_rule_i18n' table.
 *
 *
 *
 * @package    propel.generator.Thelia.Model.om
 */
abstract class BaseTaxRuleI18n extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'Thelia\\Model\\TaxRuleI18nPeer';
