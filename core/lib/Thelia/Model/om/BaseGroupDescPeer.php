...
use Thelia\Model\map\GroupDescTableMap;

/**
 * Base static class for performing query and update operations on the 'group_desc' table.
 *
 *
 *
 * @package propel.generator.Thelia.Model.om
 */
abstract class BaseGroupDescPeer
{
    ...
    const OM_CLASS = 'Thelia\\Model\\GroupDesc';

    /** the related TableMap class for this table */
    const TM_CLASS = 'GroupDescTableMap';
    ...
    const ID = 'group_desc.ID';

    /** the column name for the GROUP_ID field */
    const GROUP_ID = 'group_desc.GROUP_ID';

    /** the column name for the LANG field */
    const LANG = 'group_desc.LANG';

    /** the column name for the TITLE field */
    const TITLE = 'group_desc.TITLE';

    /** the column name for the DESCRIPTION field */
    const DESCRIPTION = 'group_desc.DESCRIPTION';

    /** the column name for the CHAPO field */
    const CHAPO = 'group_desc.CHAPO';

    /** the column name for the CREATED_AT field */
    const CREATED_AT = 'group_desc.CREATED_AT';

    /** the column name for the UPDATED_AT field */
    const UPDATED_AT = 'group_desc.UPDATED_AT';

    /** The default string format for model objects of the related table **/
    const DEFAULT_STRING_FORMAT = 'YAML';

    /**
     * An identiy map to hold any loaded instances of GroupDesc objects.
     ...
     * e.g. GroupDescPeer::$fieldNames[GroupDescPeer::TYPE_PHPNAME][0] = 'Id'
     */
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('Id', 'GroupId', 'Lang', 'Title', 'Description', 'Chapo', 'CreatedAt', 'UpdatedAt', ),
