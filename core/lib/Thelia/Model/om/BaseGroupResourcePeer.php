...
/**
 * Base static class for performing query and update operations on the 'group_resource' table.
 *
 *
 *
 * @package propel.generator.Thelia.Model.om
 */
abstract class BaseGroupResourcePeer
{
    ...
    const TM_CLASS = 'GroupResourceTableMap';
    ...
    /**
     * An identiy map to hold any loaded instances of GroupResource objects.
     * This must be public so that other peer classes can access this when hydrating from JOIN
     * queries.
     * @var        array GroupResource[]
     */
     ...
     * e.g. GroupResourcePeer::$fieldNames[GroupResourcePeer::TYPE_PHPNAME][0] = 'Id'
     */
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('Id', 'GroupId', 'ResourceId', 'Read', 'Write', 'CreatedAt', 'UpdatedAt', ),
