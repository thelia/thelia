 ...
 *
 *
 * @method AttributeAvI18nQuery orderById($order = Criteria::ASC) Order by the id column
 * @method AttributeAvI18nQuery orderByLocale($order = Criteria::ASC) Order by the locale column
 * @method AttributeAvI18nQuery orderByTitle($order = Criteria::ASC) Order by the title column
 * @method AttributeAvI18nQuery orderByDescription($order = Criteria::ASC) Order by the description column
 * @method AttributeAvI18nQuery orderByChapo($order = Criteria::ASC) Order by the chapo column
 * @method AttributeAvI18nQuery orderByPostscriptum($order = Criteria::ASC) Order by the postscriptum column
 *
 * @method AttributeAvI18nQuery groupById() Group by the id column
 * @method AttributeAvI18nQuery groupByLocale() Group by the locale column
 * @method AttributeAvI18nQuery groupByTitle() Group by the title column
 * @method AttributeAvI18nQuery groupByDescription() Group by the description column
 * @method AttributeAvI18nQuery groupByChapo() Group by the chapo column
 * @method AttributeAvI18nQuery groupByPostscriptum() Group by the postscriptum column
 *
 * @method AttributeAvI18nQuery leftJoin($relation) Adds a LEFT JOIN clause to the query
 * @method AttributeAvI18nQuery rightJoin($relation) Adds a RIGHT JOIN clause to the query
 * @method AttributeAvI18nQuery innerJoin($relation) Adds a INNER JOIN clause to the query
 *
 * @method AttributeAvI18nQuery leftJoinAttributeAv($relationAlias = null) Adds a LEFT JOIN clause to the query using the AttributeAv relation
 * @method AttributeAvI18nQuery rightJoinAttributeAv($relationAlias = null) Adds a RIGHT JOIN clause to the query using the AttributeAv relation
 * @method AttributeAvI18nQuery innerJoinAttributeAv($relationAlias = null) Adds a INNER JOIN clause to the query using the AttributeAv relation
 *
 * @method AttributeAvI18n findOne(PropelPDO $con = null) Return the first AttributeAvI18n matching the query
 * @method AttributeAvI18n findOneOrCreate(PropelPDO $con = null) Return the first AttributeAvI18n matching the query, or a new AttributeAvI18n object populated from the query conditions when no match is found
 *
 * @method AttributeAvI18n findOneById(int $id) Return the first AttributeAvI18n filtered by the id column
 * @method AttributeAvI18n findOneByLocale(string $locale) Return the first AttributeAvI18n filtered by the locale column
 * @method AttributeAvI18n findOneByTitle(string $title) Return the first AttributeAvI18n filtered by the title column
 * @method AttributeAvI18n findOneByDescription(string $description) Return the first AttributeAvI18n filtered by the description column
 * @method AttributeAvI18n findOneByChapo(string $chapo) Return the first AttributeAvI18n filtered by the chapo column
 * @method AttributeAvI18n findOneByPostscriptum(string $postscriptum) Return the first AttributeAvI18n filtered by the postscriptum column
 *
 * @method array findById(int $id) Return AttributeAvI18n objects filtered by the id column
 * @method array findByLocale(string $locale) Return AttributeAvI18n objects filtered by the locale column
 * @method array findByTitle(string $title) Return AttributeAvI18n objects filtered by the title column
 * @method array findByDescription(string $description) Return AttributeAvI18n objects filtered by the description column
 * @method array findByChapo(string $chapo) Return AttributeAvI18n objects filtered by the chapo column
 * @method array findByPostscriptum(string $postscriptum) Return AttributeAvI18n objects filtered by the postscriptum column
 *
 * @package    propel.generator.Thelia.Model.om
 */
abstract class BaseAttributeAvI18nQuery extends ModelCriteria
{
    /**
    ...
    {
        if ($criteria instanceof AttributeAvI18nQuery) {
            return $criteria;
        }
        $query = new AttributeAvI18nQuery();
        if (null !== $modelAlias) {
