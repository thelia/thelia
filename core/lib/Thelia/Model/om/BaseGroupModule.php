...
/**
 * Base class that represents a row from the 'group_module' table.
 *
 *
 *
 * @package    propel.generator.Thelia.Model.om
 */
abstract class BaseGroupModule extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'Thelia\\Model\\GroupModulePeer';
