...
abstract class AdminProfile implements ActiveRecordInterface
{
    ...
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[] = AdminProfileTableMap::ID;
        }
    ...
    public function setProfileId($v)
    {
        ...
        if ($this->profile_id !== $v) {
            $this->profile_id = $v;
            $this->modifiedColumns[] = AdminProfileTableMap::PROFILE_ID;
        }
    ...
    public function setAdminId($v)
    {
        ...
        if ($this->admin_id !== $v) {
            $this->admin_id = $v;
            $this->modifiedColumns[] = AdminProfileTableMap::ADMIN_ID;
        }
    ...
    public function setCreatedAt($v)
    {
        ...
        if ($this->created_at !== null || $dt !== null) {
            if ($dt !== $this->created_at) {
                $this->created_at = $dt;
                $this->modifiedColumns[] = AdminProfileTableMap::CREATED_AT;
            }
    ...
    public function setUpdatedAt($v)
    {
        ...
        if ($this->updated_at !== null || $dt !== null) {
            if ($dt !== $this->updated_at) {
                $this->updated_at = $dt;
                $this->modifiedColumns[] = AdminProfileTableMap::UPDATED_AT;
            }
        } // if either are not null
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : AdminProfileTableMap::translateFieldName('Id', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : AdminProfileTableMap::translateFieldName('AdminId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->admin_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : AdminProfileTableMap::translateFieldName('CreatedAt', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            $this->created_at = (null !== $col) ? PropelDateTime::newInstance($col, null, '\DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : AdminProfileTableMap::translateFieldName('UpdatedAt', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            ...
            return $startcol + 5; // 5 = AdminProfileTableMap::NUM_HYDRATE_COLUMNS.
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(AdminProfileTableMap::ID)) {
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(AdminProfileTableMap::ID)) $criteria->add(AdminProfileTableMap::ID, $this->id);
    ...
    {
        $criteria = new Criteria(AdminProfileTableMap::DATABASE_NAME);
        $criteria->add(AdminProfileTableMap::ID, $this->id);
    ...
    public function isPrimaryKeyNull()
    {
        ...
        return (null === $this->getId()) && (null === $this->getProfileId()) && (null === $this->getAdminId());
    }
