 ...
 * @method     ChildDocumentQuery orderByProductId($order = Criteria::ASC) Order by the product_id column
 * @method     ChildDocumentQuery orderByCategoryId($order = Criteria::ASC) Order by the category_id column
 * @method     ChildDocumentQuery orderByFolderId($order = Criteria::ASC) Order by the folder_id column
 * @method     ChildDocumentQuery orderByContentId($order = Criteria::ASC) Order by the content_id column
 * @method     ChildDocumentQuery orderByFile($order = Criteria::ASC) Order by the file column
 * @method     ChildDocumentQuery orderByPosition($order = Criteria::ASC) Order by the position column
 * @method     ChildDocumentQuery orderByCreatedAt($order = Criteria::ASC) Order by the created_at column
 * @method     ChildDocumentQuery orderByUpdatedAt($order = Criteria::ASC) Order by the updated_at column
 *
 * @method     ChildDocumentQuery groupById() Group by the id column
 * @method     ChildDocumentQuery groupByProductId() Group by the product_id column
 * @method     ChildDocumentQuery groupByCategoryId() Group by the category_id column
 * @method     ChildDocumentQuery groupByFolderId() Group by the folder_id column
 * @method     ChildDocumentQuery groupByContentId() Group by the content_id column
 * @method     ChildDocumentQuery groupByFile() Group by the file column
 * @method     ChildDocumentQuery groupByPosition() Group by the position column
 * @method     ChildDocumentQuery groupByCreatedAt() Group by the created_at column
 * @method     ChildDocumentQuery groupByUpdatedAt() Group by the updated_at column
 *
 ...
 *
 * @method     ChildDocumentQuery leftJoinProduct($relationAlias = null) Adds a LEFT JOIN clause to the query using the Product relation
 * @method     ChildDocumentQuery rightJoinProduct($relationAlias = null) Adds a RIGHT JOIN clause to the query using the Product relation
 * @method     ChildDocumentQuery innerJoinProduct($relationAlias = null) Adds a INNER JOIN clause to the query using the Product relation
 *
 * @method     ChildDocumentQuery leftJoinCategory($relationAlias = null) Adds a LEFT JOIN clause to the query using the Category relation
 * @method     ChildDocumentQuery rightJoinCategory($relationAlias = null) Adds a RIGHT JOIN clause to the query using the Category relation
 * @method     ChildDocumentQuery innerJoinCategory($relationAlias = null) Adds a INNER JOIN clause to the query using the Category relation
 *
 * @method     ChildDocumentQuery leftJoinContent($relationAlias = null) Adds a LEFT JOIN clause to the query using the Content relation
 * @method     ChildDocumentQuery rightJoinContent($relationAlias = null) Adds a RIGHT JOIN clause to the query using the Content relation
 * @method     ChildDocumentQuery innerJoinContent($relationAlias = null) Adds a INNER JOIN clause to the query using the Content relation
 *
 * @method     ChildDocumentQuery leftJoinFolder($relationAlias = null) Adds a LEFT JOIN clause to the query using the Folder relation
 * @method     ChildDocumentQuery rightJoinFolder($relationAlias = null) Adds a RIGHT JOIN clause to the query using the Folder relation
 * @method     ChildDocumentQuery innerJoinFolder($relationAlias = null) Adds a INNER JOIN clause to the query using the Folder relation
 *
 * @method     ChildDocumentQuery leftJoinDocumentI18n($relationAlias = null) Adds a LEFT JOIN clause to the query using the DocumentI18n relation
 * @method     ChildDocumentQuery rightJoinDocumentI18n($relationAlias = null) Adds a RIGHT JOIN clause to the query using the DocumentI18n relation
 * @method     ChildDocumentQuery innerJoinDocumentI18n($relationAlias = null) Adds a INNER JOIN clause to the query using the DocumentI18n relation
 *
 ...
 * @method     ChildDocument findOneByProductId(int $product_id) Return the first ChildDocument filtered by the product_id column
 * @method     ChildDocument findOneByCategoryId(int $category_id) Return the first ChildDocument filtered by the category_id column
 * @method     ChildDocument findOneByFolderId(int $folder_id) Return the first ChildDocument filtered by the folder_id column
 * @method     ChildDocument findOneByContentId(int $content_id) Return the first ChildDocument filtered by the content_id column
 * @method     ChildDocument findOneByFile(string $file) Return the first ChildDocument filtered by the file column
 * @method     ChildDocument findOneByPosition(int $position) Return the first ChildDocument filtered by the position column
 * @method     ChildDocument findOneByCreatedAt(string $created_at) Return the first ChildDocument filtered by the created_at column
 * @method     ChildDocument findOneByUpdatedAt(string $updated_at) Return the first ChildDocument filtered by the updated_at column
 *
 * @method     array findById(int $id) Return ChildDocument objects filtered by the id column
 * @method     array findByProductId(int $product_id) Return ChildDocument objects filtered by the product_id column
 * @method     array findByCategoryId(int $category_id) Return ChildDocument objects filtered by the category_id column
 * @method     array findByFolderId(int $folder_id) Return ChildDocument objects filtered by the folder_id column
 * @method     array findByContentId(int $content_id) Return ChildDocument objects filtered by the content_id column
 * @method     array findByFile(string $file) Return ChildDocument objects filtered by the file column
 * @method     array findByPosition(int $position) Return ChildDocument objects filtered by the position column
 * @method     array findByCreatedAt(string $created_at) Return ChildDocument objects filtered by the created_at column
 * @method     array findByUpdatedAt(string $updated_at) Return ChildDocument objects filtered by the updated_at column
 *
 */
abstract class DocumentQuery extends ModelCriteria
{
    ...
    {
        if ($criteria instanceof \Thelia\Model\DocumentQuery) {
            return $criteria;
        }
        $query = new \Thelia\Model\DocumentQuery();
        if (null !== $modelAlias) {
