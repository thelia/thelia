...
abstract class OrderFeature implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Thelia\\Model\\Map\\OrderFeatureTableMap';
    ...
    /**
     * The value for the feature_desc field.
     * @var        string
     */
    protected $feature_desc;

    /**
     * The value for the feature_av_desc field.
     * @var        string
     */
    protected $feature_av_desc;
    ...
    /**
     * Initializes internal state of Thelia\Model\Base\OrderFeature object.
     */
    ...
    /**
     * Compares this with another <code>OrderFeature</code> instance.  If
     * <code>obj</code> is an instance of <code>OrderFeature</code>, delegates to
     * <code>equals(OrderFeature)</code>.  Otherwise, returns <code>false</code>.
     *
