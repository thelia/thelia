 ...
 *
 * The check is made against the answers held in the session, not against the form that
 * was posted: a shop can add a mandatory consent between the moment the payment page
 * was rendered and the moment it is submitted, and the answer to a box that was never
...
final readonly class ConsentGuard
{
    public function __construct(
        ...
        private ConsentAcceptanceStore $acceptanceStore,
